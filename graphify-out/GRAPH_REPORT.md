...
## Corpus Check
- 2997 files · ~2,362,638 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 43990 nodes · 51364 edges · 2771 communities (2328 shown, 443 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 143 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a590dc4f`
...
## Communities (2771 total, 443 thin omitted)
...
Cohesion: 0.01
Nodes (214): catalog, @1password/connect, ai, @arizeai/phoenix-client, @babel/cli, @babel/code-frame, @babel/core, babel-plugin-annotate-pure-calls (+206 more)
...
Cohesion: 0.02
Nodes (61): Email, EmailBranded, emailChecks, $I, NormalizedString, VERSION, AbortSig, $I (+53 more)
...
Cohesion: 0.04
Nodes (85): Input(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator() (+77 more)
...
Cohesion: 0.02
Nodes (97): boundariesConfigCheckCommand, checkEnvelopePath, checkPublicDispatchEnvelope, ciContractCheckCommand, collectOptionalOutput, collectProcessOutput, commandContractCheckCommand, commonEnvelopeKeys (+89 more)
...
Cohesion: 0.02
Nodes (88): CardinalDirection, CardinalDirectionAbbrev, $I, defaultValue, formatFrameGuardValue, FrameGuardAllowFrom, FrameGuardAllowFromConfig, FrameGuardHeader (+80 more)
...
Cohesion: 0.03
Nodes (68): Button(), buttonVariants, Default, Destructive, Disabled, Ghost, Icon, Large (+60 more)
...
Cohesion: 0.03
Nodes (58): @beep/acp, @beep/agent-capability-use-cases, @beep/ai-provider-cli, @beep/architecture-lab-client, @beep/architecture-lab-config, @beep/architecture-lab-domain, @beep/architecture-lab-server, @beep/architecture-lab-tables (+50 more)
...
Cohesion: 0.07
Nodes (24): agentEffectivenessCommand, aiMetricsCommand, architectureCommand, rootCommand, createPackageCommand, createPackageCommand, docgenCommand, filesCommand (+16 more)

### Community 147 - "Community 147"
Cohesion: 0.05
Nodes (55): ComboboxChip(), ComboboxChips(), ComboboxChipsInput(), ComboboxClear(), ComboboxContent(), ComboboxEmpty(), ComboboxGroup(), ComboboxInput() (+47 more)
...
Cohesion: 0.06
Nodes (45): buildYeetRunPlan, bunRunStep(), closeoutPrContextStep(), closeoutReviewGateStep(), closeoutSteps(), commitStep(), DEFAULT_YEET_PACKET_DIR, earlyPushStep() (+37 more)
...
Cohesion: 0.06
Nodes (43): Carousel(), CarouselApi, CarouselContent(), CarouselContext, CarouselContextProps, CarouselInner(), CarouselItem(), CarouselNext() (+35 more)
...
Cohesion: 0.07
Nodes (45): YeetRunOptions, YeetRunResult, YeetRunMode, categoryForStep(), diagnosticIssueFromLine(), fallbackIssueFromResult(), fallbackIssuesFromResult(), filteredPackageNamesForStep() (+37 more)
...
Cohesion: 0.21
Nodes (10): affectedFileLines(), categoryBlocks(), noIssueBlocks, renderPackageQualityPacketDocument(), renderPackageQualityPacketMarkdown(), repairPaths(), routingLines(), verificationCommands() (+2 more)
...
Cohesion: 0.22
Nodes (14): main(), collectDeclarationNames(), collectDeclarations(), collectNonJsonDeclarationNames(), declarationFromStatement(), declarationName(), hasExportModifier(), readFile() (+6 more)
...
Cohesion: 0.25
Nodes (7): Canonical Commands, Failure Handling, Fast Plus Monitor, Ground First, Mergeable PR Workflow, Start PR Early, Yeet Quality Path
...
Cohesion: 0.29
Nodes (7): dependencies, @beep/identity, @beep/observability, @beep/schema, @beep/utils, effect, firecrawl
...
Cohesion: 0.40
Nodes (4): Claude Guide, Mission, Prompt-cache discipline, Rules
...
## Knowledge Gaps
- **30542 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+30537 more)
...
- **Why does `Dual()` connect `Community 339` to `Community 320`, `Community 1587`, `Community 2235`, `Community 207`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `createFileGenerationPlanService()` connect `Community 207` to `Community 339`, `Community 103`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 328` to `Community 513`, `Community 309`, `Community 1016`, `Community 795`, `Community 1279`?**
...
- **What connects `$schema`, `changelog`, `commit` to the rest of the system?**
  _30542 weakly-connected nodes found - possible documentation gaps or missing edges._
