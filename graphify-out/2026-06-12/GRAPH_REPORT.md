# Graph Report - beep-effect  (2026-06-12)

## Corpus Check
- 3262 files · ~2,499,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 47975 nodes · 56661 edges · 2972 communities (2487 shown, 485 thin omitted)
...
## Communities (2972 total, 485 thin omitted)

### Community 0 - "Agent Capability ACP/RPC"
Cohesion: 0.00
Nodes (409): paths, @beep/acp, @beep/acp/agent, @beep/acp/client, @beep/acp/errors, @beep/acp/protocol, @beep/acp/rpc, @beep/acp/schema (+401 more)
...
Cohesion: 0.01
Nodes (141): @beep/agent-capability-domain, @beep/agent-capability-domain/entities, @beep/agent-capability-domain/entities/Agent, @beep/agent-capability-domain/entities/Skill, paths, @beep/identity, @beep/identity/packages, @beep/schema (+133 more)
...
Cohesion: 0.02
Nodes (108): isExcludedFile(), makeAllowlistKey(), isExcludedTypeScriptSourcePath(), toPosixPath(), arraysEqual(), BeepScopedPackageName, buildAdjacency(), buildCanonicalSyncpackSources() (+100 more)
...
Cohesion: 0.02
Nodes (80): appendWorkspaceEntry(), AppKind, appKindEquivalence, appKindIs(), applyJsoncModification(), BeepPackageMetadata, ensureIdentityPackageRegistration, ensureRootWorkspaceEntry (+72 more)
...
Cohesion: 0.03
Nodes (78): Author, BeepDriverMetadata, BeepFoundationKind, BeepFoundationMetadata, BeepPackageFamily, BeepPackageMetadata, BeepToolingKind, BeepToolingMetadata (+70 more)
...
Cohesion: 0.03
Nodes (70): allFlag, allow24GbFallbackFlag, allowPublicRunpodTemplateSearchFlag, changedFilesFlag, checkFlag, cleanFlag, confirmRunpodEvalFlag, docgenAggregateCommand (+62 more)

### Community 96 - "Community 96"
Cohesion: 0.05
Nodes (53): CyclicDependencyError, $I, DomainError, $I, $I, NoSuchFileError, encodePackageJsonPrettyEffect, encodePackageJsonToJsonEffect (+45 more)
...
Cohesion: 0.04
Nodes (45): addConceptCommand, addRoleCommand, architectureAddCommand, architectureApplyCommand, architectureCheckCommand, architectureCreateCommand, architecturePlanCommand, createPackageCommand (+37 more)
...
Cohesion: 0.03
Nodes (58): aggregatePackages, buildDocgenLocalPlan, buildDocgenLocalPlanWithRepoRoot, buildPlanFromChangedFiles, buildPlanFromPackage, byPackagePathAscending, bySelectedPackagePathAscending, checkPackageDocumentation (+50 more)

### Community 102 - "Community 102"
Cohesion: 0.04
Nodes (60): analyzeExport(), analyzeModuleFileoverview(), analyzeReExports(), analyzeSourceFile(), byDocsOutputPathAscending, byIssueAscending, byRelativePathAscending, categoryIssueMessages (+52 more)
...
Cohesion: 0.04
Nodes (52): CliReportedExit, failWithReportedExit(), $I, aggregateDocs, cleanFlag, docsAggregateCommand, filterFlag, packageFlag (+44 more)
...
Cohesion: 0.03
Nodes (51): DocgenQualityFindingCode, DocgenQualityReport, AnalyzeDocgenQualityWorkerEvalOptions, CodexSdkModule, CodexSdkPackageMetadata, compactPolicyExcerpt, decodeCodexSdkPackageMetadataJson, decodeDocgenQualityReportForWorkerEval() (+43 more)
...
Cohesion: 0.03
Nodes (50): analyzeDocgenQualityWorkerEval, DocgenQualityWorkerEvalProvider, DocgenQualityWorkerEvalScope, AcquiredRunpodPod, acquireRunpodPod, cleanupRunpodPod, decodeOllamaTagsResponse, DEFAULT_RUNPOD_READINESS_TIMEOUT (+42 more)

### Community 113 - "Community 113"
Cohesion: 0.03
Nodes (66): paths, @beep/agent-capability-domain, @beep/agent-capability-domain/entities, @beep/agent-capability-domain/entities/Agent, @beep/agent-capability-domain/entities/Skill, @beep/agent-capability-use-cases, @beep/agent-capability-use-cases/proof, @beep/agent-capability-use-cases/public (+58 more)
...
Cohesion: 0.02
Nodes (78): boundariesConfigCheckCommand, checkEnvelopePath, checkPublicDispatchEnvelope, ciContractCheckCommand, collectOptionalOutput, collectProcessOutput, commandContractCheckCommand, commonEnvelopeKeys (+70 more)
...
Cohesion: 0.04
Nodes (39): aiMetricsCommand, architectureCommand, rootCommand, createPackageCommand, createPackageCommand, docgenCommand, boundariesCommand, checkBoundaryConfig (+31 more)
...
Cohesion: 0.06
Nodes (45): alertTheme, AutocompletePropsSizeOverrides, autocompleteTheme, avatarTheme, buttonTheme, cardTheme, ChipPropsSizeOverrides, chipTheme (+37 more)
...
Cohesion: 0.04
Nodes (47): paths, @beep/agent-capability-domain, @beep/agent-capability-domain/entities/Agent, @beep/agent-capability-use-cases, @beep/agent-capability-use-cases/proof, @beep/agent-capability-use-cases/public, @beep/agent-capability-use-cases/test, @beep/epistemic-domain (+39 more)
...
Cohesion: 0.04
Nodes (94): columnNameFor, persist, tableNameFromIdentifier(), titleSegment(), Any, Assign, AssignedEntityParts, AssignedPersisted (+86 more)
...
Cohesion: 0.05
Nodes (31): allFlag, checkFlag, decodeCsvText, decodeJsonText, decodeXmlText, defaultCsvParserOptions, dryRunFlag, failOnChangedTargets() (+23 more)
...
Cohesion: 0.05
Nodes (44): bootstrapIdentityWorkspace, bootstrapRootConfig, CommandPlatformLayer, CommandTestLayer, decodeDriverPackageMetadata, decodeFoundationPackageMetadata, decodeGeneratedPackageManifest, decodePackageScripts (+36 more)

### Community 222 - "Community 222"
Cohesion: 0.05
Nodes (39): agentEffectivenessCommand, agentEffectivenessPhoenixBaseUrlConfig, annotationsCheckCommand, annotationsCommand, annotationsPlanCommand, confirmPhoenixWriteFlag, dataRootFlag, datasetsBundleCommand (+31 more)
...
Cohesion: 0.06
Nodes (35): JsonFromString, Date, DateTimeFromDateWithNow, DateTimeFromNumberWithNow, DateTimeInsert, DateTimeInsertFromDate, DateTimeInsertFromNumber, DateTimeUpdate (+27 more)
...
Cohesion: 0.07
Nodes (34): Browser, encodePackageJsonEffect, NpmPackageJson, PackageExports, PackageImports, PeerDependenciesMeta, PublishConfig, TypesVersions (+26 more)
...
Cohesion: 0.04
Nodes (52): artifactDirForContext, artifactNameHash(), runArtifactPathForContext, runIdForContext(), runStatePathForContext(), safeArtifactName, PrCloseoutReport, YeetRunOptions (+44 more)
...
Cohesion: 0.08
Nodes (27): beep agent-effectiveness annotations plan, beep agent-effectiveness doctor, Agent Effectiveness Loop Initiative, goals/ai-metrics-stack, goals/jsdoc-worker-eval, Agent Outcome Annotation Bridge, Config Snapshot A/B Scorecard Loop, JSDoc Worker-Eval Phoenix Experiment Lane (+19 more)
...
Cohesion: 0.06
Nodes (29): BackToTop(), backToTopVisibleAtom, scrollToTopAtom, oipRedirects(), makeOipContactHttpApiAppLayer(), makeOipContactHttpApiRouteLive(), makeOipContactHttpApiWebHandlerWithSubmit(), OipContactHttpApiAppLayer (+21 more)
...
Cohesion: 0.04
Nodes (41): HomeProps, isContactSubmissionStatus, OipHomePage(), socialIcon, ThemeModeToggle(), ContactSubmissionStatus, launchReviewGates, oipSiteContent (+33 more)
...
Cohesion: 0.06
Nodes (40): catalogReadFailure(), decodePackageManifestJson, firstParseErrorMessage, hydrateIndexPackage, hydrateRepoExportsCatalogIndex, $I, decodeRepoExportsCatalog, decodeRepoExportsCatalogIndex (+32 more)
...
Cohesion: 0.10
Nodes (28): FieldAtoms, FieldRefs, FormAtoms, FormAtomsConfig, FormOperations, make(), PublicFieldAtoms, getNestedValue (+20 more)
...
Cohesion: 0.19
Nodes (18): @beep/* Alias Import Law for Tests, Hexagonal Slice Layering, Architecture-Lab Proof Slice, VERSION Entry Export, WorkItem Aggregate, @beep/architecture-lab-client, @beep/architecture-lab-client Changelog, @beep/architecture-lab-client README (+10 more)
...
Cohesion: 0.09
Nodes (28): ContactForm(), contactReactivityKeys, currentTimestamp(), effectiveSubmittedAtAtom, markContactStartedAtom, nextSubmittedAt(), submitContactAtom, SubmitContactForm (+20 more)
...
Cohesion: 0.10
Nodes (20): syncDataTargets, encodeUnknownJsonResult, extractCurrencyName(), formatTsLiteral(), $I, isIso4217CurrencyNameWithMetadata, ISO4217_SOURCE_URL, Iso4217CurrencyCountry (+12 more)
...
Cohesion: 0.12
Nodes (8): Activity, $I, CandidateClaim, $I, Evidence, $I, $I, UsageRecord
...
Cohesion: 0.13
Nodes (15): Agent Guide, Effect-first development mandate, graphify, graphify knowledge-graph integration, Graphiti memory durable knowledge base, LiteralKit internal-domain guidance, Mission, Rules (+7 more)
...
Cohesion: 0.15
Nodes (13): ./entities/ApprovalGate, ./entities/CandidateDraft, ./entities/CandidateProject, ./entities/CandidateTask, ./entities/ContextPacket, ./entities/EmailArtifact, ./entities/Workspace, ./values/ApprovalDecision (+5 more)
...
Cohesion: 0.15
Nodes (7): TimezoneNameValues, Networks, CurrencyCode, CurrencyCodeData, FileExtension, MimeType, TimezoneName
...
Cohesion: 0.20
Nodes (9): ApprovalGateId, CandidateDraftId, CandidateProjectId, CandidateTaskId, ContextPacketId, EmailArtifactId, $I, make (+1 more)
...
Cohesion: 0.70
Nodes (3): CurrencyCodeDataPublished, CurrencyCodeDataSourceUrl, CurrencyCodeDataValues
...
Cohesion: 0.60
Nodes (6): exports, ./entities, ./package.json, exports, ./entities/CandidateDraft, ./entities/CandidateProject
...
Cohesion: 0.10
Nodes (20): FallowAttributionKinds, FallowEnvelopeStatus, FallowFailureEnvelope, FallowFailureEnvelopeStatus, FallowFeature, FallowFeatureFamily, FallowReportBaseFields, FallowReportBaseResolutionFailed (+12 more)
...
Cohesion: 0.67
Nodes (3): dependencies, @beep/architecture-lab-tables, effect
...
Cohesion: 0.14
Nodes (14): Layer composition pattern, No try-catch in Effect.gen, 🚨 CRITICAL TESTING REQUIREMENTS, ❌ FORBIDDEN PATTERNS, Never use Effect.runSync in tests, Never use expect with it.effect, Testing Framework Selection, ✅ Use @effect/vitest for Effect-based modules (+6 more)
...
Cohesion: 0.13
Nodes (19): contactRequestResponse, contactRequestResponseWithSubmit, ContactRoutePayloadError, ContactRoutePayloadErrorReason, $I, readContactFormPayload, rejected, SubmitContact (+11 more)
...
Cohesion: 0.06
Nodes (37): @beep/repo-codegraph, Catalog facts authoritative over embedding/graph hints, RepoExportsCatalog model, Package-local import policy (beep.importPolicy), Deterministic repo export lookup (lookupRepoExports), @beep/repo-cli (CLI surface for lookup), @beep/repo-configs, DocsESLintConfig (JSDoc/TSDoc lint surface) (+29 more)
...
Cohesion: 0.05
Nodes (37): @beep/data, Development, Installation, License, Usage, @beep/identity, Development, Installation (+29 more)
...
Cohesion: 0.16
Nodes (16): decodeUnknownRecordOption, findingsForCount(), normalizeArrayFindings(), normalizeAuditFindings(), normalizeFlagsFindings(), normalizeSummaryFindings(), rawArrayCount(), rawCountValue() (+8 more)
...
Cohesion: 0.19
Nodes (13): sameAttributionKind, sameEnvelopeStatus, attributionKindSetDiagnostics(), attributionSummary(), checkExactEnvelopeKeys(), checkReportInvariants(), countFor(), decodeFallowReportOkOption (+5 more)
...
Cohesion: 0.25
Nodes (8): attributionKinds(), baseEnvelope(), commandText(), makeFailureEnvelope(), makeOkEnvelope(), normalizeFindings(), renderWrapperCommand(), wrapperArgs()
...
Cohesion: 0.32
Nodes (8): fallowCiLaneDiagnostics(), fallowCiRequiredTextDiagnostics(), fallowCiUploadDiagnostics(), laneEnvelopeDiagnostics(), laneNameDiagnostics(), missingDiagnostic(), presentDiagnostic(), repeatedLineDiagnostics()
...
Cohesion: 0.29
Nodes (6): CommaSeparatedList, $I, normalizeBooleanString, NormalizedBooleanString, TrimmedNonEmptyText, truthyBooleanString
...
Cohesion: 0.67
Nodes (4): printQualityProfileConfig(), printQualityProfileDetection(), renderQualityProfileConfigLines(), jsonStringifyPretty
...
Cohesion: 0.47
Nodes (6): auditFinding(), notApplicableFinding(), parserName(), promotedBlockingFinding(), slugify, subCategoryName()
...
Cohesion: 0.40
Nodes (5): Job 1 — USPTO/WIPO patent FIGURES (black-line 2D drawings), Job 2 — Invention 3D MODELING (disclosure → editable parametric model), Job 3 — PRIOR-ART / reverse-modeling (reconstruct existing devices from photos/specs), Job 4 — Full DISCLOSURE→FIGURE pipeline (ingest disclosure → figure set + descriptions + numerals), Landscape by job
...
## Knowledge Gaps
- **32635 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+32630 more)
...
- **What is the exact relationship between `ArchitectureLabMigrationTarget` and `Agentic Professional Runtime proof`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Result` connect `Community 320` to `Community 737`, `Community 742`, `Community 359`, `Community 502`, `Community 1148`?**
