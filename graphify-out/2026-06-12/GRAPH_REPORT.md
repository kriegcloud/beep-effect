...
## Corpus Check
- 3253 files · ~2,497,916 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 47877 nodes · 56558 edges · 2959 communities (2472 shown, 487 thin omitted)
...
- `Bitemporal Attribution Evidence Trail` --semantically_similar_to--> `BitemporalMixin Four-Clock Time Model`  [INFERRED] [semantically similar]
  PRD-ambient-billing-copilot.md → Todox Data Model.md
- `submitProofForm()` --calls--> `Expect`  [INFERRED]
  apps/stack-installer/test/App.test.tsx → scratchpad/Lexical.schemas.type-test.ts
...
## Communities (2959 total, 487 thin omitted)

### Community 0 - "Agent Capability ACP/RPC"
Cohesion: 0.00
Nodes (404): paths, @beep/acp, @beep/acp/agent, @beep/acp/client, @beep/acp/errors, @beep/acp/protocol, @beep/acp/rpc, @beep/acp/schema (+396 more)
...
Cohesion: 0.03
Nodes (78): App(), $I, LoadState, $I, Badge(), badgeVariants, AsLink, Count (+70 more)
...
Cohesion: 0.03
Nodes (76): appendWorkspaceEntry(), AppKind, appKindEquivalence, appKindIs(), applyJsoncModification(), BeepPackageMetadata, directoriesFor, ensureIdentityPackageRegistration (+68 more)
...
Cohesion: 0.07
Nodes (37): dropdownArrowVariants, ActionButtons, Default, Disabled, GroupedControls, MultipleToggleGroup, SingleToggleGroup, SplitButton (+29 more)
...
Cohesion: 0.03
Nodes (50): DocgenQualityReport, DocgenQualityWorkerEvalProvider, DocgenQualityWorkerEvalScope, AcquiredRunpodPod, acquireRunpodPod, cleanupRunpodPod, decodeOllamaTagsResponse, DEFAULT_RUNPOD_READINESS_TIMEOUT (+42 more)
...
Cohesion: 0.03
Nodes (65): Button(), buttonVariants, Default, Destructive, Disabled, Ghost, Icon, Large (+57 more)
...
Cohesion: 0.05
Nodes (35): candidateIdFlag, cloneCheckFlag, cloneFuzzyFlag, cloneMinSimilarityFlag, cloneWriteFlag, ensureRepoExportsCatalogFresh, fileFlag, lookupFromFlag (+27 more)
...
Cohesion: 0.05
Nodes (36): agentEffectivenessCommand, aiMetricsCommand, architectureCommand, rootCommand, corpusCommand, createPackageCommand, createPackageCommand, docgenCommand (+28 more)
...
Cohesion: 0.02
Nodes (64): VERSION, AbortSig, $I, BigDecimalFromNumber, $I, CommaSeparatedList, $I, normalizeBooleanString (+56 more)
...
Cohesion: 0.03
Nodes (102): Input(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator() (+94 more)
...
Cohesion: 0.02
Nodes (132): clientMapFlag, corpusCatalogCommand, corpusEnrichCommand, corpusExtractCommand, corpusOrganizeCommand, corpusRootFlag, corpusSalvageCommand, exportChildrenFlag (+124 more)
...
Cohesion: 0.10
Nodes (21): beep, family, kind, bin, beep-cli, description, devDependencies, @effect/vitest (+13 more)
...
Cohesion: 0.08
Nodes (30): Annotation Plan Dry Run, Agent-Effectiveness Doctor Trust Gate, agent-effectiveness-loop Parent Goal, Dry-Run-Default Confirmation-Gated Phoenix Write Principle, Agent Effectiveness Phoenix Enrichment, Current Recommendation, Mission, Reading Order (+22 more)
...
Cohesion: 0.08
Nodes (22): codexCommand, qualityReviewFixLoopCommand, runCodexQualityReviewFixLoop, textEncoder, CodexCommandError, CodexCommandErrorOptions, $I, docsCommand (+14 more)
...
Cohesion: 0.11
Nodes (19): dependencies, @beep/editor, @beep/lexical-schema, @beep/md, @beep/ui, effect, react, react-dom (+11 more)
...
Cohesion: 0.20
Nodes (27): description, get, get, get, post, description, operationId, parameters (+19 more)
...
Cohesion: 0.10
Nodes (20): @beep/observability, @beep/observability, dependencies, @beep/identity, @beep/observability, @beep/schema, @beep/utils, @clack/prompts (+12 more)
...
Cohesion: 0.09
Nodes (18): blockToLexical(), codeChildText, collectListItems(), elementDefaults, headingConstructors, inlineNodeToMd, leafDefaults, lineBreak() (+10 more)
...
Cohesion: 0.09
Nodes (23): ArtifactRefNode, BaseNode, Direction, EditorStateFromJson, editorStateToPlainText(), ElementFormat, ElementNode, Encoded (+15 more)
...
Cohesion: 0.14
Nodes (37): description, post, post, post, openapi, paths, /endpoints/{endpointId}/update, /networkvolumes (+29 more)
...
Cohesion: 0.10
Nodes (26): runTerseEffectRules, Expect, ensureParentDirectory, NodeTestLayer, projectFilePath, readProjectFile, withTempWorkingDirectory(), writeDefaultTsconfig (+18 more)
...
Cohesion: 0.40
Nodes (5): numberBoundaryInterfaceValueAtom, numberInputTempInterfaceValueAtom, numberToString, useNumberBoundary(), useNumberInput()
...
Cohesion: 0.15
Nodes (13): dependencies, @beep/identity, @beep/lexical-schema, @beep/ui, @beep/utils, effect, lexical, @lexical/code (+5 more)
...
Cohesion: 0.20
Nodes (9): expectReportedExit(), encodeJson, runLintCommand, runSchemaFirstAndExpectNoErrors, testLayer, writePackage, writePrecisionAuditInventory, writeSchemaFirstFileFixture (+1 more)
...
Cohesion: 0.25
Nodes (8): isControlCode(), isCsiFinalCode(), isCsiIntermediateCode(), isCsiParameterCode(), isEscFinalCode(), sanitizeTerminalText(), skipCsiSequence(), skipOscSequence()
...
Cohesion: 0.33
Nodes (5): CliJsonError, encodeCommandJson, encodeJson, $I, printCommandJson

### Community 2930 - "Community 2930"
Cohesion: 0.33
Nodes (6): devDependencies, @effect/vitest, @lexical/headless, @types/node, @types/react, @types/react-dom
...
Cohesion: 0.40
Nodes (3): documentToEditorState(), editorStateToDocument(), roundTrip()
...
## Knowledge Gaps
- **32558 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+32553 more)
