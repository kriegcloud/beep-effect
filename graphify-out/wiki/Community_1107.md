...
- **vitest.config.ts** (2 connections) — `packages/workspace/tables/vitest.config.ts`
- **vitest.config.ts** (2 connections) — `packages/foundation/modeling/rdf/vitest.config.ts`
- **vitest.config.ts** (2 connections) — `packages/tooling/test-kit/test-utils/vitest.config.ts`
...
- `packages/shared/tables/vitest.config.ts`
- `packages/tooling/test-kit/test-utils/vitest.config.ts`
- `packages/workspace/tables/vitest.config.ts`
- `vitest.shared.ts`
