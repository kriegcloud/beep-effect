...
- [constants](#constants)
  - [TimezoneNameValues](#timezonenamevalues)
- [models](#models)
  - [TimezoneName (type alias)](#timezonename-type-alias)
---
...
```ts
type TimezoneName = (typeof internal.TimezoneNameValues)[number]
```

[Source](https://github.com/kriegcloud/beep-effect/tree/main/packages/foundation/primitive/data/src/Timezones.ts#L33)
