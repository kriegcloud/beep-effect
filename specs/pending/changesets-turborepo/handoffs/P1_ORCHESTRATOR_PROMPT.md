...
1. `specs/pending/changesets-turborepo/outputs/current-release-surface.md`
2. `specs/pending/changesets-turborepo/outputs/release-decisions.md`
...
- Keep edits inside `specs/pending/changesets-turborepo/`.
...
4. Update `specs/pending/changesets-turborepo/REFLECTION_LOG.md` with Phase 1 notes.
5. Create handoff docs for next phase:
   - `specs/pending/changesets-turborepo/handoffs/HANDOFF_P2.md`
   - `specs/pending/changesets-turborepo/handoffs/P2_ORCHESTRATOR_PROMPT.md`
...
- `specs/pending/changesets-turborepo/README.md`
- `specs/pending/changesets-turborepo/handoffs/HANDOFF_P1.md`
