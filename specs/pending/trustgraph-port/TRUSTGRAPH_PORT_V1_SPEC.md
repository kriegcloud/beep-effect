...
- The expert-memory control-plane docs explicitly treat identity, workflow state, progress, budgets, partial results, and auditability as architectural concerns in [EXPERT_MEMORY_CONTROL_PLANE.md](/home/elpresidank/YeeBois/projects/beep-effect/specs/pending/expert-memory-big-picture/EXPERT_MEMORY_CONTROL_PLANE.md).
