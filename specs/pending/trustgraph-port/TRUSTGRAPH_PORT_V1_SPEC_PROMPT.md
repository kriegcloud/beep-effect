...
This prompt is intentionally scoped to a `kernel-first`, `repo-first` v1 spec package for `beep-effect`.
...
Your task is to create a decision-complete v1 spec package for a selective TrustGraph capability port into `beep-effect`.
...
3. Read these local references before drafting:
   ...
   - `specs/pending/expert-memory-big-picture/RESEARCH_LANES_AND_OPEN_QUESTIONS.md`
...
- Target directory: `specs/pending/trustgraph-port`
- Create these artifacts:
  - `specs/pending/trustgraph-port/TRUSTGRAPH_PORT_V1_SPEC.md`
  - `specs/pending/trustgraph-port/TRUSTGRAPH_V1_CAPABILITY_MAP.md`
  - `specs/pending/trustgraph-port/TRUSTGRAPH_V1_PHASE_PLAN.md`
