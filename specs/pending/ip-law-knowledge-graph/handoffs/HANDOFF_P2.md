...
- [README.md](../README.md) — Assumptions and Defaults, ADR-002 (FalkorDB), ADR-005 (Cypher)
- [p1-schema-design.md](../outputs/p1-schema-design.md) — Complete node and edge type definitions
...
P2 is complete when `outputs/p2-implementation-plan.md` contains a file-level plan that another agent can follow without making additional design decisions.
