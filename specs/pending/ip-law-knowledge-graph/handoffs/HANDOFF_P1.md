...
- [README.md](../README.md) — Planned Node Types table, Planned Edge Types table, ADR-004 (Schema mapping strategy)
- [p0-ontology-research.md](../outputs/p0-ontology-research.md) — Class hierarchies, object properties, reasoning constraints, class-to-node-type mapping
...
P1 is complete when `outputs/p1-schema-design.md` contains all schema definitions with OWL traceability and no open design decisions remain.
