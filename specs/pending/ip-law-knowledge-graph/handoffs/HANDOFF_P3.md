...
- [README.md](../README.md) — ADRs, Success Criteria
- [p1-schema-design.md](../outputs/p1-schema-design.md) — Schema definitions to implement
- [p2-implementation-plan.md](../outputs/p2-implementation-plan.md) — File-level plan, seed data strategy, quality gates
...
P3 is complete when all source files are implemented, tests pass, seed data loads successfully, and `outputs/p3-implementation-notes.md` documents the full implementation record.
