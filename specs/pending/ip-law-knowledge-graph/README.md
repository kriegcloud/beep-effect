...
- [README.md](./README.md) — This file (normative source)
- [QUICK_START.md](./QUICK_START.md) — 5-minute executive summary
- [AGENT_PROMPTS.md](./AGENT_PROMPTS.md) — Per-phase agent execution prompts
- [REFLECTION_LOG.md](./REFLECTION_LOG.md) — Phase-by-phase learnings

### Handoffs

- [HANDOFF_P0.md](./handoffs/HANDOFF_P0.md) — P0 Ontology Research handoff
- [HANDOFF_P1.md](./handoffs/HANDOFF_P1.md) — P1 Schema Design handoff
- [HANDOFF_P2.md](./handoffs/HANDOFF_P2.md) — P2 Implementation Plan handoff
- [HANDOFF_P3.md](./handoffs/HANDOFF_P3.md) — P3 Implementation handoff
- [HANDOFF_P4.md](./handoffs/HANDOFF_P4.md) — P4 Verification handoff
...
- [p0-ontology-research.md](./outputs/p0-ontology-research.md) — Ontology survey findings
- [p1-schema-design.md](./outputs/p1-schema-design.md) — Effect Schema definitions
- [p2-implementation-plan.md](./outputs/p2-implementation-plan.md) — File-level build plan
- [p3-implementation-notes.md](./outputs/p3-implementation-notes.md) — Implementation record
- [p4-verification.md](./outputs/p4-verification.md) — Final verification evidence
...
|---|---|---|---|
| P0 | Ontology Research | `outputs/p0-ontology-research.md` | All 7 ontologies surveyed; key classes, object properties, and reasoning constraints documented; class-to-node-type mapping proposed |
| P1 | Schema Design | `outputs/p1-schema-design.md` | 15 node types + 11 edge types defined as Effect Schema tagged unions; OWL traceability annotations present; no open design decisions |
| P2 | Implementation Plan | `outputs/p2-implementation-plan.md` | File-level build plan with package scaffold, dependency order, seed data strategy, and quality gates defined |
| P3 | Implementation | `outputs/p3-implementation-notes.md` | All source files implemented; seed data loaded; tests passing; deviations from P2 plan documented |
| P4 | Verification | `outputs/p4-verification.md` | `pnpm check`, `pnpm lint-fix`, `pnpm test`, `pnpm build` all pass; failure classifications resolved; final readiness statement signed off |
