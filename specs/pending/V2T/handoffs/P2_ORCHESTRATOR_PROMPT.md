...
Read `handoffs/HANDOFF_P2.md`, `RESEARCH.md`, `DESIGN_RESEARCH.md`, `apps/V2T`, `packages/v2t-sidecar`, the live infra seams under `infra/`, `apps/V2T/scripts/build-sidecar.ts`, `package.json`, `turbo.json`, `infra/package.json`, the repo-law inputs named in `README.md`, and the delegation assets under `prompts/`.
