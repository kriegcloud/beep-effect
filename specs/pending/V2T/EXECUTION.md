...
Implement the first committed V2T slice in `apps/V2T` and its supporting seams without widening scope beyond the contracts locked in `RESEARCH.md`, `DESIGN_RESEARCH.md`, and `PLANNING.md`.
