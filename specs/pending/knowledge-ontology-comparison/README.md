...
- **NOT** redesigning the entire knowledge architecture from scratch
- **NOT** redesigning architecture
- **NOT** making technology decisions (only recommendations)

Note: This spec started as **research and analysis** (P1-P4). It later expanded into **capability parity closure and remediation phases** (P5+), which include code changes in `packages/knowledge/server/*` with test evidence.
...
- [knowledge-graph-integration](../../completed/knowledge-graph-integration/) - Original spec
