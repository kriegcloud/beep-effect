...
- `specs/pending/unified-ai-tooling/handoffs/HANDOFF_P5.md`
...
- `specs/pending/unified-ai-tooling/outputs/p6-final-verification.md`
- Updated `specs/pending/unified-ai-tooling/outputs/manifest.json` (P6 status)
...
rg -n "^## Quality Gate Evidence" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
rg -n "^### (Test Suites Executed|Fixture Sets Used|TDD Evidence|Pass/Fail Summary|Unresolved Risks|Review Signoff)$" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
rg -n "^\\| Design/Architecture \\|" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
rg -n "^\\| Security/Secrets \\|" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
rg -n "^\\| Migration/Operations \\|" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
! rg -n "\\|[^|]*\\|[^|]*\\|[^|]*\\| rejected \\|" specs/pending/unified-ai-tooling/outputs/p6-final-verification.md
```
