/**
 * @module TypeScriptSyntaxKindEnum
 * @description Snapshot of TypeScript compiler `SyntaxKind` enum values for
 * audit and cross-reference workflows.
 * @since 2026-03-01
 *
 * @source typescript.d.ts-morph (TypeScript compiler)
 * @description The SyntaxKind enum defines ALL node types in the TypeScript AST.
 *
 * Key ranges for JSDoc work:
 *   - JSDoc nodes:     310-352 (FirstJSDocNode=310, LastJSDocNode=352)
 *   - JSDoc tag nodes: 328-352 (FirstJSDocTagNode=328, LastJSDocTagNode=352)
 *   - Declaration nodes: See individual entries (ClassDeclaration=264, FunctionDeclaration=263, etc.)
 */

/**
 * Full TypeScript `SyntaxKind` enum snapshot.
 *
 * @since 2026-03-01
