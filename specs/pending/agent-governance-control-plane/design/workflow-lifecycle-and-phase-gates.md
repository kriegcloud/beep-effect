...
This lifecycle is the required workflow for every category in this package and every consumer spec inheriting it. Consumer specs are allowed to add domain-specific checks. Consumer specs are not allowed to weaken this lifecycle.
