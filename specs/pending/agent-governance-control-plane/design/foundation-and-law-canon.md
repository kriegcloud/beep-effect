...
3. this spec package root README
4. design docs in this directory
5. closed phase outputs in `outputs/`
...
2. Generic governance text is required to live in this package instead of being copied into consumer specs.
3. Consumer specs are required to inherit this law canon rather than redefining it.
...
7. Consumer specs are not allowed to weaken the exception standard.
