...
- [phased-roadmap.md](./phased-roadmap.md) - P0-P4 workstream map, inputs, deliverables, and exit gates
- [verification-strategy.md](./verification-strategy.md) - verification matrix, repo command expectations, and known caveats
