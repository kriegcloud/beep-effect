...
## 1. Context
You are running Phase P1 of .
Follow locked defaults and phase gates in  and .

## 2. Mission
Deliver Phase P1 outputs to completion with no unresolved blockers and with next-phase handoff continuity.
...
## 6. Required outputs
Produce all artifacts for Phase P1 listed in  under that phase path.
