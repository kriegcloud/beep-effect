...
- [Persistence Summary](../../../.repos/beep-effect/packages/knowledge/_docs/PERSISTENCE_SUMMARY.md)
...
- [Workflow State Patterns](../../../.repos/beep-effect/packages/knowledge/_docs/architecture/workflow-state-patterns.md)
- [WorkflowPersistence.ts](../../../.repos/beep-effect/packages/knowledge/server/src/Workflow/WorkflowPersistence.ts)
- [ProgressStream.ts](../../../.repos/beep-effect/packages/knowledge/server/src/Workflow/ProgressStream.ts)
