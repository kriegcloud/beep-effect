...
This completed spec package was finalized under `specs/pending/effect-governance-legacy-retirement` and now lives at `specs/completed/effect-governance-legacy-retirement`.
