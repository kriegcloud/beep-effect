...
| `docs/patterns/` | Pattern library | Implementation recipes |
...
**Output**: Create `specs/.specs/ai-friendliness-audit/audit-context.md` with findings.
...
**Output**: Create `specs/.specs/ai-friendliness-audit/evaluation-report.md` with findings.
...
**Output**: Create `specs/.specs/ai-friendliness-audit/remediation-plan.md`
