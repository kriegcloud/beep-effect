...
cd specs/.specs/ai-friendliness-audit
...
- `docs/patterns/` - Pattern library (reference for evaluation)
- `specs/.specs/vertical-slice-bootstraper/reviews/` - Example of multi-agent review pattern
