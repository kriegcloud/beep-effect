# Error Handling Patterns - beep-effect codebase

## 🎯 OVERVIEW
Comprehensive error handling patterns used throughout the beep-effect codebase, emphasizing structured errors, type safety, and proper Effect composition.
...
class SystemError extends Data.TaggedError("SystemError")<{
  ...
  module: string
  method: string
  pathOrDescriptor?: undefined | string | number
  cause?: unknown
}> {
  override get message(): string {
