...
const config = {
  source: [
    ...
    "packages/installer-channels/*/package.json",
    "packages/installer-dependencies/*/package.json",
    "packages/installer-providers/*/package.json",
    "packages/installer-security/*/package.json",
    "packages/installer-workspace/*/package.json",
