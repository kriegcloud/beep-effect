...
import { Context, Effect, SchemaGetter } from "effect";
...
const $I = $AgentsDomainId.create("McpSchema");
 ...
 * @since 0.0.0
 */
export interface optionalWithDefault<Self extends S.Constraint & S.WithoutConstructorDefault>
  extends S.withConstructorDefault<S.decodeTo<S.toType<S.optionalKey<Self>>, S.optionalKey<Self>>> {}
 ...
 * @since 0.0.0
 */
export const optionalWithDefault = <Self extends S.Constraint & S.WithoutConstructorDefault>(
  schema: Self,
  defaultValue: () => S.optionalKey<Self>["Type"]
): optionalWithDefault<Self> => {
  const effect = Effect.sync(defaultValue);
  return S.optionalKey(schema).pipe(
    S.decode<S.optionalKey<Self>>({
      decode: SchemaGetter.withDefault(effect),
      encode: SchemaGetter.passthrough(),
    }),
    S.withConstructorDefault<S.decodeTo<S.toType<S.optionalKey<Self>>, S.optionalKey<Self>>>(effect)
  );
};
 ...
 * @since 0.0.0
 */
export const optional = <Self extends S.Constraint>(schema: Self): S.decodeTo<S.optional<Self>, S.optionalKey<Self>> =>
  S.optionalKey(schema).pipe(
    S.decodeTo(S.optional(schema), {
      decode: SchemaGetter.passthrough() as any,
      encode: SchemaGetter.transformOptional(O.flatMap(O.fromUndefinedOr)),
    })
  );
 ...
 * @since 0.0.0
 */
export const RequestId = S.Union([S.String, S.Finite]).pipe(
  $I.annoteSchema("RequestId", {
    description: "Schema for JSON-RPC request identifiers, allowing string or number ids.",
  })
);
 ...
 * @since 0.0.0
 */
export const ProgressToken = S.Union([S.String, S.Finite]).pipe(
  $I.annoteSchema("ProgressToken", {
    description: "Schema for MCP progress tokens that associate progress notifications with the original request.",
  })
);
 ...
 * @since 0.0.0
 */
export class RequestMeta extends S.Opaque<RequestMeta>()(
  S.Struct({
    _meta: optional(
      S.Struct({
        /**
 ...
 * @since 0.0.0
 */
export class ResultMeta extends S.Opaque<ResultMeta>()(
  S.Struct({
    /**
     * This result property is reserved by the protocol to allow clients and
     * servers to attach additional metadata to their responses.
     */
    _meta: optional(S.Record(S.String, S.Json)),
  })
) {}
 ...
 * @since 0.0.0
 */
export class NotificationMeta extends S.Opaque<NotificationMeta>()(
  S.Struct({
    /**
...
export const Cursor = S.String.pipe(
  $I.annoteSchema("Cursor", {
    description: "Schema for opaque cursor tokens used in pagination.",
  })
);
 ...
 * @since 0.0.0
 */
export class PaginatedRequestMeta extends S.Opaque<PaginatedRequestMeta>()(
  S.Struct({
    ...RequestMeta.fields,
    /**
 ...
 * @since 0.0.0
 */
export class PaginatedResultMeta extends S.Opaque<PaginatedResultMeta>()(
  S.Struct({
    ...ResultMeta.fields,
    /**
 ...
 * @since 0.0.0
 */
export const Role = LiteralKit(["user", "assistant"]).annotate(
  $I.annote("Role", {
    description: "Schema for MCP conversation roles, allowing user and assistant.",
  })
);
 ...
 * @since 0.0.0
 */
export class Annotations extends S.Opaque<Annotations>()(
  S.Struct({
    /**
     ...
     */
    audience: Role.pipe(S.Array, optional),
    /**
     ...
     */
    priority: optional(S.Finite.check(S.isBetween({ minimum: 0, maximum: 1 }))),
  })
) {}
 ...
 * @since 0.0.0
 */
export class Implementation extends S.Opaque<Implementation>()(
  S.Struct({
    name: S.String,
...
export class ClientCapabilities extends S.Class<ClientCapabilities>($I`ClientCapabilities`)(
  {
     ...
     */
    experimental: optional(S.Record(S.String, S.Struct({}))),
    /**
     ...
     */
    extensions: optional(S.Record(S.TemplateLiteral([S.String, "/", S.String]), S.Json)),
    /**
    ...
    roots: optional(
      S.Struct({
         ...
         */
        listChanged: optional(S.Boolean),
      })
    ),
    /**
     * Present if the client supports sampling from an LLM.
     */
    sampling: optional(S.Struct({})),
    /**
     * Present if the client supports elicitation from the server.
     */
    elicitation: optional(S.Struct({})),
  },
  $I.annote("ClientCapabilities", {
    description: "Describes capabilities advertised by an MCP client.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ServerCapabilities extends S.Opaque<ServerCapabilities>()(
  S.Struct({
    /**
     ...
     */
    logging: optional(S.Struct({})),
    /**
     * Present if the server supports argument autocompletion suggestions.
     */
    completions: optional(S.Struct({})),
    /**
 ...
 * @since 0.0.0
 */
export class McpErrorBase extends S.Class<McpErrorBase>($I`McpErrorBase`)(
  {
    /**
  ...
  $I.annote("McpErrorBase", {
    description: "Schema for MCP and JSON-RPC error objects.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ParseError extends S.ErrorClass<ParseError>($I`ParseError`)(
  {
    ...McpErrorBase.fields,
    _tag: S.tag("ParseError"),
    code: S.tag(PARSE_ERROR_CODE),
  },
  $I.annote("ParseError", {
    description: "MCP/JSON-RPC error for invalid JSON that could not be parsed.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class InvalidRequest extends S.ErrorClass<InvalidRequest>($I`InvalidRequest`)(
  {
    ...McpErrorBase.fields,
    _tag: S.tag("InvalidRequest"),
    code: S.tag(INVALID_REQUEST_ERROR_CODE),
  },
  $I.annote("InvalidRequest", {
    description: "MCP/JSON-RPC error for a request object that is not valid.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class MethodNotFound extends S.ErrorClass<MethodNotFound>($I`MethodNotFound`)(
  {
    ...McpErrorBase.fields,
    _tag: S.tag("MethodNotFound"),
    code: S.tag(METHOD_NOT_FOUND_ERROR_CODE),
  },
  $I.annote("MethodNotFound", {
    description: "MCP/JSON-RPC error for an unavailable method.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class InvalidParams extends S.ErrorClass<InvalidParams>($I`InvalidParams`)(
  {
    ...McpErrorBase.fields,
    _tag: S.tag("InvalidParams"),
    code: S.tag(INVALID_PARAMS_ERROR_CODE),
  },
  $I.annote("InvalidParams", {
    description: "MCP/JSON-RPC error for invalid method parameters.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class InternalError extends S.ErrorClass<InternalError>($I`InternalError`)(
  {
    ...McpErrorBase.fields,
    _tag: S.tag("InternalError"),
    code: S.tag(INTERNAL_ERROR_CODE),
  },
  $I.annote("InternalError", {
    description: "MCP/JSON-RPC error for unexpected internal server failures.",
  })
) {
  static readonly notImplemented = InternalError.make({ message: "Not implemented" });
}
...
export class Ping extends Rpc.make("ping", {
  success: S.Struct({}),
  error: McpError,
  payload: S.UndefinedOr(RequestMeta),
}) {}
 ...
 * @since 0.0.0
 */
export class InitializeResult extends S.Opaque<InitializeResult>()(
  S.Struct({
    ...ResultMeta.fields,
    /**
     ...
     */
    instructions: optional(S.String),
  })
) {}
...
export class InitializedNotification extends Rpc.make("notifications/initialized", {
  payload: S.UndefinedOr(NotificationMeta),
}) {}
...
export class ProgressNotification extends Rpc.make("notifications/progress", {
  payload: {
     ...
     */
    progress: optional(S.Finite),
    /**
     * Total number of items to process (or total progress required), if known.
     */
    total: optional(S.Finite),
    /**
     * An optional message describing the current progress.
     */
    message: optional(S.String),
  },
}) {}
...
export class Resource extends S.Class<Resource>($I`Resource`)(
  ...
  $I.annote("Resource", {
    description: "Schema for a known resource that the server is capable of reading.",
  })
) {}
...
export class ResourceTemplate extends S.Class<ResourceTemplate>($I`ResourceTemplate`)(
  ...
  $I.annote("ResourceTemplate", {
    description: "Schema for a template description of resources available on the server.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ResourceContents extends S.Opaque<ResourceContents>()(
  S.Struct({
    /**
     * The URI of this resource.
     */
 ...
 * @since 0.0.0
 */
export class TextResourceContents extends S.Opaque<TextResourceContents>()(
  S.Struct({
 ...
 * @since 0.0.0
 */
export class BlobResourceContents extends S.Opaque<BlobResourceContents>()(
  S.Struct({
    ...ResourceContents.fields,
    /**
 ...
 * @since 0.0.0
 */
export class ListResourcesResult extends S.Class<ListResourcesResult>($I`ListResourcesResult`)(
  {
    ...PaginatedResultMeta.fields,
    resources: S.Array(Resource),
  },
  $I.annote("ListResourcesResult", {
    description: "Server's response to a resources/list request from the client.",
  })
) {}
...
export class ListResources extends Rpc.make("resources/list", {
  ...
  error: McpError,
  payload: S.UndefinedOr(PaginatedRequestMeta),
}) {}
 ...
 * @since 0.0.0
 */
export class ListResourceTemplatesResult extends S.Class<ListResourceTemplatesResult>($I`ListResourceTemplatesResult`)(
  {
    ...PaginatedResultMeta.fields,
    resourceTemplates: S.Array(ResourceTemplate),
  },
  $I.annote("ListResourceTemplatesResult", {
    description: "Server's response to a resources/templates/list request from the client.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ReadResourceResult extends S.Opaque<ReadResourceResult>()(
  S.Struct({
    ...ResultMeta.fields,
    contents: S.Array(S.Union([TextResourceContents, BlobResourceContents])),
  })
) {}
 ...
 * @since 0.0.0
 */
export class PromptArgument extends S.Opaque<PromptArgument>()(
  S.Struct({
    /**
...
export class Prompt extends S.Class<Prompt>($I`Prompt`)(
  {
     ...
     */
    arguments: PromptArgument.pipe(S.Array, optional),
  },
  $I.annote("Prompt", {
 ...
 * @since 0.0.0
 */
export class TextContent extends S.Opaque<TextContent>()(
  S.Struct({
    type: S.tag("text"),
    /**
 ...
 * @since 0.0.0
 */
export class ImageContent extends S.Opaque<ImageContent>()(
  S.Struct({
    type: S.tag("image"),
    /**
     * The image data.
 ...
 * @since 0.0.0
 */
export class AudioContent extends S.Opaque<AudioContent>()(
  S.Struct({
    type: S.tag("audio"),
    /**
     * The audio data.
 ...
 * @since 0.0.0
 */
export class EmbeddedResource extends S.Opaque<EmbeddedResource>()(
  S.Struct({
    type: S.tag("resource"),
    resource: S.Union([TextResourceContents, BlobResourceContents]),
    /**
     * Optional annotations for the client.
     */
    annotations: optional(Annotations),
 ...
 * @since 0.0.0
 */
export class ResourceLink extends S.Opaque<ResourceLink>()(
  S.Struct({
    ...Resource.fields,
    type: S.tag("resource_link"),
  })
) {}
 ...
 * @since 0.0.0
 */
export const ContentBlock = S.Union([TextContent, ImageContent, AudioContent, EmbeddedResource, ResourceLink]).pipe(
  $I.annoteSchema("ContentBlock", {
    description: "Schema for MCP content blocks that can appear in prompt messages or tool results.",
  })
);
 ...
 * @since 0.0.0
 */
export class PromptMessage extends S.Opaque<PromptMessage>()(
  S.Struct({
    role: Role,
 ...
 * @since 0.0.0
 */
export class ListPromptsResult extends S.Class<ListPromptsResult>($I`ListPromptsResult`)(
  {
    ...PaginatedResultMeta.fields,
    prompts: S.Array(Prompt),
  },
  $I.annote("ListPromptsResult", {
    description: "Server response to a prompts/list request from the client.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class GetPromptResult extends S.Class<GetPromptResult>($I`GetPromptResult`)(
  {
    ...ResultMeta.fields,
    messages: S.Array(PromptMessage),
    /**
     * An optional description for the prompt.
     */
    description: optional(S.String),
  },
  $I.annote("GetPromptResult", {
    description: "Server response to a prompts/get request from the client.",
  })
) {}
...
export class GetPrompt extends Rpc.make("prompts/get", {
  ...
  payload: {
     ...
     */
    arguments: optional(S.Record(S.String, S.String)),
  },
}) {}
 ...
 * @since 0.0.0
 */
export class ToolAnnotations extends S.Opaque<ToolAnnotations>()(
  S.Struct({
    /**
     ...
     * Default: `false`
     */
    readOnlyHint: optionalWithDefault(S.Boolean, constFalse),
    /**
     ...
     * Default: `true`
     */
    destructiveHint: optionalWithDefault(S.Boolean, constTrue),
    /**
     ...
     * Default: `false`
     */
    idempotentHint: optionalWithDefault(S.Boolean, constFalse),
    /**
     ...
     * Default: `true`
     */
    openWorldHint: optionalWithDefault(S.Boolean, constTrue),
  })
) {}
...
export class Tool extends S.Class<Tool>($I`Tool`)(
  ...
  $I.annote("Tool", {
    description: "Schema for the definition of a tool the client can call.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ListToolsResult extends S.Class<ListToolsResult>($I`ListToolsResult`)(
  {
    ...PaginatedResultMeta.fields,
    tools: S.Array(Tool),
  },
  $I.annote("ListToolsResult", {
    description: "Server's response to a tools/list request from the client.",
  })
) {}
...
export class CallToolResult extends S.Class<CallToolResult>($I`CallToolResult`)(
  {
    ...
    structuredContent: optional(S.Any),
    /**
     * Whether the tool call ended in an error.
     *
     * If not set, this is assumed to be false (the call was successful).
     */
    isError: optional(S.Boolean),
  },
  $I.annote("CallToolResult", {
    description: "Schema for the server's response to a tool call.",
  })
) {}
...
export const LoggingLevel = LiteralKit([
  ...
  $I.annote("LoggingLevel", {
    description:
      "Schema for log message severity levels, mapped to syslog message severities (RFC 5424 section 6.2.1).",
  })
);
 ...
 * @since 0.0.0
 */
export class SamplingMessage extends S.Opaque<SamplingMessage>()(
  S.Struct({
    role: Role,
    content: S.Union([TextContent, ImageContent, AudioContent]),
  })
) {}
 ...
 * @since 0.0.0
 */
export class ModelHint extends S.Opaque<ModelHint>()(
  S.Struct({
    /**
...
export class ModelPreferences extends S.Class<ModelPreferences>($I`ModelPreferences`)(
  {
     ...
     */
    hints: ModelHint.pipe(S.Array, optional),
    /**
     * How much to prioritize cost when selecting a model. A value of 0 means cost
     * is not important, while a value of 1 means cost is the most important
     * factor.
     */
    costPriority: optional(S.Finite.check(S.isBetween({ minimum: 0, maximum: 1 }))),
    /**
     * How much to prioritize sampling speed (latency) when selecting a model. A
     * value of 0 means speed is not important, while a value of 1 means speed is
     * the most important factor.
     */
    speedPriority: optional(S.Finite.check(S.isBetween({ minimum: 0, maximum: 1 }))),
    /**
     * How much to prioritize intelligence and capabilities when selecting a
     * model. A value of 0 means intelligence is not important, while a value of 1
     * means intelligence is the most important factor.
     */
    intelligencePriority: optional(S.Finite.check(S.isBetween({ minimum: 0, maximum: 1 }))),
  },
  $I.annote("ModelPreferences", {
    description: "Server's model selection preferences requested of the client during sampling.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class CreateMessageResult extends S.Class<CreateMessageResult>($I`CreateMessageResult`)(
  {
    /**
     ...
     */
    stopReason: optional(S.String),
  },
  $I.annote("CreateMessageResult", {
    description: "Client response to an MCP sampling request.",
  })
) {}
...
export class CreateMessage extends Rpc.make("sampling/createMessage", {
  ...
  error: McpError,
  payload: {
    messages: S.Array(SamplingMessage),
    /**
     ...
     */
    systemPrompt: optional(S.String),
    /**
     * A request to include context from one or more MCP servers (including the
     * caller), to be attached to the prompt. The client MAY ignore this request.
     */
    includeContext: optional(LiteralKit(["none", "thisServer", "allServers"])),
    temperature: optional(S.Finite),
    /**
     * The maximum number of tokens to sample, as requested by the server. The
     * client MAY choose to sample fewer tokens than requested.
     */
    maxTokens: S.Finite,
    stopSequences: S.String.pipe(S.Array, optional),
    /**
 ...
 * @since 0.0.0
 */
export class ResourceReference extends S.Opaque<ResourceReference>()(
  S.Struct({
    type: S.tag("ref/resource"),
    /**
 ...
 * @since 0.0.0
 */
export class PromptReference extends S.Opaque<PromptReference>()(
  S.Struct({
    type: S.tag("ref/prompt"),
    /**
     * The name of the prompt or prompt template
     */
    name: S.String,
 ...
 * @since 0.0.0
 */
export class CompleteResult extends S.Opaque<CompleteResult>()(
  S.Struct({
    completion: S.Struct({
      /**
...
export class Complete extends Rpc.make("completion/complete", {
  ...
  error: McpError,
  payload: S.Struct({
    ref: S.Union([PromptReference, ResourceReference]),
    /**
    ...
    context: optionalWithDefault(
      S.Struct({
         ...
         */
        arguments: optionalWithDefault(S.Record(S.String, S.String), () => ({})),
      }),
      () => ({ arguments: {} })
    ),
  }),
...
export class Root extends S.Class<Root>($I`Root`)(
  ...
  $I.annote("Root", {
    description: "A root directory or file that the server can operate on.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ListRootsResult extends S.Class<ListRootsResult>($I`ListRootsResult`)(
  {
    roots: S.Array(Root),
  },
  $I.annote("ListRootsResult", {
    description: "Client response containing the roots available to the server.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ElicitAcceptResult extends S.Class<ElicitAcceptResult>($I`ElicitAcceptResult`)(
  {
    ...ResultMeta.fields,
    /**
  ...
  $I.annote("ElicitAcceptResult", {
    description: "Accepted client response to an elicitation request.",
  })
) {}
 ...
 * @since 0.0.0
 */
export class ElicitDeclineResult extends S.Class<ElicitDeclineResult>($I`ElicitDeclineResult`)(
  {
    ...ResultMeta.fields,
    /**
     * The user action in response to the elicitation.
     ...
     * - "cancel": User dismissed without making an explicit choice
     */
    action: S.Literals(["cancel", "decline"]),
  },
  $I.annote("ElicitDeclineResult", {
    description: "Declined or canceled client response to an elicitation request.",
  })
) {}
 ...
 * @since 0.0.0
 */
export const ElicitResult = S.Union([ElicitAcceptResult, ElicitDeclineResult]).pipe(
  $I.annoteSchema("ElicitResult", {
    description: "Schema for every client response to an elicitation request.",
  })
);
...
export class Elicit extends Rpc.make("elicitation/create", {
  ...
  payload: {
    ...
    message: S.String,
    /**
     * A restricted subset of JSON S.
     * Only top-level properties are allowed, without nesting.
     */
    requestedSchema: S.Any,
  },
}) {}
 ...
 * @since 0.0.0
 */
export class ElicitationDeclined extends S.ErrorClass<ElicitationDeclined>($I`ElicitationDeclined`)(
  {
    _tag: S.tag("ElicitationDeclined"),
    request: Elicit.payloadSchema,
    cause: optional(S.Defect()),
  },
  $I.annote("ElicitationDeclined", {
    description:
 ...
 * @since 0.0.0
 */
export function isParam(schema: S.Constraint): schema is Param<string, S.Top> {
  return P.hasProperty(schema, ParamSchemaTypeId);
}
 ...
 * @since 0.0.0
 */
export interface Param<Name extends string, Self extends S.Constraint>
  extends S.BottomLazy<
    Self["ast"],
    Param<Name, Self>,
    Self["~type.parameters"],
    Self["~type.mutability"],
    Self["~type.optionality"],
    Self["~type.constructor.default"],
    Self["~encoded.mutability"],
    Self["~encoded.optionality"]
  > {
  readonly Type: Self["Type"];
  readonly Encoded: Self["Encoded"];
  readonly DecodingServices: Self["DecodingServices"];
  readonly EncodingServices: Self["EncodingServices"];
  readonly Rebuild: Param<Name, Self>;
  readonly "~type.make.in": Self["~type.make.in"];
  readonly "~type.make": Self["~type.make"];
  readonly Iso: Self["Iso"];
 ...
 * @since 0.0.0
 */
export function param<const Name extends string, Self extends S.Constraint>(
  name: Name,
  schema: Self
): Param<Name, Self> {
  return S.make(schema.ast, { [ParamSchemaTypeId]: ParamSchemaTypeId, name, schema });
}
 ...
 * @since 0.0.0
 */
export class EnabledWhen extends Context.Service<EnabledWhen, P.Predicate<typeof Initialize.payloadSchema.Type>>()(
  $I`EnabledWhen`
) {}
