...
const $I = $AgentsDomainId.create("ResponseIdTracker");
...
export interface Service {
  ...
  prepareUnsafe(prompt: Prompt.Prompt): O.Option<PrepareResult>;
}
 ...
 * @since 0.0.0
 */
export class ResponseIdTracker extends Context.Service<ResponseIdTracker, Service>()($I`ResponseIdTracker`) {}
