...
| P7-T5 Graphiti Recovery Automation | P1 | [#65](https://github.com/kriegcloud/beep-effect/issues/65) | RESOLVED | Recovery script now includes `--dry-run` validation path and successful smoke run with forced rehydrate evidence; package script added for CI/local checks. | `outputs/p7-kg-excellence/recovery-automation-report.md`, `outputs/p7-kg-excellence/evidence/20260226T010811Z-graphiti-recover-dry-run.log`, `outputs/p7-kg-excellence/evidence/20260226T010811Z-graphiti-recover-smoke.log` |
