...
- `Specified`: JSDoc fibration and agent-pipeline design is documented in `initiatives/repo-codegraph-jsdoc/history/outputs/JSDOC_FIBRATION_ARCHITECTURE.md`.
...
| Fibration | Schema annotation + payload split, narrowed outputs, pipeline roles | `initiatives/repo-codegraph-jsdoc/history/outputs/JSDOC_FIBRATION_ARCHITECTURE.md` | `Specified` |
| NLP | six-module architecture, claim decomposition and budgeting | `initiatives/repo-codegraph-jsdoc/history/outputs/Building a code-aware NLP service in TypeScript.md` | `Specified` |
