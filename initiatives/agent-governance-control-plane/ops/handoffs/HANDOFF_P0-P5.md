...
Create a reusable repo-wide governance control plane that future initiatives inherit instead of re-creating generic laws, auditors, and packet contracts locally.

## Locked Defaults

1. The package path is `initiatives/agent-governance-control-plane`.
2. The packet structure mirrors the repo's strong phased-initiative pattern.
