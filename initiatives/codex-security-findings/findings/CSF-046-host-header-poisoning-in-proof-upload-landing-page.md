...
- Verification command: `node --check initiatives/stack-installer/ops/proof-upload-server.mjs && node initiatives/stack-installer/ops/proof-upload-smoke.mjs`
- Changed files:
...
The proof upload helper is treated as committed internal ops tooling under initiatives/stack-installer/ops, not as the main Beep repo-memory runtime or desktop product described in the threat model.
