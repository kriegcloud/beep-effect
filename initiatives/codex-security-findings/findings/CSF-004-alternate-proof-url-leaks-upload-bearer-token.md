...
- Verification command: `node initiatives/stack-installer/ops/proof-upload-smoke.mjs`
- Changed files:
  - initiatives/stack-installer/ops/proof-upload-server.mjs
  - initiatives/stack-installer/ops/proof-upload-smoke.mjs
...
The earlier threat model did not explicitly cover initiatives/stack-installer/ops, so scope is inferred from repository documentation rather than a declared production deployment model.
