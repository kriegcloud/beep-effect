...
- Verification command: `node --check initiatives/stack-installer/ops/start-proof-upload-window.mjs && node initiatives/stack-installer/ops/proof-upload-smoke.mjs`
- Changed files:
