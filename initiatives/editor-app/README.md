...
This initiative defines the local-first editor application direction for the
repository. It separates the editor product thesis from repo-memory while
keeping the canonical document model and runtime boundaries explicit.
