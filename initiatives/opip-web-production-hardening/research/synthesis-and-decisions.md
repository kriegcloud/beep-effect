...
OPIP production hardening is managed-first, lean, and review-gated.
...
- `apps/opip-web` owns OPIP content contracts, fallback data, form validation,
  legal notices, and product presentation.
- `infra` owns Vercel, Cloudflare, and AWS/Pulumi provisioning.
- `@beep/ui` receives no OPIP-specific theme or content.

## Explicitly Deferred

- Dedicated OPIP AWS organization.
