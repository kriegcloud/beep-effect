...
[history/httpapi-rpc-pivot.md](./history/httpapi-rpc-pivot.md) remains valuable, but only as supporting evidence.
...
- [history/cluster-first-repo-expert-memory-plan.md](./history/cluster-first-repo-expert-memory-plan.md)
