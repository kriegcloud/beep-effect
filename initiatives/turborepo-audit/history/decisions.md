...
- Audit support root: `initiatives/turborepo-audit`
- Canonical topic outputs: `initiatives/turborepo-audit/history/outputs/{topic-id}.md`
- Canonical summary output: `initiatives/turborepo-audit/history/outputs/_turborepo-orchestrator-summary.md`
- Shared support doc: `initiatives/turborepo-audit/OFFICIAL_TOPIC_SURFACE_MAP.md`
- This decisions log is intentionally separate from the orchestrator summary.
- The audit was initially drafted against a nested output folder during authoring, but the final deliverables were normalized into `initiatives/turborepo-audit/history/outputs` to match the original output contract and avoid duplicate sources of truth.
