...
## Completion Evidence
 ...
 - commands:
   ...
   - `git diff --check`
   - `node initiatives/stack-installer/ops/p1-completion-check.mjs --output-root output/stack-installer/p1-live --base-ref origin/main`
...
- files changed:
   - initiative packet and review outputs under `initiatives/stack-installer/**`
