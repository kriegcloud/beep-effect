...
3. Read the initiative packet:
   - `initiatives/ai-metrics-stack/SPEC.md`
   - `initiatives/ai-metrics-stack/PLAN.md`
   - `initiatives/ai-metrics-stack/README.md`
   - `initiatives/ai-metrics-stack/ops/manifest.json`
   - `initiatives/ai-metrics-stack/ops/handoffs/HANDOFF_P0-P6.md`
   - all files under `initiatives/ai-metrics-stack/history/outputs/`
...
rg -n "ai-metrics|AIMetrics|CodexTranscriptLine|ClaudeTranscriptLine|sourceRole|subagent|forwarder|scorecard|otlp" \
  initiatives/ai-metrics-stack packages/tooling/library/ai-metrics packages/tooling/tool/cli/src/commands/AIMetrics infra/src
...
- `initiatives/ai-metrics-stack/PLAN.md`
- `initiatives/ai-metrics-stack/ops/manifest.json`
- a new `initiatives/ai-metrics-stack/history/outputs/...` report
