...
- Phase 0 is explicitly read-only and must preserve the full quality proof:
  `initiatives/repo-quality-acceleration/SPEC.md:41-70`,
  `initiatives/repo-quality-acceleration/SPEC.md:127-139`, and
  `initiatives/repo-quality-acceleration/ops/prompts/parallel-explorer.md:17-27`.
...
- `package.json`
- `turbo.json`
- `initiatives/repo-quality-acceleration/README.md`
- `initiatives/repo-quality-acceleration/SPEC.md`
- `initiatives/repo-quality-acceleration/PLAN.md`
- `initiatives/repo-quality-acceleration/ops/manifest.json`
- `initiatives/repo-quality-acceleration/ops/prompts/parallel-explorer.md`
