...
```sh
test -s initiatives/repo-quality-acceleration/research/ci-timing-and-setup.md
test -s initiatives/repo-quality-acceleration/research/turbo-cache-and-scope.md
test -s initiatives/repo-quality-acceleration/research/repo-cli-orchestration.md
test -s initiatives/repo-quality-acceleration/research/docgen-selective-checking.md
test -s initiatives/repo-quality-acceleration/research/quality-safety-semantics.md
test -s initiatives/repo-quality-acceleration/history/outputs/phase0-synthesis.md
```

```sh
rg -n "^(# |## Current-State Findings|## Evidence|## Candidate Interventions|## Do Not Do|## Open Questions)" initiatives/repo-quality-acceleration/research
rg -n "impact|risk|cost|verification|fallback|full proof|Do not" initiatives/repo-quality-acceleration/history/outputs/phase0-synthesis.md
