...
- [SPEC.md](../../SPEC.md) — Source-of-Truth Contract (7 ontology URLs), Planned Node Types table, Planned Edge Types table
- [manifest.json](../manifest.json) — Phase status tracking
...
P0 is complete when `history/outputs/p0-ontology-research.md` exists with all 7 ontology sections substantively populated and the class-to-node-type mapping covers all 15 planned node types.
