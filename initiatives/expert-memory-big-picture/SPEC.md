...
- [Repo Codegraph JSDoc SPEC](../repo-codegraph-jsdoc/SPEC.md)
- [Semantic KG Integration Explained](../repo-codegraph-jsdoc/research/semantic-kg-integration-explained.md)
...
- `./.repos/beep-effect/packages/knowledge/_docs/INDEX.md` (historical archive path, not checked into this checkout)
