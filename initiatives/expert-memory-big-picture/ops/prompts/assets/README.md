...
- [spec-creator-prompt.md](./spec-creator-prompt.md)
  Use when you want an agent to create a new initiative packet with a normative spec.
...
- Creating new initiative packets: start with [spec-creator-prompt.md](./spec-creator-prompt.md).
