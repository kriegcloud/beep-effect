...
- deterministic extraction and certainty tiers in [Repo Codegraph JSDoc SPEC](../repo-codegraph-jsdoc/SPEC.md)
- semantic overlay, validation, provenance, and temporal concerns in [Semantic KG Integration Explained](../repo-codegraph-jsdoc/research/semantic-kg-integration-explained.md)
...
- `./.repos/beep-effect/packages/knowledge/_docs/architecture/system-architecture.md` (historical archive path, not checked into this checkout)
...
- `./.repos/beep-effect/packages/knowledge/server/src/GraphRAG/GraphRAGService.ts` (historical archive path, not checked into this checkout)
