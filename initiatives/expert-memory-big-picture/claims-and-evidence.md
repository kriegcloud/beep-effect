...
- `./.repos/beep-effect/packages/knowledge/domain/src/entities/MentionRecord/MentionRecord.model.ts` (historical archive path, not checked into this checkout)
- `./.repos/beep-effect/packages/knowledge/domain/src/entities/RelationEvidence/RelationEvidence.model.ts` (historical archive path, not checked into this checkout)
- `./.repos/beep-effect/packages/knowledge/server/src/GraphRAG/CitationValidator.ts` (historical archive path, not checked into this checkout)
- `./.repos/beep-effect/packages/knowledge/server/src/GraphRAG/ReasoningTraceFormatter.ts` (historical archive path, not checked into this checkout)
- `./.repos/beep-effect/packages/knowledge/server/src/Rdf/ProvenanceEmitter.ts` (historical archive path, not checked into this checkout)
- `./.repos/beep-effect/packages/knowledge/_docs/mvp/ARCHITECTURAL_DECISIONS_MVP.md` (historical archive path, not checked into this checkout)
