...
- the vendored legacy knowledge slice package docs at `./.repos/beep-effect/packages/knowledge/{server,client,ui}/README.md` (historical archive paths, not checked into this checkout)
