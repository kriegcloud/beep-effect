# @beep/_test-license-1771561808031 Agent Guide
...
## Quick Recipes
```ts
import { VERSION } from "@beep/_test-license-1771561808031"
```

## Verifications
- `bunx turbo run test --filter=@beep/_test-license-1771561808031`
- `bunx turbo run lint --filter=@beep/_test-license-1771561808031`
- `bunx turbo run check --filter=@beep/_test-license-1771561808031`
