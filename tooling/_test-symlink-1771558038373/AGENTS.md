# @beep/_test-symlink-1771558038373 Agent Guide
...
## Quick Recipes
```ts
import { VERSION } from "@beep/_test-symlink-1771558038373"
```

## Verifications
- `bunx turbo run test --filter=@beep/_test-symlink-1771558038373`
- `bunx turbo run lint --filter=@beep/_test-symlink-1771558038373`
- `bunx turbo run check --filter=@beep/_test-symlink-1771558038373`
