# @beep/_test-idempotent-1771560353205 Agent Guide
...
## Quick Recipes
```ts
import { VERSION } from "@beep/_test-idempotent-1771560353205"
```

## Verifications
- `bunx turbo run test --filter=@beep/_test-idempotent-1771560353205`
- `bunx turbo run lint --filter=@beep/_test-idempotent-1771560353205`
- `bunx turbo run check --filter=@beep/_test-idempotent-1771560353205`
