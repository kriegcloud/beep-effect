...
import {
  ...
  SymbolKind,
  SymbolQualifiedName,
} from "./TSMorph/TSMorph.model.ts";

const DemoSymbolId = S.TemplateLiteral([
  SymbolFilePath,
  "::",
  SymbolQualifiedName,
  "#",
...
const DemoSymbolIdParts = S.TemplateLiteralParser([
  SymbolFilePath,
  "::",
  SymbolQualifiedName,
  "#",
...
const demoSymbolId = decodeDemoSymbolId(
  `${demoFilePath}::${demoQualifiedName}#${demoKind}`
);
