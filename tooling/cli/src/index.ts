...
const repoCommand = CliCommand.make("beep").pipe(
  ...
  CliCommand.withSubcommands([envCommand, syncCommand])
);
...
const runtimeLayers = Layer.mergeAll(BunContext.layer, BunTerminal.layer, BunFileSystem.layer, BunPath.layerPosix);
