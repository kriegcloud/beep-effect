...
describe("createContentSecurityPolicyHeader", () => {
  ...
  describe("when giving an object", () => {
    const dummyOption: Parameters<
      typeof createContentSecurityPolicyOptionHeaderValue
    >[0] = {
      directives: { childSrc: "'self'", objectSrc: "https://example.com" },
    };

    let properHeaderNameGetterMock: ReturnType<
      typeof mock<typeof getProperHeaderName>
    >;
    let headerValueCreatorMock: ReturnType<
      typeof mock<typeof createContentSecurityPolicyOptionHeaderValue>
    >;
...
describe("createContentSecurityPolicyOptionHeaderValue", () => {
  ...
  describe("when giving an object", () => {
    ...
    let fetchDirectiveToStringConverterMock: ReturnType<
      typeof mock<typeof convertFetchDirectiveToString>
    >;
    let documentDirectiveToStringConverterMock: ReturnType<
      typeof mock<typeof convertDocumentDirectiveToString>
    >;
    let navigationDirectiveToStringConverterMock: ReturnType<
      typeof mock<typeof convertNavigationDirectiveToString>
    >;
    let reportingDirectiveToStringConverterMock: ReturnType<
      typeof mock<typeof convertReportingDirectiveToString>
    >;

    beforeEach(() => {
      fetchDirectiveToStringConverterMock = mock(convertFetchDirectiveToString);
      documentDirectiveToStringConverterMock = mock(
        convertDocumentDirectiveToString
      );
      navigationDirectiveToStringConverterMock = mock(
        convertNavigationDirectiveToString
      );
      reportingDirectiveToStringConverterMock = mock(
        convertReportingDirectiveToString
      );
    });
    ...
    it("should call the second argument with directives", () => {
      ...
      expect(fetchDirectiveToStringConverterMock).toBeCalledWith(
        dummyOption.directives
      );
    });
    ...
    it("should call the third argument with directives", () => {
      ...
      expect(documentDirectiveToStringConverterMock).toBeCalledWith(
        dummyOption.directives
      );
    });
    ...
    it("should call the fourth argument with directives", () => {
      ...
      expect(navigationDirectiveToStringConverterMock).toBeCalledWith(
        dummyOption.directives
      );
    });
    ...
    it("should call the fifth argument with directives", () => {
      ...
      expect(reportingDirectiveToStringConverterMock).toBeCalledWith(
        dummyOption.directives
      );
    });
...
describe("getProperHeaderName", () => {
  ...
  describe("when giving true", () => {
    it('should return "Content-Security-Policy-Report-Only"', () => {
      expect(getProperHeaderName(true)).toBe(
...
describe("createDirectiveValue", () => {
  it("should join arguments using one half-space", () => {
    ...
    expect(createDirectiveValue(directiveName, values)).toBe(
      `${directiveName} ${values.join(" ")}`
    );
    expect(createDirectiveValue(directiveName, values[0]!)).toBe(
      `${directiveName} ${values[0]}`
    );
  });
  ...
  it("should call the third argument with the second argument", () => {
    ...
    createDirectiveValue(
      directiveName,
      values,
      arrayWrapperMock as typeof wrapArray
    );
...
describe("convertFetchDirectiveToString", () => {
  ...
  describe('when giving an object which has "childSrc" property', () => {
    it('should return value which includes "child-src"', () => {
      expect(convertFetchDirectiveToString({ childSrc: "'self'" })).toBe(
        "child-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "child-src": "'self'" })).toBe(
        "child-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "connectSrc" property', () => {
    it('should return value which includes "connect-src"', () => {
      expect(convertFetchDirectiveToString({ connectSrc: "'self'" })).toBe(
        "connect-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "connect-src": "'self'" })).toBe(
        "connect-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "defaultSrc" property', () => {
    it('should return value which includes "default-src"', () => {
      expect(convertFetchDirectiveToString({ defaultSrc: "'self'" })).toBe(
        "default-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "default-src": "'self'" })).toBe(
        "default-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "fontSrc" property', () => {
    it('should return value which includes "font-src"', () => {
      expect(convertFetchDirectiveToString({ fontSrc: "'self'" })).toBe(
        "font-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "font-src": "'self'" })).toBe(
        "font-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "frameSrc" property', () => {
    it('should return value which includes "frame-src"', () => {
      expect(convertFetchDirectiveToString({ frameSrc: "'self'" })).toBe(
        "frame-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "frame-src": "'self'" })).toBe(
        "frame-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "imgSrc" property', () => {
    it('should return value which includes "img-src"', () => {
      expect(convertFetchDirectiveToString({ imgSrc: "'self'" })).toBe(
        "img-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "img-src": "'self'" })).toBe(
        "img-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "manifestSrc" property', () => {
    it('should return value which includes "manifest-src"', () => {
      expect(convertFetchDirectiveToString({ manifestSrc: "'self'" })).toBe(
        "manifest-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "manifest-src": "'self'" })).toBe(
        "manifest-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "mediaSrc" property', () => {
    it('should return value which includes "media-src"', () => {
      expect(convertFetchDirectiveToString({ mediaSrc: "'self'" })).toBe(
        "media-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "media-src": "'self'" })).toBe(
        "media-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "prefetchSrc" property', () => {
    it('should return value which includes "prefetch-src"', () => {
      expect(convertFetchDirectiveToString({ prefetchSrc: "'self'" })).toBe(
        "prefetch-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "prefetch-src": "'self'" })).toBe(
        "prefetch-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "objectSrc" property', () => {
    it('should return value which includes "object-src"', () => {
      expect(convertFetchDirectiveToString({ objectSrc: "'self'" })).toBe(
        "object-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "object-src": "'self'" })).toBe(
        "object-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "scriptSrc" property', () => {
    it('should return value which includes "script-src"', () => {
      expect(convertFetchDirectiveToString({ scriptSrc: "'self'" })).toBe(
        "script-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "script-src": "'self'" })).toBe(
        "script-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "scriptSrcElem" property', () => {
    it('should return value which includes "script-src-elem"', () => {
      expect(convertFetchDirectiveToString({ scriptSrcElem: "'self'" })).toBe(
      ...
      expect(
        convertFetchDirectiveToString({ "script-src-elem": "'self'" })
      ).toBe("script-src-elem 'self'");
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "scriptSrcAttr" property', () => {
    it('should return value which includes "script-src-attr"', () => {
      expect(convertFetchDirectiveToString({ scriptSrcAttr: "'self'" })).toBe(
      ...
      expect(
        convertFetchDirectiveToString({ "script-src-attr": "'self'" })
      ).toBe("script-src-attr 'self'");
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "styleSrc" property', () => {
    it('should return value which includes "style-src"', () => {
      expect(convertFetchDirectiveToString({ styleSrc: "'self'" })).toBe(
        "style-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "style-src": "'self'" })).toBe(
        "style-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "styleSrcElem" property', () => {
    it('should return value which includes "style-src-elem"', () => {
      expect(convertFetchDirectiveToString({ styleSrcElem: "'self'" })).toBe(
        "style-src-elem 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "style-src-elem": "'self'" })).toBe(
        "style-src-elem 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "styleSrcAttr" property', () => {
    it('should return value which includes "style-src-attr"', () => {
      expect(convertFetchDirectiveToString({ styleSrcAttr: "'self'" })).toBe(
        "style-src-attr 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "style-src-attr": "'self'" })).toBe(
        "style-src-attr 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe('when giving an object which has "workerSrc" property', () => {
    it('should return value which includes "worker-src"', () => {
      expect(convertFetchDirectiveToString({ workerSrc: "'self'" })).toBe(
        "worker-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
      ...
      expect(convertFetchDirectiveToString({ "worker-src": "'self'" })).toBe(
        "worker-src 'self'"
      );
      expect(
        convertFetchDirectiveToString({
  ...
  describe("when giving an object which has one or more properties", () => {
    it('should return value which includes their directive names joined "; "', () => {
      expect(
        ...
        "child-src 'self'; object-src https://example.com/; style-src 'unsafe-inline'"
      );
...
describe("convertDocumentDirectiveToString", () => {
  ...
  describe('when giving an object which has "baseURI" property', () => {
    it('should return value which includes "base-uri"', () => {
      expect(convertDocumentDirectiveToString({ baseURI: "'self'" })).toBe(
        "base-uri 'self'"
      );
      expect(
        convertDocumentDirectiveToString({
      ...
      expect(convertDocumentDirectiveToString({ "base-uri": "'self'" })).toBe(
        "base-uri 'self'"
      );
      expect(
        convertDocumentDirectiveToString({
  ...
  describe('when giving an object which has "pluginTypes" property', () => {
    it('should return value which includes "plugin-types"', () => {
      expect(
        convertDocumentDirectiveToString({ pluginTypes: "text/javascript" })
      ).toBe("plugin-types text/javascript");
      expect(
        convertDocumentDirectiveToString({
      ...
      expect(
        convertDocumentDirectiveToString({ "plugin-types": "text/javascript" })
      ).toBe("plugin-types text/javascript");
      expect(
        convertDocumentDirectiveToString({
  ...
  describe('when giving an object which has "sandbox" property', () => {
    it('should return value which includes "sandbox"', () => {
      expect(convertDocumentDirectiveToString({ sandbox: true })).toBe(
        "sandbox"
      );
      expect(
        convertDocumentDirectiveToString({ sandbox: "allow-forms" })
      ).toBe("sandbox allow-forms");
    });
  });
  ...
  describe("when giving an object which has one or more properties", () => {
    it('should return value which includes their directive names joined "; "', () => {
      expect(
        ...
        "base-uri 'self'; plugin-types text/javascript image/png; sandbox"
      );
...
describe("convertReportingDirectiveToString", () => {
  ...
  describe('when giving an object which has "reportURI" property', () => {
    it('should return value which includes "report-uri"', () => {
      expect(
        convertReportingDirectiveToString({ reportURI: "https://example.com" })
  ...
  describe('when giving an object which has "reportTo" property', () => {
    it('should return value which includes "report-to"', () => {
      expect(
        convertReportingDirectiveToString({ reportTo: "endpoint-1" })
      ).toBe("report-to endpoint-1");

      expect(
        convertReportingDirectiveToString({ "report-to": "endpoint-1" })
      ).toBe("report-to endpoint-1");
    });
  });
...
describe("convertNavigationDirectiveToString", () => {
  ...
  describe('when giving an object which has "formAction" property', () => {
    it('should return value which includes "form-action"', () => {
      expect(convertNavigationDirectiveToString({ formAction: "'self'" })).toBe(
        "form-action 'self'"
      );
      expect(
        convertNavigationDirectiveToString({
  ...
  describe('when giving an object which has "frameAncestors" property', () => {
    it('should return value which includes "frame-ancestors"', () => {
      expect(
        convertNavigationDirectiveToString({ frameAncestors: "'self'" })
  ...
  describe('when giving an object which has "navigateTo" property', () => {
    it('should return value which includes "navigate-to"', () => {
      expect(convertNavigationDirectiveToString({ navigateTo: "'self'" })).toBe(
        "navigate-to 'self'"
      );
      expect(
        convertNavigationDirectiveToString({
  ...
  describe("when giving an object which has one or more properties", () => {
    it('should return value which includes their directive names joined "; "', () => {
      expect(
        ...
        "form-action 'self'; frame-ancestors 'self' https://example.com; navigate-to 'self'"
      );
