...
describe("createReferrerPolicyHeader", () => {
  ...
  describe("when giving an object", () => {
    const dummyOption: Parameters<typeof createReferrerPolicyHeader>[0] =
      "same-origin";

    let headerValueCreatorMock: ReturnType<
      typeof mock<typeof createReferrerPolicyHeaderValue>
    >;
    beforeEach(() => {
    ...
    it("should return Some with Referrer-Policy header when value is provided", async () => {
      ...
      const result = await runEffect(
        createReferrerPolicyHeader(dummyOption, headerValueCreatorMock)
      );
...
describe("createReferrerPolicyHeaderValue", () => {
  describe("when giving undefined", () => {
    it("should return undefined", async () => {
      ...
      expect(
        await runEffect(createReferrerPolicyHeaderValue(null as never))
      ).toBeUndefined();
    });
  });
  ...
  describe("when giving false", () => {
    it("should return undefined", async () => {
      expect(
        await runEffect(createReferrerPolicyHeaderValue(false))
      ).toBeUndefined();
    });
  });
  ...
  describe('when giving "no-referrer"', () => {
    it('should return "no-referrer"', async () => {
      expect(
        await runEffect(createReferrerPolicyHeaderValue("no-referrer"))
      ).toBe("no-referrer");
    });
  });
  ...
  describe('when giving "no-referrer-when-downgrade"', () => {
    it('should return "no-referrer-when-downgrade"', async () => {
      expect(
        await runEffect(
          createReferrerPolicyHeaderValue("no-referrer-when-downgrade")
        )
      ).toBe("no-referrer-when-downgrade");
    });
  });

  describe('when giving "origin"', () => {
    it('should return "origin"', async () => {
      expect(await runEffect(createReferrerPolicyHeaderValue("origin"))).toBe(
        "origin"
      );
    });
  });
  ...
  describe('when giving "origin-when-cross-origin"', () => {
    it('should return "origin-when-cross-origin"', async () => {
      expect(
        await runEffect(
          createReferrerPolicyHeaderValue("origin-when-cross-origin")
        )
      ).toBe("origin-when-cross-origin");
    });
  });
  ...
  describe('when giving "same-origin"', () => {
    it('should return "same-origin"', async () => {
      expect(
        await runEffect(createReferrerPolicyHeaderValue("same-origin"))
      ).toBe("same-origin");
    });
  });
  ...
  describe('when giving "strict-origin"', () => {
    it('should return "strict-origin"', async () => {
      expect(
        await runEffect(createReferrerPolicyHeaderValue("strict-origin"))
      ).toBe("strict-origin");
    });
  });
  ...
  describe('when giving "strict-origin-when-cross-origin"', () => {
    it('should return "strict-origin-when-cross-origin"', async () => {
      expect(
        await runEffect(
          createReferrerPolicyHeaderValue("strict-origin-when-cross-origin")
        )
  ...
  describe('when giving "unsafe-url"', () => {
    it("should raise error", () => {
      const result = runEffectExit(
        createReferrerPolicyHeaderValue("unsafe-url" as never)
      );
