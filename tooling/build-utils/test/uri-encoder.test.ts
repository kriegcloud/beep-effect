...
describe("encodeStrictURI", () => {
  ...
  describe("when giving URL object", () => {
    it("should convert to string", () => {
      ...
      expect(encodeStrictURI(new URL("https://日本語.com/ほげ/"))).toBe(
        "https://xn--wgv71a119e.com/%E3%81%BB%E3%81%92/"
      );
    });
  });

  describe("when giving invalid URI", () => {
