# @beep/_test-nodesc-1771558038551 Agent Guide
...
## Quick Recipes
```ts
import { VERSION } from "@beep/_test-nodesc-1771558038551"
```

## Verifications
- `bunx turbo run test --filter=@beep/_test-nodesc-1771558038551`
- `bunx turbo run lint --filter=@beep/_test-nodesc-1771558038551`
- `bunx turbo run check --filter=@beep/_test-nodesc-1771558038551`
