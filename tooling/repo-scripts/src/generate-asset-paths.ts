...
const program = Effect.gen(function* () {
  ...
  if (conversions.length > 0) {
    const conversionsJson = yield* S.encode(S.parseJson({ space: 2 }))(conversions);
    yield* Console.log("Converted assets:", conversionsJson);
  }
  ...
  const filesJson = yield* S.encode(S.parseJson({ space: 2 }))(files);
  const content = `// Auto-generated by tooling/repo-scripts/src/generate-asset-paths.ts
// Do not edit manually.

export const publicPaths = ${filesJson} as const;
`;
