 ...
 * Export: formatPropertyKey
 * Kind: function
 * Source: .repos/effect-smol/packages/effect/src/Formatter.ts
 * Generated: 2026-02-19T04:50:36.494Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "formatPropertyKey";
const exportKind = "function";
const moduleImportPath = "effect/Formatter";
const sourceSummary = "Fast path for formatting property keys.";
const sourceExample = "";
