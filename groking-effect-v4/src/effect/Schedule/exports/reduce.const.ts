...
const sourceSummary = "Returns a new `Schedule` that combines the outputs of the provided schedule using the specified effectful `combine` function and starting from the specified `initial` state.";
