...
const sourceSummary = "Creates a schedule that unfolds a state by repeatedly applying a function, outputting the current state and computing the next state.";
