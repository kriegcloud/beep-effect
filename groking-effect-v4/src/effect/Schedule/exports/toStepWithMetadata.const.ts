...
const sourceSummary = "Extracts a step function from a Schedule that provides metadata about each execution. It will also handle sleeping for the computed delay.";
const sourceExample = "";
