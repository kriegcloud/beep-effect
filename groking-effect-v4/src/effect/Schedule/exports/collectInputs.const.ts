 ...
 *
 * Overview:
 * Returns a new `Schedule` that always recurs, collecting all inputs of the schedule into an array.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "collectInputs";
const exportKind = "const";
const moduleImportPath = "effect/Schedule";
const sourceSummary = "Returns a new `Schedule` that always recurs, collecting all inputs of the schedule into an array.";
