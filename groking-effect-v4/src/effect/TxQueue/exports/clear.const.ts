...
const sourceSummary = "Clears all elements from the queue without affecting its state. Returns the cleared elements, or an empty array if the queue is done with Done or interrupt.";
