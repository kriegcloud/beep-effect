 ...
 * Export: CurrentConcurrency
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/References.ts
 * Generated: 2026-02-19T04:14:16.489Z
 *
 * Overview:
 * Reference for controlling the current concurrency limit. Can be set to "unbounded" for unlimited concurrency or a specific number to limit concurrent operations.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "CurrentConcurrency";
const exportKind = "const";
const moduleImportPath = "effect/References";
const sourceSummary = "Reference for controlling the current concurrency limit. Can be set to \"unbounded\" for unlimited concurrency or a specific number to limit concurrent operations.";
