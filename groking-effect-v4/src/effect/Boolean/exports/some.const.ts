...
const sourceSummary = "This utility function is used to check if at least one of the elements in a collection of boolean values is `true`.";
const sourceExample = "import { some } from \"effect/Boolean\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(some([true, false, true]), true)\nassert.deepStrictEqual(some([false, false, false]), false)";
