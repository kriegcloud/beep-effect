...
const sourceSummary = "This utility function is used to check if all the elements in a collection of boolean values are `true`.";
const sourceExample = "import { every } from \"effect/Boolean\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(every([true, true, true]), true)\nassert.deepStrictEqual(every([true, false, true]), false)";
