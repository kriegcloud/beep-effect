 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "truncate";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Truncate a `BigDecimal` at the given scale. This is the same operation as rounding away from zero.";
const sourceExample = "import { fromStringUnsafe, truncate } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(\n  truncate(fromStringUnsafe(\"145\"), -1),\n  fromStringUnsafe(\"140\")\n)\nassert.deepStrictEqual(\n  truncate(fromStringUnsafe(\"-14.5\")),\n  fromStringUnsafe(\"-14\")\n)";
