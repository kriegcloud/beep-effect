 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "fromNumberUnsafe";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Creates a `BigDecimal` from a `number` value.";
const sourceExample = "import { fromNumberUnsafe, make } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(fromNumberUnsafe(123), make(123n, 0))\nassert.deepStrictEqual(fromNumberUnsafe(123.456), make(123456n, 3))";
