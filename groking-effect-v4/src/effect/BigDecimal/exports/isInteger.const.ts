 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isInteger";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Checks if a given `BigDecimal` is an integer.";
const sourceExample = "import { fromStringUnsafe, isInteger } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(isInteger(fromStringUnsafe(\"0\")), true)\nassert.deepStrictEqual(isInteger(fromStringUnsafe(\"1\")), true)\nassert.deepStrictEqual(isInteger(fromStringUnsafe(\"1.1\")), false)";
