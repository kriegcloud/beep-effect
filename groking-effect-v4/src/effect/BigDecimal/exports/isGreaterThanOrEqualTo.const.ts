...
const sourceSummary = "Checks if a given `BigDecimal` is greater than or equal to the provided one.";
const sourceExample = "import { fromStringUnsafe, isGreaterThanOrEqualTo } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(\n  isGreaterThanOrEqualTo(fromStringUnsafe(\"2\"), fromStringUnsafe(\"3\")),\n  false\n)\nassert.deepStrictEqual(\n  isGreaterThanOrEqualTo(fromStringUnsafe(\"3\"), fromStringUnsafe(\"3\")),\n  true\n)\nassert.deepStrictEqual(\n  isGreaterThanOrEqualTo(fromStringUnsafe(\"4\"), fromStringUnsafe(\"3\")),\n  true\n)";
