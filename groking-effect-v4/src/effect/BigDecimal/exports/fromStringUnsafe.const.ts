 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "fromStringUnsafe";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Parses a numerical `string` into a `BigDecimal`.";
const sourceExample = "import { fromStringUnsafe, make } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(fromStringUnsafe(\"123\"), make(123n, 0))\nassert.deepStrictEqual(fromStringUnsafe(\"123.456\"), make(123456n, 3))\nassert.throws(() => fromStringUnsafe(\"123.abc\"))";
