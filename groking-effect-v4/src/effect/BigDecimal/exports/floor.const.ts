 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "floor";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Calculate the floor of a `BigDecimal` at the given scale.";
const sourceExample = "import { floor, fromStringUnsafe } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(\n  floor(fromStringUnsafe(\"145\"), -1),\n  fromStringUnsafe(\"140\")\n)\nassert.deepStrictEqual(\n  floor(fromStringUnsafe(\"-14.5\")),\n  fromStringUnsafe(\"-15\")\n)";
