 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toNumberUnsafe";
const exportKind = "const";
const moduleImportPath = "effect/BigDecimal";
const sourceSummary = "Converts a `BigDecimal` to a `number`.";
const sourceExample = "import { fromStringUnsafe, toNumberUnsafe } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(toNumberUnsafe(fromStringUnsafe(\"123.456\")), 123.456)";
