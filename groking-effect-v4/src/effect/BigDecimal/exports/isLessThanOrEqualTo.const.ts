...
const sourceSummary = "Checks if a given `BigDecimal` is less than or equal to the provided one.";
const sourceExample = "import { fromStringUnsafe, isLessThanOrEqualTo } from \"effect/BigDecimal\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(\n  isLessThanOrEqualTo(fromStringUnsafe(\"2\"), fromStringUnsafe(\"3\")),\n  true\n)\nassert.deepStrictEqual(\n  isLessThanOrEqualTo(fromStringUnsafe(\"3\"), fromStringUnsafe(\"3\")),\n  true\n)\nassert.deepStrictEqual(\n  isLessThanOrEqualTo(fromStringUnsafe(\"4\"), fromStringUnsafe(\"3\")),\n  false\n)";
