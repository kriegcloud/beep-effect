 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isObjectKeyword";
const exportKind = "function";
const moduleImportPath = "effect/Predicate";
const sourceSummary = "Checks whether a value is an `object` in the JavaScript sense (objects, arrays, functions).";
const sourceExample =
  'import { Predicate } from "effect"\n\nconsole.log(Predicate.isObjectKeyword(() => 1))\nconsole.log(Predicate.isObjectKeyword(null))';
