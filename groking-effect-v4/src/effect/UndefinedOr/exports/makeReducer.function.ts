...
const sourceSummary = "Creates a `Reducer` for `UndefinedOr<A>` that prioritizes the first non-`undefined` value and combines values when both operands are present.";
const sourceExample = "";
