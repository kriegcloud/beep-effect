 ...
 * Generated: 2026-02-19T04:50:48.428Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Provided";
const exportKind = "type";
const moduleImportPath = "effect/unstable/http/HttpRouter";
const sourceSummary = "Services provided by the HTTP router, which are available in the request context.";
const sourceExample = "";
