 ...
 * Export: QuerySchemaConstraint
 * Kind: type
 * Source: .repos/effect-smol/packages/effect/src/unstable/httpapi/HttpApiEndpoint.ts
 * Generated: 2026-02-19T04:14:27.630Z
 *
 * Overview:
 * URL search params can be repeated, so fields may encode to `string` or `ReadonlyArray<string>` (or be missing).
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "QuerySchemaConstraint";
const exportKind = "type";
const moduleImportPath = "effect/unstable/httpapi/HttpApiEndpoint";
const sourceSummary = "URL search params can be repeated, so fields may encode to `string` or `ReadonlyArray<string>` (or be missing).";
const sourceExample = "";
