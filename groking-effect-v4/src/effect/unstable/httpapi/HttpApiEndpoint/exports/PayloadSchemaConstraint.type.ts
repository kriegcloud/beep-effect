 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "PayloadSchemaConstraint";
const exportKind = "type";
const moduleImportPath = "effect/unstable/httpapi/HttpApiEndpoint";
const sourceSummary = "Payload schema depends on the HTTP method: - for no-body methods, payload is modeled as query params, so each field must encode to `string | ReadonlyArray<string> | undefined` a...";
const sourceExample = "";
