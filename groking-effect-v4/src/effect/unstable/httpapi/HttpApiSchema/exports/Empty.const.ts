 ...
 * Generated: 2026-02-19T04:14:27.680Z
 *
 * Overview:
...
const sourceSummary = "Creates a void schema with the given HTTP status code. This is used to represent empty responses with a specific status code.";
const sourceExample = "";
