 ...
 * Generated: 2026-02-19T04:14:27.723Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "OpenAPISpec";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/httpapi/OpenApi";
const sourceSummary = "This model describes the OpenAPI specification (version 3.1.0) returned by {@link fromApi}. It is not intended to describe the entire OpenAPI specification, only the output of `...";
const sourceExample = "";
