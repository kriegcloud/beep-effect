 ...
 * Generated: 2026-02-19T04:14:27.558Z
 *
 * Overview:
...
const sourceSummary = "An `HttpApi` is a collection of `HttpApiEndpoint`s. You can use an `HttpApi` to represent a portion of your domain.";
const sourceExample = "";
