 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "SingletonRegistered";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/cluster/ShardingRegistrationEvent";
const sourceSummary = "Represents an event that occurs when a new singleton is registered with a runner.";
const sourceExample = "";
