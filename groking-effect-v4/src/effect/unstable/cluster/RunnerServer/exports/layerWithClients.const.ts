 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "layerWithClients";
const exportKind = "const";
const moduleImportPath = "effect/unstable/cluster/RunnerServer";
const sourceSummary = "A `RunnerServer` layer that includes the `Runners` & `Sharding` clients.";
const sourceExample = "";
