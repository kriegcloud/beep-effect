 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "fromRpcGroup";
const exportKind = "const";
const moduleImportPath = "effect/unstable/cluster/Entity";
const sourceSummary = "Creates a new `Entity` of the specified `type` which will accept messages that adhere to the provided `RpcGroup`.";
const sourceExample = "";
