 ...
 * Generated: 2026-02-19T04:14:25.201Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "layerK8s";
const exportKind = "const";
const moduleImportPath = "effect/unstable/cluster/RunnerHealth";
const sourceSummary = "A layer which will check the Kubernetes API to see if a Runner is healthy.";
const sourceExample = "";
