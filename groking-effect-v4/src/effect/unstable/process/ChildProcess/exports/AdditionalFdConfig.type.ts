 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "AdditionalFdConfig";
const exportKind = "type";
const moduleImportPath = "effect/unstable/process/ChildProcess";
const sourceSummary = "Configuration for additional file descriptors to expose to the child process.";
const sourceExample = "";
