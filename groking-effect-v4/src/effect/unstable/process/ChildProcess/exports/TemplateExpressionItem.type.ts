 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "TemplateExpressionItem";
const exportKind = "type";
const moduleImportPath = "effect/unstable/process/ChildProcess";
const sourceSummary = "Valid template expression item types.";
const sourceExample = "";
