 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FileSchemaOptions";
const exportKind = "type";
const moduleImportPath = "effect/unstable/cli/Primitive";
const sourceSummary = "Represents options which can be provided to methods that deal with parsing file content and decoding the file content with a `Schema`.";
const sourceExample = "";
