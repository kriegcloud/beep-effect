 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "VariadicParamOptions";
const exportKind = "type";
const moduleImportPath = "effect/unstable/cli/Param";
const sourceSummary = "Represent options which can be used to configure variadic parameters.";
const sourceExample = "";
