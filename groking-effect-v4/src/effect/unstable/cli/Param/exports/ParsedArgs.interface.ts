 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ParsedArgs";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/cli/Param";
const sourceSummary = "Input context passed to `Param.parse` implementations. - `flags`: already-collected flag values by canonical flag name - `arguments`: remaining positional arguments to be consumed";
const sourceExample = "";
