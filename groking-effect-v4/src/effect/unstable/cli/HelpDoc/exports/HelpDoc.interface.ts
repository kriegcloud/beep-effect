...
const sourceSummary = "Structured representation of help documentation for a command. This data structure is independent of formatting, allowing for different output formats (text, markdown, JSON, etc.).";
const sourceExample = "import type * as HelpDoc from \"effect/unstable/cli/HelpDoc\"\n\nconst deployCommandHelp: HelpDoc.HelpDoc = {\n  description: \"Deploy your application to the cloud\",\n  usage: \"myapp deploy [options] <target>\",\n  flags: [\n    {\n      name: \"verbose\",\n      aliases: [\"-v\"],\n      type: \"boolean\",\n      description: \"Enable verbose logging\",\n      required: false\n    },\n    {\n      name: \"env\",\n      aliases: [\"-e\"],\n      type: \"string\",\n      description: \"Target environment\",\n      required: true\n    }\n  ],\n  args: [\n    {\n      name: \"target\",\n      type: \"string\",\n      description: \"Deployment target (e.g., 'production', 'staging')\",\n      required: true,\n      variadic: false\n    }\n  ]\n}";
