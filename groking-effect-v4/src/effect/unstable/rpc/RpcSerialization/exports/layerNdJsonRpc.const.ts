 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "layerNdJsonRpc";
const exportKind = "const";
const moduleImportPath = "effect/unstable/rpc/RpcSerialization";
const sourceSummary = "A rpc serialization layer that uses JSON-RPC for serialization seperated by new lines.";
const sourceExample = "";
