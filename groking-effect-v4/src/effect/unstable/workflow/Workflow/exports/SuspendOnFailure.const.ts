 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "SuspendOnFailure";
const exportKind = "const";
const moduleImportPath = "effect/unstable/workflow/Workflow";
const sourceSummary = "If you set this annotation to `true` for a workflow, it will suspend if it encounters any kind of error.";
const sourceExample = "";
