 ...
 * Generated: 2026-02-19T04:14:30.472Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "findOne";
const exportKind = "const";
const moduleImportPath = "effect/unstable/sql/SqlSchema";
const sourceSummary = "Run a sql query with a request schema and a result schema and return the first result, if any.";
const sourceExample = "";
