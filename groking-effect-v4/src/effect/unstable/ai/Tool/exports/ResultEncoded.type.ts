 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ResultEncoded";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "A utility type to extract the encoded type of the tool call result whether it succeeds or fails.";
const sourceExample = "";
