...
const sourceSummary = "**Unsafe**: This function will throw an error if an insecure property is found in the parsed JSON or if the provided JSON text is not parseable.";
const sourceExample = "";
