 ...
 *
 * Overview:
 * A utility type to extract the type of the tool call result whether it succeeds or fails.
 *
...
const sourceSummary = "A utility type to extract the type of the tool call result whether it succeeds or fails.";
const sourceExample = "";
