 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FailureEncoded";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "A utility type to extract the encoded type of the tool call result when it fails.";
const sourceExample = "";
