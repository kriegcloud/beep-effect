 ...
 * Export: ResultDecodingServices
 * Kind: type
 * Source: .repos/effect-smol/packages/effect/src/unstable/ai/Tool.ts
 * Generated: 2026-02-19T04:50:45.971Z
 *
 * Overview:
 * A utility type to extract the requirements needed to decode the result of a `Tool` call.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ResultDecodingServices";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "A utility type to extract the requirements needed to decode the result of a `Tool` call.";
const sourceExample = "";
