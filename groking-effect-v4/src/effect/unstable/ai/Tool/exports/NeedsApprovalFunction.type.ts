 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "NeedsApprovalFunction";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "Function type for dynamically determining if a tool requires approval.";
const sourceExample = "";
