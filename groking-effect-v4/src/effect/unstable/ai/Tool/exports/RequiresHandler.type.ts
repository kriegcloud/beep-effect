 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "RequiresHandler";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "A utility type to determine if the specified tool requires a user-defined handler to be implemented.";
const sourceExample = "";
