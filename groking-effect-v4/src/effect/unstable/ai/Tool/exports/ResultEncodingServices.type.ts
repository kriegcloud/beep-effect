 ...
 * Export: ResultEncodingServices
 * Kind: type
 * Source: .repos/effect-smol/packages/effect/src/unstable/ai/Tool.ts
 * Generated: 2026-02-19T04:14:24.148Z
 *
 * Overview:
 * A utility type to extract the requirements needed to encode the result of a `Tool` call.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ResultEncodingServices";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Tool";
const sourceSummary = "A utility type to extract the requirements needed to encode the result of a `Tool` call.";
const sourceExample = "";
