 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "UsageAttributes";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Telemetry";
const sourceSummary = "Telemetry attributes which are part of the GenAI specification and are namespaced by `gen_ai.usage`.";
const sourceExample = "";
