 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WellKnownOperationName";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Telemetry";
const sourceSummary = "The `gen_ai.operation.name` attribute has the following list of well-known values.";
const sourceExample = "";
