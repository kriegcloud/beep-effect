 ...
 * Export: ToolParamsDeltaPartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ToolParamsDeltaPartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Encoded representation of tool params delta parts for serialization.";
const sourceExample = "";
