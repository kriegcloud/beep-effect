 ...
 * Export: ToolParamsStartPartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ToolParamsStartPartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Encoded representation of tool params start parts for serialization.";
const sourceExample = "";
