 ...
 * Export: ReasoningStartPartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ReasoningStartPartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Encoded representation of reasoning start parts for serialization.";
const sourceExample = "";
