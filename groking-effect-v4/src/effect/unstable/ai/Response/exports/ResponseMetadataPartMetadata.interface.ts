 ...
 * Export: ResponseMetadataPartMetadata
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ResponseMetadataPartMetadata";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Represents provider-specific metadata that can be associated with a `ResponseMetadataPart` through module augmentation.";
const sourceExample = "";
