 ...
 * Export: DocumentSourcePartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DocumentSourcePartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Encoded representation of document source parts for serialization.";
const sourceExample = "";
