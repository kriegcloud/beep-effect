 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ConstructorParams";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "A utility type for specifying the parameters required to construct a specific response part.";
const sourceExample = "";
