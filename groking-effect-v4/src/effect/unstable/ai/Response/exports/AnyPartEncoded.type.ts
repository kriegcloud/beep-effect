 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "AnyPartEncoded";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Response";
const sourceSummary = "Encoded representation of all possible response content parts for serialization.";
const sourceExample = "";
