 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ListResourceTemplates";
const exportKind = "class";
const moduleImportPath = "effect/unstable/ai/McpSchema";
const sourceSummary = "Sent from the client to request a list of resource templates the server has.";
const sourceExample = "";
