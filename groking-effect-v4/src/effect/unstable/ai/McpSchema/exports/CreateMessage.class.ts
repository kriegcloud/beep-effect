 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "CreateMessage";
const exportKind = "class";
const moduleImportPath = "effect/unstable/ai/McpSchema";
const sourceSummary =
  "A request from the server to sample an LLM via the client. The client has full discretion over which model to select. The client should also inform the user before beginning sam...";
const sourceExample = "";
