 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ProgressNotification";
const exportKind = "class";
const moduleImportPath = "effect/unstable/ai/McpSchema";
const sourceSummary = "An out-of-band notification used to inform the receiver of a progress update for a long-running request.";
const sourceExample = "";
