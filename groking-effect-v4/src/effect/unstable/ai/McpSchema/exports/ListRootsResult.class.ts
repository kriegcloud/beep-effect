 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ListRootsResult";
const exportKind = "class";
const moduleImportPath = "effect/unstable/ai/McpSchema";
const sourceSummary = "The client's response to a roots/list request from the server. This result contains an array of Root objects, each representing a root directory or file that the server can oper...";
const sourceExample = "";
