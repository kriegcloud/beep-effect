 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ServerCapabilities";
const exportKind = "class";
const moduleImportPath = "effect/unstable/ai/McpSchema";
const sourceSummary = "Capabilities that a server may support. Known capabilities are defined here, in this schema, but this is not a closed set: any server can define its own, additional capabilities.";
const sourceExample = "";
