 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WithHandlerTools";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Toolkit";
const sourceSummary = "A utility type which can be used to extract the tools from a toolkit with handlers.";
const sourceExample = "";
