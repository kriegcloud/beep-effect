 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ToolsByName";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Toolkit";
const sourceSummary = "A utility type which transforms either a record or an array of tools into a record where keys are tool names and values are the tool instances.";
const sourceExample = "";
