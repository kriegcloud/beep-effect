 ...
 * Export: AssistantMessagePartEncoded
 * Kind: type
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "AssistantMessagePartEncoded";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Union type of encoded content parts for assistant messages.";
const sourceExample = "";
