 ...
 * Export: MessageConstructorParams
 * Kind: type
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MessageConstructorParams";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "A utility type for specifying the parameters required to construct a specific message for a prompt.";
const sourceExample = "";
