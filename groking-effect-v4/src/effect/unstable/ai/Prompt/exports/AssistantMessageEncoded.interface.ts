 ...
 * Export: AssistantMessageEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "AssistantMessageEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Encoded representation of assistant messages for serialization.";
const sourceExample = "";
