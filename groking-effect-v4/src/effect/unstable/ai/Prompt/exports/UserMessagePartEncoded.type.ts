 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "UserMessagePartEncoded";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Union type of encoded content parts for user messages.";
const sourceExample = "";
