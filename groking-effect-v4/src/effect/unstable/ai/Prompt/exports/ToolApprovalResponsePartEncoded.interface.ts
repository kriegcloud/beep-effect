 ...
 * Export: ToolApprovalResponsePartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ToolApprovalResponsePartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Encoded representation of tool approval response parts for serialization.";
const sourceExample = "";
