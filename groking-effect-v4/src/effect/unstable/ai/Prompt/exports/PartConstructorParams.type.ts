 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "PartConstructorParams";
const exportKind = "type";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "A utility type for specifying the parameters required to construct a specific part of a prompt.";
const sourceExample = "";
