 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ContentFromString";
const exportKind = "const";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Schema for decoding message content (i.e. an array containing a single `TextPart`) from a string.";
const sourceExample = "";
