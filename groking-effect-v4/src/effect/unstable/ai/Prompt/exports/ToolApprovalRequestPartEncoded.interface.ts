 ...
 * Export: ToolApprovalRequestPartEncoded
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ToolApprovalRequestPartEncoded";
const exportKind = "interface";
const moduleImportPath = "effect/unstable/ai/Prompt";
const sourceSummary = "Encoded representation of tool approval request parts for serialization.";
const sourceExample = "";
