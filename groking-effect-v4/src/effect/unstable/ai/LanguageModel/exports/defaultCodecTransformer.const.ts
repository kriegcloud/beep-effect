 ...
 * Export: defaultCodecTransformer
 * Kind: const
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "defaultCodecTransformer";
const exportKind = "const";
const moduleImportPath = "effect/unstable/ai/LanguageModel";
const sourceSummary = "The default codec transformer that passes schemas through without provider-specific rewrites.";
const sourceExample = "";
