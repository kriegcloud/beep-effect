 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isManagedRuntime";
const exportKind = "const";
const moduleImportPath = "effect/ManagedRuntime";
const sourceSummary = "Checks if the provided argument is a `ManagedRuntime`.";
const sourceExample = "";
