...
const sourceSummary = "Combines the elements from this channel and the specified channel by repeatedly applying the function `f` to extract an element using both sides and conceptually \"offer\" it to t...";
const sourceExample = "";
