...
const sourceSummary = "Retrieves a value from the RcMap by key. If the resource doesn't exist, it will be acquired using the lookup function. The resource is reference counted and will be released whe...";
