 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "withCurrentZoneNamed";
const exportKind = "const";
const moduleImportPath = "effect/DateTime";
const sourceSummary = "Provide the `CurrentTimeZone` to an effect using an IANA time zone identifier.";
