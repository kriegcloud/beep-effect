...
const sourceSummary = "A `QuitError` represents an error that occurs when a user attempts to quit out of a `Terminal` prompt for input (usually by entering `ctrl`+`c`).";
const sourceExample = "";
