 ...
 * Generated: 2026-02-19T04:14:22.121Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Terminal";
const exportKind = "interface";
const moduleImportPath = "effect/Terminal";
const sourceSummary = "A `Terminal` represents a command-line interface which can read input from a user and display messages to a user.";
const sourceExample = "";
