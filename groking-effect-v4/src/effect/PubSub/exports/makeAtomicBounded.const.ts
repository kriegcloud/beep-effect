 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "makeAtomicBounded";
const exportKind = "const";
const moduleImportPath = "effect/PubSub";
const sourceSummary = "Creates a bounded atomic PubSub implementation with optional replay buffer.";
const sourceExample = "";
