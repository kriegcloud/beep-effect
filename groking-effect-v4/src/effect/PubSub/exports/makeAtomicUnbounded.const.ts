 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "makeAtomicUnbounded";
const exportKind = "const";
const moduleImportPath = "effect/PubSub";
const sourceSummary = "Creates an unbounded atomic PubSub implementation with optional replay buffer.";
const sourceExample = "";
