...
const sourceSummary = "A strategy that drops new messages when the `PubSub` is at capacity. This guarantees that a slow subscriber will not slow down the rate at which messages are published. However,...";
