...
const sourceSummary = "Acquires the specified number of permits from the semaphore. If not enough permits are available, the effect will block until they become available.";
