...
const sourceSummary = "Tries to acquire the specified number of permits from the semaphore without blocking. Returns true if successful, false if not enough permits are available.";
