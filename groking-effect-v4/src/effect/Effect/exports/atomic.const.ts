...
const sourceSummary = "Defines a transaction. Transactions are \"all or nothing\" with respect to changes made to transactional values (i.e. TxRef) that occur within the transaction body.";
