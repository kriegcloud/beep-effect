...
const sourceSummary = "An optimized version of `flatMap` that checks if an effect is already resolved and applies the flatMap function eagerly when possible.";
