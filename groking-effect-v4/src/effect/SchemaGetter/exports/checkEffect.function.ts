 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "checkEffect";
const exportKind = "function";
const moduleImportPath = "effect/SchemaGetter";
const sourceSummary = "Creates a getter that validates a value using an effectful check function.";
const sourceExample = "import { SchemaGetter, Effect } from \"effect\"\n\nconst nonNegative = SchemaGetter.checkEffect<number>((n) =>\n  Effect.succeed(n >= 0 ? undefined : \"must be non-negative\")\n)";
