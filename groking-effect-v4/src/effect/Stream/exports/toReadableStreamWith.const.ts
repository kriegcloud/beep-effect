 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toReadableStreamWith";
const exportKind = "const";
const moduleImportPath = "effect/Stream";
const sourceSummary = "Converts the stream to a `ReadableStream` using the provided services.";
const sourceExample =
  'import { ServiceMap, Stream } from "effect"\n\nconst stream = Stream.make(1, 2, 3, 4, 5)\nconst readableStream = Stream.toReadableStreamWith(stream, ServiceMap.empty())';
