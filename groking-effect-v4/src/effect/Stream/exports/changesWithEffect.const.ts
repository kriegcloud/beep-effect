 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "changesWithEffect";
const exportKind = "const";
const moduleImportPath = "effect/Stream";
const sourceSummary = "Emits only elements that differ from the previous element, using an effectful equality check.";
