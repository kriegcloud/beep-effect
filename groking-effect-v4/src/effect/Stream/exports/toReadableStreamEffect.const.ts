 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toReadableStreamEffect";
const exportKind = "const";
const moduleImportPath = "effect/Stream";
const sourceSummary = "Creates an Effect that builds a ReadableStream from the stream.";
const sourceExample =
  'import { Console, Effect, Stream } from "effect"\n\nconst stream = Stream.make(1, 2, 3, 4, 5)\n\nconst effect = Effect.gen(function*() {\n  const readableStream = yield* Stream.toReadableStreamEffect(stream)\n  yield* Console.log(readableStream instanceof ReadableStream) // true\n})\n\nEffect.runPromise(effect)';
