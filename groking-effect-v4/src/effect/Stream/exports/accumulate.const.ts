 ...
 * Generated: 2026-02-19T04:50:42.440Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "accumulate";
const exportKind = "const";
const moduleImportPath = "effect/Stream";
const sourceSummary = "Accumulates elements into a growing array, emitting the cumulative array for each input chunk.";
const sourceExample =
  "import { Console, Effect, Stream } from \"effect\"\n\nconst program = Effect.gen(function*() {\n  const accumulated = yield* Stream.runCollect(\n    Stream.fromArray([1, 2, 3]).pipe(\n      Stream.rechunk(1),\n      Stream.accumulate\n    )\n  )\n  yield* Console.log(accumulated)\n})\n\nEffect.runPromise(program)\n//=> { _id: 'Chunk', values: [ [ 1 ], [ 1, 2 ], [ 1, 2, 3 ] ] }";
