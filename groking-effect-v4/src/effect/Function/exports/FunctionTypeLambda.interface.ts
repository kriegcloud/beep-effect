 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FunctionTypeLambda";
const exportKind = "interface";
const moduleImportPath = "effect/Function";
const sourceSummary = "Type lambda for function types, used for higher-kinded type operations.";
const sourceExample = "import type { FunctionTypeLambda } from \"effect/Function\"\nimport type { Kind } from \"effect/HKT\"\n\n// Create a function type using the type lambda\ntype StringToNumber = Kind<FunctionTypeLambda, string, never, never, number>\n// Equivalent to: (a: string) => number";
