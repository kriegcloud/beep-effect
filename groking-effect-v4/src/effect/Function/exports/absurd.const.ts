 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "absurd";
const exportKind = "const";
const moduleImportPath = "effect/Function";
const sourceSummary = "The `absurd` function is a stub for cases where a value of type `never` is encountered in your code, meaning that it should be impossible for this code to be executed.";
const sourceExample = "import { absurd } from \"effect/Function\"\n\nconst handleNever = (value: never) => {\n  return absurd(value) // This will throw an error if called\n}";
