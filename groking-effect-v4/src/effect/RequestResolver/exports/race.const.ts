...
const sourceSummary = "Returns a new request resolver that executes requests by sending them to this request resolver and that request resolver, returning the results from the first data source to com...";
