 ...
 *
 * Overview:
 * Adds caching capabilities to a request resolver, allowing it to cache results up to a specified capacity.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "withCache";
const exportKind = "const";
const moduleImportPath = "effect/RequestResolver";
const sourceSummary = "Adds caching capabilities to a request resolver, allowing it to cache results up to a specified capacity.";
const sourceExample = "";
