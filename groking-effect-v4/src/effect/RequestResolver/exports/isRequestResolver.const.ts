 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isRequestResolver";
const exportKind = "const";
const moduleImportPath = "effect/RequestResolver";
const sourceSummary = "Returns `true` if the specified value is a `RequestResolver`, `false` otherwise.";
const sourceExample = "";
