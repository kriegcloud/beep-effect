 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "makeWithTTL";
const exportKind = "const";
const moduleImportPath = "effect/Pool";
const sourceSummary = "Makes a new pool with the specified minimum and maximum sizes and time to live before a pool whose excess items are not being used will be shrunk down to the minimum size. The p...";
const sourceExample = "";
