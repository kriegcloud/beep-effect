 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Pool";
const exportKind = "interface";
const moduleImportPath = "effect/Pool";
const sourceSummary = "A `Pool<A, E>` is a pool of items of type `A`, each of which may be associated with the acquisition and release of resources. An attempt to get an item `A` from a pool may fail ...";
const sourceExample = "";
