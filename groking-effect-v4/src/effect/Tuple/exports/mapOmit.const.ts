...
const sourceSummary = "Applies a `Struct.Lambda` transformation to all elements except those at the specified indices; the excluded elements are copied unchanged.";
