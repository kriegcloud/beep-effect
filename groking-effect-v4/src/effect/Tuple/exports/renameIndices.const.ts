...
const sourceSummary =
  'Rearranges elements of a tuple by providing an array of stringified source indices. Each position in the array specifies which index to read from (e.g., `["2", "1", "0"]` revers...';
const sourceExample =
  'import { pipe, Tuple } from "effect"\n\nconst result = pipe(\n  Tuple.make("a", "b", "c"),\n  Tuple.renameIndices(["2", "1", "0"])\n)\nconsole.log(result) // ["c", "b", "a"]';
