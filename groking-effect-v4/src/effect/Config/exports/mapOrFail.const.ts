 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "mapOrFail";
const exportKind = "const";
const moduleImportPath = "effect/Config";
const sourceSummary = "Transforms the parsed value with a function that may fail.";
const sourceExample = "import { Config, Effect } from \"effect\"\n\nconst trimmed = Config.string(\"name\").pipe(\n  Config.mapOrFail((s) => Effect.succeed(s.trim()))\n)";
