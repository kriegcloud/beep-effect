 ...
 * Generated: 2026-02-19T04:02:04.686Z
 *
 * Overview:
...
const sourceSummary = "Returns the first {@link Interrupt} reason from a cause, including its annotations. Returns `Filter.fail` with the original cause when no `Interrupt` is found.";
