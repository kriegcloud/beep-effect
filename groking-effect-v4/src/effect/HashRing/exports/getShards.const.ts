 ...
 * Generated: 2026-02-19T04:50:37.004Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "getShards";
const exportKind = "const";
const moduleImportPath = "effect/HashRing";
const sourceSummary =
  "Distributes `count` shards across the nodes in the ring, attempting to balance the number of shards allocated to each node. Returns undefined if the hashring has no elements wit...";
const sourceExample = "";
