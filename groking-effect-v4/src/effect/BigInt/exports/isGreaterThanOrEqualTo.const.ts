...
const sourceSummary = "Returns a function that checks if a given `bigint` is greater than or equal to the provided one.";
const sourceExample = "import { isGreaterThanOrEqualTo } from \"effect/BigInt\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(isGreaterThanOrEqualTo(2n, 3n), false)\nassert.deepStrictEqual(isGreaterThanOrEqualTo(3n, 3n), true)\nassert.deepStrictEqual(isGreaterThanOrEqualTo(4n, 3n), true)";
