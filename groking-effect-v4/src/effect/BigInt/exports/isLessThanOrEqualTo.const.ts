...
const sourceSummary = "Returns a function that checks if a given `bigint` is less than or equal to the provided one.";
const sourceExample = "import { isLessThanOrEqualTo } from \"effect/BigInt\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(isLessThanOrEqualTo(2n, 3n), true)\nassert.deepStrictEqual(isLessThanOrEqualTo(3n, 3n), true)\nassert.deepStrictEqual(isLessThanOrEqualTo(4n, 3n), false)";
