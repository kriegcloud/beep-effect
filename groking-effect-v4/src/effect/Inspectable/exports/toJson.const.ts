 ...
 * Generated: 2026-02-19T04:14:14.189Z
 *
 * Overview:
...
const sourceSummary = "Safely converts a value to a JSON-serializable representation, useful for implementing the `toJSON` method of the {@link Inspectable} interface.";
const sourceExample = "";
