...
const sourceSummary = "Tries to parse a `number` from a `string` using the `Number()` function. The following special string values are supported: \"NaN\", \"Infinity\", \"-Infinity\".";
