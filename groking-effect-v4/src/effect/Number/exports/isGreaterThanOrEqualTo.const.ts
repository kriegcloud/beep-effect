...
const sourceSummary = "Returns a function that checks if a given `number` is greater than or equal to the provided one.";
const sourceExample = "import { isGreaterThanOrEqualTo } from \"effect/Number\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(isGreaterThanOrEqualTo(2, 3), false)\nassert.deepStrictEqual(isGreaterThanOrEqualTo(3, 3), true)\nassert.deepStrictEqual(isGreaterThanOrEqualTo(4, 3), true)";
