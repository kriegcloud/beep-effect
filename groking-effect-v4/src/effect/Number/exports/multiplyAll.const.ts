 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "multiplyAll";
const exportKind = "const";
const moduleImportPath = "effect/Number";
const sourceSummary = "Takes an `Iterable` of `number`s and returns their multiplication as a single `number`.";
const sourceExample = "import { multiplyAll } from \"effect/Number\"\nimport * as assert from \"node:assert\"\n\nassert.deepStrictEqual(multiplyAll([2, 3, 4]), 24)";
