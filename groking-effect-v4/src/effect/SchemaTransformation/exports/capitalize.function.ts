 ...
 *
 * Overview:
 * A string-to-string transformation that capitalizes the first character on decode. Encode is passthrough.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "capitalize";
const exportKind = "function";
const moduleImportPath = "effect/SchemaTransformation";
const sourceSummary = "A string-to-string transformation that capitalizes the first character on decode. Encode is passthrough.";
