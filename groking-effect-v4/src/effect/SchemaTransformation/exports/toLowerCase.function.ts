 ...
 *
 * Overview:
 * A string-to-string transformation that lowercases on decode. Encode is passthrough.
 *
...
const sourceSummary = "A string-to-string transformation that lowercases on decode. Encode is passthrough.";
