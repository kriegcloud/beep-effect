 ...
 *
 * Overview:
 * A string-to-string transformation that uppercases on decode. Encode is passthrough.
 *
...
const sourceSummary = "A string-to-string transformation that uppercases on decode. Encode is passthrough.";
