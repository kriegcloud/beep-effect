 ...
 *
 * Overview:
 * Decodes a `FormData` instance into an `unknown` record and encodes an `unknown` record back to `FormData`.
 *
...
const sourceSummary = "Decodes a `FormData` instance into an `unknown` record and encodes an `unknown` record back to `FormData`.";
