 ...
 *
 * Overview:
 * The output of {@link toCodeDocument}: generated TypeScript code for one or more schemas plus their shared references and auxiliary artifacts.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "CodeDocument";
const exportKind = "type";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "The output of {@link toCodeDocument}: generated TypeScript code for one or more schemas plus their shared references and auxiliary artifacts.";
const sourceExample = "";
