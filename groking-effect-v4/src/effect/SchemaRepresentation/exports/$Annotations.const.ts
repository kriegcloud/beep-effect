 ...
 *
 * Overview:
 * Schema codec for `Schema.Annotations.Annotations`. Filters out internal annotation keys and non-primitive values during encoding.
 *
...
const sourceSummary = "Schema codec for `Schema.Annotations.Annotations`. Filters out internal annotation keys and non-primitive values during encoding.";
const sourceExample = "";
