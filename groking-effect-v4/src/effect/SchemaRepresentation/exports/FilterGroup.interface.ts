 ...
 *
 * Overview:
 * A group of validation constraints that are logically combined. Contains at least one {@link Check}.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FilterGroup";
const exportKind = "interface";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "A group of validation constraints that are logically combined. Contains at least one {@link Check}.";
const sourceExample = "";
