 ...
 * Export: DeclarationMeta
 * Kind: type
 * Source: .repos/effect-smol/packages/effect/src/SchemaRepresentation.ts
 * Generated: 2026-02-19T04:50:40.595Z
 *
 * Overview:
 * Metadata union for {@link Declaration} checks — either {@link DateMeta} or {@link SizeMeta}.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DeclarationMeta";
const exportKind = "type";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Metadata union for {@link Declaration} checks — either {@link DateMeta} or {@link SizeMeta}.";
const sourceExample = "";
