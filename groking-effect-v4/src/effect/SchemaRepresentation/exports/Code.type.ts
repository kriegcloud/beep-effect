 ...
 *
 * Overview:
 * A pair of TypeScript source strings for a schema: `runtime` is the executable Schema expression, `Type` is the corresponding TypeScript type.
 *
...
const sourceSummary = "A pair of TypeScript source strings for a schema: `runtime` is the executable Schema expression, `Type` is the corresponding TypeScript type.";
const sourceExample = "";
