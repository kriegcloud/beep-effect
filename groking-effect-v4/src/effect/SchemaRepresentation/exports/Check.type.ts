 ...
 *
 * Overview:
 * A validation constraint attached to a type. Either a single {@link Filter} or a {@link FilterGroup} combining multiple checks.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Check";
const exportKind = "type";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "A validation constraint attached to a type. Either a single {@link Filter} or a {@link FilterGroup} combining multiple checks.";
const sourceExample = "";
