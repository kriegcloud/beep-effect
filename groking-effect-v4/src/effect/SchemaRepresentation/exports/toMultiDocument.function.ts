 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toMultiDocument";
const exportKind = "function";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Wraps a single {@link Document} as a {@link MultiDocument} with one representation.";
const sourceExample = "";
