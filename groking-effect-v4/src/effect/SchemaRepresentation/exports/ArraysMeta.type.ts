 ...
 *
 * Overview:
 * Metadata union for array-specific validation checks (minLength, maxLength, length, unique).
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ArraysMeta";
const exportKind = "type";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Metadata union for array-specific validation checks (minLength, maxLength, length, unique).";
const sourceExample = "";
