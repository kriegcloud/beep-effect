 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "fromJsonSchemaDocument";
const exportKind = "function";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Parses a Draft 2020-12 JSON Schema document into a {@link Document}.";
const sourceExample = "";
