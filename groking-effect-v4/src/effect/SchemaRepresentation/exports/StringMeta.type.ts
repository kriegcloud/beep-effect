 ...
 *
 * Overview:
 * Metadata union for string-specific validation checks (minLength, maxLength, pattern, UUID, trimmed, etc.).
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "StringMeta";
const exportKind = "type";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Metadata union for string-specific validation checks (minLength, maxLength, pattern, UUID, trimmed, etc.).";
const sourceExample = "";
