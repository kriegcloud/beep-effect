 ...
 *
 * Overview:
 * Constructs a {@link Code} value from a runtime expression string and a TypeScript type string.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "makeCode";
const exportKind = "function";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Constructs a {@link Code} value from a runtime expression string and a TypeScript type string.";
const sourceExample = "";
