 ...
 * Export: MultiDocumentFromJson
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/SchemaRepresentation.ts
 * Generated: 2026-02-19T04:14:19.663Z
 *
 * Overview:
 * Schema codec that decodes a {@link MultiDocument} from JSON and encodes it back.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MultiDocumentFromJson";
const exportKind = "const";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Schema codec that decodes a {@link MultiDocument} from JSON and encodes it back.";
const sourceExample = "";
