 ...
 * Export: toJsonSchemaMultiDocument
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/SchemaRepresentation.ts
 * Generated: 2026-02-19T04:50:40.597Z
 *
 * Overview:
 * Converts a {@link MultiDocument} to a Draft 2020-12 JSON Schema multi-document.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toJsonSchemaMultiDocument";
const exportKind = "const";
const moduleImportPath = "effect/SchemaRepresentation";
const sourceSummary = "Converts a {@link MultiDocument} to a Draft 2020-12 JSON Schema multi-document.";
const sourceExample = "";
