 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "OrderTypeLambda";
const exportKind = "interface";
const moduleImportPath = "effect/Order";
const sourceSummary = "Type lambda for the `Order` type class, used internally for higher-kinded type operations.";
const sourceExample = "";
