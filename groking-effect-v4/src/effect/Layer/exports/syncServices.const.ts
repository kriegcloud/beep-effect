 ...
 * Generated: 2026-02-19T04:50:37.316Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "syncServices";
const exportKind = "const";
const moduleImportPath = "effect/Layer";
const sourceSummary = "Lazily constructs a layer from the specified value, which must return one or more services.";
const sourceExample =
  'import { Effect, Layer, ServiceMap } from "effect"\n\nclass Database extends ServiceMap.Service<Database, {\n  readonly query: (sql: string) => Effect.Effect<string>\n}>()("Database") {}\n\nconst layer = Layer.syncServices(() =>\n  ServiceMap.make(Database, {\n    query: (sql: string) => Effect.succeed(`Query: ${sql}`)\n  })\n)';
