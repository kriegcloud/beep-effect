 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "getIndexSignatureKeys";
const exportKind = "function";
const moduleImportPath = "effect/SchemaAST";
const sourceSummary = "Returns the object keys that match the index signature parameter schema.";
const sourceExample = "";
