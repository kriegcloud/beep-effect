 ...
 *
 * Overview:
 * Non-empty array of validation {@link Check} values attached to an AST node via {@link Base.checks}.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Checks";
const exportKind = "type";
const moduleImportPath = "effect/SchemaAST";
const sourceSummary = "Non-empty array of validation {@link Check} values attached to an AST node via {@link Base.checks}.";
const sourceExample = "";
