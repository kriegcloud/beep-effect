 ...
 *
 * Overview:
 * Marks an AST node's property key as optional by setting {@link Context.isOptional} to `true`.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "optionalKey";
const exportKind = "function";
const moduleImportPath = "effect/SchemaAST";
const sourceSummary = "Marks an AST node's property key as optional by setting {@link Context.isOptional} to `true`.";
const sourceExample = "";
