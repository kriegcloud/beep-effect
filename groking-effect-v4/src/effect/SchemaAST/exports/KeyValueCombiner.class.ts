 ...
 * Export: KeyValueCombiner
 * Kind: class
 * Source: .repos/effect-smol/packages/effect/src/SchemaAST.ts
 * Generated: 2026-02-19T04:50:40.337Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "KeyValueCombiner";
const exportKind = "class";
const moduleImportPath = "effect/SchemaAST";
const sourceSummary = "Bidirectional merge strategy for index signature key-value pairs.";
const sourceExample = "";
