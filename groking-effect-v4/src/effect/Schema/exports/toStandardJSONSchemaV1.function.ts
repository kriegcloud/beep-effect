 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toStandardJSONSchemaV1";
const exportKind = "function";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Experimental support for converting a schema to a Standard JSON Schema V1.";
const sourceExample = "";
