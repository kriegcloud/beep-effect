 ...
 * Export: isLessThanOrEqualToBigInt
 * Kind: const
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isLessThanOrEqualToBigInt";
const exportKind = "const";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Validates that a BigInt is less than or equal to the specified value (inclusive).";
const sourceExample = "";
