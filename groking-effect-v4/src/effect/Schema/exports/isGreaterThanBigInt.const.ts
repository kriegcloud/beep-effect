 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isGreaterThanBigInt";
const exportKind = "const";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Validates that a BigInt is greater than the specified value (exclusive).";
const sourceExample = "";
