 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "toCodecStringTree";
const exportKind = "function";
const moduleImportPath = "effect/Schema";
const sourceSummary = "The StringTree serializer converts **every leaf value to a string**, while preserving the original structure.";
const sourceExample = "";
