 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isLengthBetween";
const exportKind = "function";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Validates that a value's length is within the specified range. Works with strings and arrays.";
const sourceExample = "";
