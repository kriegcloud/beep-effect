 ...
 * Export: isLessThanOrEqualToDate
 * Kind: const
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isLessThanOrEqualToDate";
const exportKind = "const";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Validates that a Date is less than or equal to the specified date (inclusive).";
const sourceExample = "";
