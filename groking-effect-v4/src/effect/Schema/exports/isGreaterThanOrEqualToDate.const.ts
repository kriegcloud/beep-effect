 ...
 * Export: isGreaterThanOrEqualToDate
 * Kind: const
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "isGreaterThanOrEqualToDate";
const exportKind = "const";
const moduleImportPath = "effect/Schema";
const sourceSummary = "Validates that a Date is greater than or equal to the specified date (inclusive).";
const sourceExample = "";
