 ...
 * Package: effect
 * Module: effect/Pull
 * Export: doneExitFromCause
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/Pull.ts
 * Generated: 2026-02-19T04:50:38.446Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "doneExitFromCause";
const exportKind = "const";
const moduleImportPath = "effect/Pull";
const sourceSummary = "Converts a Cause into an Exit, extracting halt leftovers as success values.";
const sourceExample = "";
