 ...
 * Package: effect
 * Module: effect/Pull
 * Export: filterDoneLeftover
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/Pull.ts
 * Generated: 2026-02-19T04:50:38.453Z
 *
 * Overview:
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "filterDoneLeftover";
const exportKind = "const";
const moduleImportPath = "effect/Pull";
const sourceSummary = "Filters a Cause to extract the leftover value from done errors.";
const sourceExample = "";
