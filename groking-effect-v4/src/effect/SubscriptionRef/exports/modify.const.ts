 ...
 *
 * Overview:
 * Atomically modifies the `SubscriptionRef` with a function that computes a return value and a new value, notifying subscribers of the change.
 *
...
const sourceSummary = "Atomically modifies the `SubscriptionRef` with a function that computes a return value and a new value, notifying subscribers of the change.";
