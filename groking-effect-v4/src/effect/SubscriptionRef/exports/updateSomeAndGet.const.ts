 ...
 *
 * Overview:
 * Optionally updates the value of the `SubscriptionRef` with the result of applying a function that returns an `Option` and returns the new value, notifying subscribers only if the value changes.
 *
...
const sourceSummary = "Optionally updates the value of the `SubscriptionRef` with the result of applying a function that returns an `Option` and returns the new value, notifying subscribers only if th...";
