 ...
 *
 * Overview:
 * Optionally updates the value of the `SubscriptionRef` with the result of applying a function that returns an `Option`, notifying subscribers only if the value changes.
 *
...
const sourceSummary = "Optionally updates the value of the `SubscriptionRef` with the result of applying a function that returns an `Option`, notifying subscribers only if the value changes.";
