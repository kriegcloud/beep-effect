 ...
 *
 * Overview:
 * Atomically retrieves the current value and optionally updates it with the result of applying a function that returns an `Option`, notifying subscribers only if the value changes.
 *
...
const sourceSummary = "Atomically retrieves the current value and optionally updates it with the result of applying a function that returns an `Option`, notifying subscribers only if the value changes.";
