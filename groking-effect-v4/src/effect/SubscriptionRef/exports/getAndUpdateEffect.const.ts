 ...
 * Export: getAndUpdateEffect
 * Kind: const
 * Source: .repos/effect-smol/packages/effect/src/SubscriptionRef.ts
 * Generated: 2026-02-19T04:14:21.694Z
 *
 * Overview:
 * Atomically retrieves the current value and updates it with the result of applying an effectful function, notifying subscribers of the change.
 *
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "getAndUpdateEffect";
const exportKind = "const";
const moduleImportPath = "effect/SubscriptionRef";
const sourceSummary = "Atomically retrieves the current value and updates it with the result of applying an effectful function, notifying subscribers of the change.";
