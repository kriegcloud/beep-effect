 ...
 *
 * Overview:
 * Atomically retrieves the current value and sets a new value, notifying subscribers of the change.
 *
...
const sourceSummary = "Atomically retrieves the current value and sets a new value, notifying subscribers of the change.";
