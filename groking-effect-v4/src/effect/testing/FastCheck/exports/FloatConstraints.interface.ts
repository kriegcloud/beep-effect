 ...
 * Export: FloatConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/float.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FloatConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link float}";
const sourceExample = "";
