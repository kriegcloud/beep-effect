 ...
 * Kind: type
 * Source: node_modules/fast-check/lib/types/arbitrary/_internals/builders/TypedIntArrayArbitraryBuilder.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "BigIntArrayConstraints";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on typed arrays for big int values";
const sourceExample = "";
