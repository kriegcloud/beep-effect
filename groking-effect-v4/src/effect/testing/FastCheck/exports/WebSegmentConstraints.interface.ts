 ...
 * Export: WebSegmentConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/webSegment.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WebSegmentConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link webSegment}";
const sourceExample = "";
