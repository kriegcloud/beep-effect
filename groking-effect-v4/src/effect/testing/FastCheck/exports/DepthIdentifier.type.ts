 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DepthIdentifier";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Type used to strongly type instances of depth identifier while keeping internals what they contain internally";
const sourceExample = "";
