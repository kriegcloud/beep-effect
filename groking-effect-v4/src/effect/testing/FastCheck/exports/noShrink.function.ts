 ...
 * Export: noShrink
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/noShrink.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "noShrink";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Build an arbitrary without shrinking capabilities.";
const sourceExample = "";
