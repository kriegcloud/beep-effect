 ...
 * Export: Arbitrary
 * Kind: class
 * Source: node_modules/fast-check/lib/types/check/arbitrary/definition/Arbitrary.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Arbitrary";
const exportKind = "class";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Abstract class able to generate values on type `T`";
const sourceExample = "";
