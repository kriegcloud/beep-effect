 ...
 * Export: RandomType
 * Kind: type
 * Source: node_modules/fast-check/lib/types/check/runner/configuration/RandomType.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "RandomType";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Random generators automatically recognized by the framework without having to pass a builder function";
const sourceExample = "";
