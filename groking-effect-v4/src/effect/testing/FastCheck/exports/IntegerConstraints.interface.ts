 ...
 * Export: IntegerConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/integer.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "IntegerConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link integer}";
const sourceExample = "";
