 ...
 * Export: Stream
 * Kind: class
 * Source: node_modules/fast-check/lib/types/stream/Stream.d.ts
...
const sourceSummary = "Wrapper around `IterableIterator` interface offering a set of helpers to deal with iterations in a simple way";
const sourceExample = "";
