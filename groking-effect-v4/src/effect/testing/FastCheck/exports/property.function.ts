 ...
 * Export: property
 * Kind: function
 * Source: node_modules/fast-check/lib/types/check/property/Property.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "property";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Instantiate a new {@link fast-check#IProperty}";
const sourceExample = "";
