 ...
 * Export: DictionaryConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/dictionary.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DictionaryConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link dictionary}";
const sourceExample = "";
