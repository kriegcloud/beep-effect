 ...
 * Export: pre
 * Kind: function
 * Source: node_modules/fast-check/lib/types/check/precondition/Pre.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "pre";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Add pre-condition checks inside a property execution";
const sourceExample = "";
