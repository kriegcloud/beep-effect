 ...
 * Export: MixedCaseConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/mixedCase.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MixedCaseConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link mixedCase}";
const sourceExample = "";
