 ...
 * Export: IAsyncPropertyWithHooks
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "IAsyncPropertyWithHooks";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Interface for asynchronous property defining hooks, see {@link IAsyncProperty}";
const sourceExample = "";
