 ...
 * Export: Float64ArrayConstraints
 * Kind: type
 * Source: node_modules/fast-check/lib/types/arbitrary/float64Array.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Float64ArrayConstraints";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link float64Array}";
const sourceExample = "";
