 ...
 * Export: WebFragmentsConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/webFragments.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WebFragmentsConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link webFragments}";
const sourceExample = "";
