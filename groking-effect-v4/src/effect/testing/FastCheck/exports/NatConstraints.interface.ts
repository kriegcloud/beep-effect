 ...
 * Export: NatConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/nat.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "NatConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link nat}";
const sourceExample = "";
