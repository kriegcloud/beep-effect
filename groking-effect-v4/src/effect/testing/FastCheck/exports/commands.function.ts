 ...
 * Export: commands
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/commands.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "commands";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For arrays of {@link AsyncCommand} to be executed by {@link asyncModelRun}";
const sourceExample = "";
