 ...
 * Export: Random
 * Kind: class
 * Source: node_modules/fast-check/lib/types/random/generator/Random.d.ts
...
const sourceSummary = "Wrapper around an instance of a `pure-rand`'s random number generator offering a simpler interface to deal with random with impure patterns";
const sourceExample = "";
