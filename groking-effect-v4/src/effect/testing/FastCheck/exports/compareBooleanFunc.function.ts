 ...
 * Export: compareBooleanFunc
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/compareBooleanFunc.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "compareBooleanFunc";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For comparison boolean functions";
const sourceExample = "";
