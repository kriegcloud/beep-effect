 ...
 * Export: DomainConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/domain.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DomainConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link domain}";
const sourceExample = "";
