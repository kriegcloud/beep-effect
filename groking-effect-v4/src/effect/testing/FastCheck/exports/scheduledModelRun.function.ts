 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "scheduledModelRun";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Run asynchronous and scheduled commands over a `Model` and the `Real` system";
const sourceExample = "";
