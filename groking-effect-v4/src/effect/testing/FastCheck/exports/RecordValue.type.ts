 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "RecordValue";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Infer the type of the Arbitrary produced by record given the type of the source arbitrary and constraints to be applied";
const sourceExample = "";
