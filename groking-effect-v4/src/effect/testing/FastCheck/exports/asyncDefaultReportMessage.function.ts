 ...
 * Export: asyncDefaultReportMessage
 * Kind: function
 * Source: node_modules/fast-check/lib/types/check/runner/utils/RunDetailsFormatter.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "asyncDefaultReportMessage";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Format output of {@link check} using the default error reporting of {@link assert}";
const sourceExample = "";
