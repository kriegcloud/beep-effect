 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "DepthContext";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Instance of depth, can be used to alter the depth perceived by an arbitrary or to bias your own arbitraries based on the current depth";
const sourceExample = "";
