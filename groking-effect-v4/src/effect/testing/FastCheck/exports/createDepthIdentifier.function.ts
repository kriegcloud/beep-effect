 ...
 * Export: createDepthIdentifier
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/_internals/helpers/DepthContext.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "createDepthIdentifier";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Create a new and unique instance of DepthIdentifier that can be shared across multiple arbitraries if needed";
const sourceExample = "";
