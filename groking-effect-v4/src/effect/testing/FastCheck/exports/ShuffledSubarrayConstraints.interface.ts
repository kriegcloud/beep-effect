 ...
 * Export: ShuffledSubarrayConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/shuffledSubarray.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ShuffledSubarrayConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link shuffledSubarray}";
const sourceExample = "";
