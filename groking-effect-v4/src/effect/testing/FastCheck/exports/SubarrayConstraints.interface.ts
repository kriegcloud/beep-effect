 ...
 * Export: SubarrayConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/subarray.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "SubarrayConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link subarray}";
const sourceExample = "";
