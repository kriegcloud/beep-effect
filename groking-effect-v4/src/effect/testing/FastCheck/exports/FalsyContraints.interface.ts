 ...
 * Export: FalsyContraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/falsy.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "FalsyContraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link falsy}";
const sourceExample = "";
