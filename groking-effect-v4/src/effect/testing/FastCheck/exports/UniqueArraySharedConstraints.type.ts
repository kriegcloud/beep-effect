 ...
 * Export: UniqueArraySharedConstraints
 * Kind: type
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "UniqueArraySharedConstraints";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Shared constraints to be applied on {@link uniqueArray}";
const sourceExample = "";
