 ...
 * Export: ICommand
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/model/command/ICommand.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ICommand";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Interface that should be implemented in order to define a command";
const sourceExample = "";
