...
const sourceSummary =
  "Loosely typed type for the `tie` function passed by {@link letrec} to the `builder` function we pass to it. You may want also want to use its strongly typed version {@link Letre...";
const sourceExample = "";
