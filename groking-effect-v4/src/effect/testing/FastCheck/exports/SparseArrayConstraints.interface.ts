 ...
 * Export: SparseArrayConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/sparseArray.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "SparseArrayConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link sparseArray}";
const sourceExample = "";
