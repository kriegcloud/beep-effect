 ...
 * Export: UuidConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/uuid.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "UuidConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link uuid}";
const sourceExample = "";
