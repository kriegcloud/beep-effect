 ...
 * Kind: function
 * Source: node_modules/fast-check/lib/types/check/property/AsyncProperty.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "asyncProperty";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Instantiate a new {@link fast-check#IAsyncProperty}";
const sourceExample = "";
