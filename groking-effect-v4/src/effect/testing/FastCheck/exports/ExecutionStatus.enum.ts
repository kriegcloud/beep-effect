 ...
 * Kind: enum
 * Source: node_modules/fast-check/lib/types/check/runner/reporter/ExecutionStatus.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ExecutionStatus";
const exportKind = "enum";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Status of the execution of the property";
const sourceExample = "";
