 ...
 * Export: WebUrlConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/webUrl.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WebUrlConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link webUrl}";
const sourceExample = "";
