 ...
 * Export: maxSafeNat
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/maxSafeNat.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "maxSafeNat";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For positive integers between 0 (included) and Number.MAX_SAFE_INTEGER (included)";
const sourceExample = "";
