 ...
 * Export: MapConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/map.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MapConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link map}";
const sourceExample = "";
