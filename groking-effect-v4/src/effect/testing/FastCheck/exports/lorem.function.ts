 ...
 * Export: lorem
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/lorem.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "lorem";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For lorem ipsum string of words or sentences with maximal number of words or sentences";
const sourceExample = "";
