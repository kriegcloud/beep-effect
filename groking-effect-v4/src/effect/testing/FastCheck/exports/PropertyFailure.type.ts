 ...
 * Export: PropertyFailure
 * Kind: type
 * Source: node_modules/fast-check/lib/types/check/property/IRawProperty.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "PropertyFailure";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Represent failures of the property";
const sourceExample = "";
