 ...
 * Export: ipV4Extended
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/ipV4Extended.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ipV4Extended";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For valid IP v4 according to WhatWG";
const sourceExample = "";
