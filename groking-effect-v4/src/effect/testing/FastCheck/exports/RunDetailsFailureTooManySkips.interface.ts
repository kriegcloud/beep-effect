 ...
 * Export: RunDetailsFailureTooManySkips
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/runner/reporter/RunDetails.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "RunDetailsFailureTooManySkips";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Run reported as failed because too many retries have been attempted to generate valid values";
const sourceExample = "";
