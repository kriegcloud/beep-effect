 ...
 * Export: RunDetailsFailureInterrupted
 * Kind: interface
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "RunDetailsFailureInterrupted";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Run reported as failed because it took too long and thus has been interrupted";
const sourceExample = "";
