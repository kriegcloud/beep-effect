 ...
 * Export: CommandsContraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/model/commands/CommandsContraints.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "CommandsContraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Parameters for {@link commands}";
const sourceExample = "";
