 ...
 * Export: WebAuthorityConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/webAuthority.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WebAuthorityConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link webAuthority}";
const sourceExample = "";
