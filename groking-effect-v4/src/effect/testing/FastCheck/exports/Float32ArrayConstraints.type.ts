 ...
 * Export: Float32ArrayConstraints
 * Kind: type
 * Source: node_modules/fast-check/lib/types/arbitrary/float32Array.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "Float32ArrayConstraints";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link float32Array}";
const sourceExample = "";
