 ...
 * Export: constantFrom
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/constantFrom.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "constantFrom";
const exportKind = "function";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "For one `...values` values - all equiprobable";
const sourceExample = "";
