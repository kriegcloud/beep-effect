 ...
 * Export: gen
 * Kind: function
 * Source: node_modules/fast-check/lib/types/arbitrary/gen.d.ts
...
const sourceSummary = "Generate values within the test execution itself by leveraging the strength of `gen`";
const sourceExample = "";
