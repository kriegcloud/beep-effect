 ...
 * Export: OptionConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/option.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "OptionConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link option}";
const sourceExample = "";
