 ...
 * Export: ArrayConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/array.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ArrayConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link array}";
const sourceExample = "";
