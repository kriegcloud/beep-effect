 ...
 * Export: ContextValue
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/context.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ContextValue";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Execution context attached to one predicate run";
const sourceExample = "";
