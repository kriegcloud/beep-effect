 ...
 * Export: StringConstraints
 * Kind: type
 * Source: node_modules/fast-check/lib/types/arbitrary/string.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "StringConstraints";
const exportKind = "type";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on arbitrary {@link string}";
const sourceExample = "";
