 ...
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/_internals/helpers/QualifiedObjectConstraints.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ObjectConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints for {@link anything} and {@link object}";
const sourceExample = "";
