 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "IAsyncProperty";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Interface for asynchronous property, see {@link IRawProperty}";
const sourceExample = "";
