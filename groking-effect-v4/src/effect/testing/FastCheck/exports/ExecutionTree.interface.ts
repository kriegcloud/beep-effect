 ...
 * Export: ExecutionTree
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/runner/reporter/ExecutionTree.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "ExecutionTree";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Summary of the execution process";
const sourceExample = "";
