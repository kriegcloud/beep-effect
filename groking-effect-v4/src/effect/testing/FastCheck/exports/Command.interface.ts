 ...
 * Export: Command
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/model/command/Command.d.ts
...
const sourceSummary = "Interface that should be implemented in order to define a synchronous command";
const sourceExample = "";
