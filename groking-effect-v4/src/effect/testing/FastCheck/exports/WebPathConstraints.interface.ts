 ...
 * Export: WebPathConstraints
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/arbitrary/webPath.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WebPathConstraints";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Constraints to be applied on {@link webPath}";
const sourceExample = "";
