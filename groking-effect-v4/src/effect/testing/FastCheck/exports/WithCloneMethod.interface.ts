 ...
 * Export: WithCloneMethod
 * Kind: interface
 * Source: node_modules/fast-check/lib/types/check/symbols.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WithCloneMethod";
const exportKind = "interface";
const moduleImportPath = "effect/testing/FastCheck";
const sourceSummary = "Object instance that should be cloned from one generation/shrink to another";
const sourceExample = "";
