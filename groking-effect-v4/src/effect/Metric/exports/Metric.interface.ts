...
const sourceSummary = "A `Metric<Input, State>` represents a concurrent metric which accepts update values of type `Input` and are aggregated to a value of type `State`.";
