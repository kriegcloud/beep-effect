...
const sourceSummary = "Combines filtering and mapping in a single operation. Applies a function that returns an Option to each entry, keeping only the Some values and transforming them.";
