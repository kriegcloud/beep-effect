 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WellKnownServiceTier";
const exportKind = "type";
const moduleImportPath = "@effect/ai-openai-compat/OpenAiTelemetry";
const sourceSummary = "The `gen_ai.openai.request.service_tier` attribute has the following list of well-known values.";
const sourceExample = "";
