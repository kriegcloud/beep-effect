 ...
 * Export: WellKnownResponseFormat
 * Kind: type
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "WellKnownResponseFormat";
const exportKind = "type";
const moduleImportPath = "@effect/ai-openai/OpenAiTelemetry";
const sourceSummary = "The `gen_ai.openai.request.response_format` attribute has the following list of well-known values.";
const sourceExample = "";
