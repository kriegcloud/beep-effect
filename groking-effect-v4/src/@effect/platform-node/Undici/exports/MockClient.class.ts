 ...
 * Export: MockClient
 * Kind: class
 * Source: node_modules/undici/types/mock-client.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MockClient";
const exportKind = "class";
const moduleImportPath = "@effect/platform-node/Undici";
const sourceSummary = "MockClient extends the Client API and allows one to mock requests.";
const sourceExample = "";
