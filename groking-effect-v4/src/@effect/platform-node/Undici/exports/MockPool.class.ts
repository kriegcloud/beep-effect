 ...
 * Export: MockPool
 * Kind: class
 * Source: node_modules/undici/types/mock-pool.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "MockPool";
const exportKind = "class";
const moduleImportPath = "@effect/platform-node/Undici";
const sourceSummary = "MockPool extends the Pool API and allows one to mock requests.";
const sourceExample = "";
