 ...
 * Export: H2CClient
 * Kind: class
 * Source: node_modules/undici/types/h2c-client.d.ts
 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "H2CClient";
const exportKind = "class";
const moduleImportPath = "@effect/platform-node/Undici";
const sourceSummary = "A basic H2C client, mapped on top a single TCP connection. Pipelining is disabled by default.";
const sourceExample = "";
