 ...
 * Export Coordinates
 * ========================================================================== */
const exportName = "layerTypeScript";
const exportKind = "const";
const moduleImportPath = "@effect/ai-codegen/Generator";
const sourceSummary = "Layer providing the CodeGenerator with TypeScript-only transformer.";
const sourceExample = "";
