# Iteration 4 - Dry Run Prompt (effect/Cause StackTrace.class)

You are not alone in this codebase. Other agents may make unrelated edits; ignore them and do not modify files outside your assignment.
...
## Assignment
- Target file: `/home/elpresidank/YeeBois/projects/beep-effect2/groking-effect-v4/src/effect/Cause/exports/StackTrace.class.ts`
- Export kind: `class`
- Mode: dry-run only
...
- Report output: `/home/elpresidank/YeeBois/projects/beep-effect2/groking-effect-v4/agents/experiments/dry-run-iterations/iteration-4/reports/agent-cause-stacktrace.md`

## Deliverable
Create only the report file. Do not modify target exports.
