...
2. Preserve current executable, source-aligned `Option.Do` examples.
...
2. Write report to:
   - /home/elpresidank/YeeBois/projects/beep-effect2/groking-effect-v4/agents/experiments/implementation-wave-core-effect/batch-001/reports/fix-option-do-const.md
