import {
  ...
  PromptClient,
  TriplesClient,
} from "@beep/graph-pipeline/Clients";
import { graphRagQuery } from "@beep/graph-pipeline/GraphRag";
...
const literal = (value: string): Primitives.Term => ({
  type: "LITERAL",
  value,
  datatype: O.none(),
  language: O.none(),
...
const SEED_TRIPLES: ReadonlyArray<Primitives.Triple> = [
  {
    ...
    p: iri("http://example.org/usedBy"),
    o: iri("http://example.org/ChatGPT"),
  },
  {
    g: O.none(),
