...
CREATE TABLE "user_hotkey" (
	...
	CONSTRAINT "user_hotkey_id_unique" UNIQUE("id")
);
--> statement-breakpoint
...
ALTER TABLE "user_hotkey" ADD CONSTRAINT "user_hotkey_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "user_hotkeys_shortcuts_idx" ON "user_hotkey" USING btree ("shortcuts");--> statement-breakpoint
