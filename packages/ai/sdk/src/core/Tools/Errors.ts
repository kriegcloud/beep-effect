...
export class ToolNotFoundError extends Schema.TaggedErrorClass<ToolNotFoundError>()(
  ...
  static readonly make = (params: Pick<ToolNotFoundError, "name" | "available">) =>
    new ToolNotFoundError(params)
}
 ...
 */
export class ToolOutputError extends Schema.TaggedErrorClass<ToolOutputError>()(
  "ToolOutputError",
  {
    name: Schema.String,
    message: Schema.String,
