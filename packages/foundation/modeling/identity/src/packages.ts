...
/**
 * Identity composer for `@beep/inputs`.
 *
 * @example
 * ```typescript
 * import { $InputsId } from "@beep/identity"
 *
 * const id = $InputsId.make("Inputs")
 * void id
 * ```
 *
 * @since 0.0.0
 * @category configuration
 */
export const $InputsId: Identity.IdentityComposer<"@beep/inputs"> = composers.$InputsId;
