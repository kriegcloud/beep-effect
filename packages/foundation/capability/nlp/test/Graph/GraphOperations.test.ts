...
describe("ExecutionId", () => {
  it.effect("generates distinct ids", () =>
    Effect.gen(function* () {
...
describe("Operation constructors", () => {
  it.effect("pure mints one child node per produced value", () =>
    Effect.gen(function* () {
  ...
  it.effect("transform produces a single mapped child", () =>
    Effect.gen(function* () {
  ...
  it.effect("filter keeps or drops based on the predicate", () =>
    Effect.gen(function* () {
  ...
  it.effect("identity re-emits the node under a fresh id", () =>
    Effect.gen(function* () {
...
describe("ResultStore", () => {
  ...
  it.effect("stores and retrieves a result, incrementing hits", () =>
    Effect.gen(function* () {
...
describe("GraphExecutor", () => {
  ...
  it.effect("applies an operation to leaf nodes, producing new nodes", () =>
    Effect.gen(function* () {
