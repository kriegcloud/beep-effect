...
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for the Delete KnowledgeEntity contract.",
  })
) {}

export class Success extends S.Void.annotations(
  $I.annotations("Success", {
    description: "Success response for the Delete KnowledgeEntity contract.",
  })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", {
    description: "Delete KnowledgeEntity Request Contract.",
  })
) {
  ...
  static readonly Http = HttpApiEndpoint.del("Delete", "/:id")
    ...
    .addError(EntityErrors.KnowledgeEntityPermissionDeniedError)
