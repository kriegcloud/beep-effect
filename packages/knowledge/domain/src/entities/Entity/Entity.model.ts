...
import { Attributes, Confidence } from "@beep/knowledge-domain/values/Attributes.value.value";
import { EvidenceSpan } from "@beep/knowledge-domain/values/EvidenceSpan.value.value";
...
export class Model extends M.Class<Model>($I`EntityModel`)(
  makeFields(KnowledgeEntityIds.KnowledgeEntityId, {
    ...
    documentId: BS.FieldOptionOmittable(
      WorkspacesEntityIds.DocumentId.annotations({
