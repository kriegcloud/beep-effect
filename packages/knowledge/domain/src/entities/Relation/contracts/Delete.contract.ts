...
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for the Delete Relation contract.",
  })
) {}

export class Success extends S.Void.annotations(
  $I.annotations("Success", {
    description: "Success response for the Delete Relation contract.",
  })
) {}

export const Failure = S.Union(RelationErrors.RelationNotFoundError, RelationErrors.RelationPermissionDeniedError);
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  static readonly Http = HttpApiEndpoint.del("Delete", "/:id")
    ...
    .addError(RelationErrors.RelationPermissionDeniedError)
