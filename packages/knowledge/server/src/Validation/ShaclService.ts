...
const serviceEffect: Effect.Effect<ShaclServiceShape, never, OntologyService> = Effect.gen(function* () {
	...
	const validate: (
		...
		ontology: OntologyContext,
		options?: undefined | ValidateOptions
	) => Effect.Effect<ValidationReport, ShaclValidationError | ValidationPolicyError> = Effect.fn("ShaclService.validate")(function* (
			graph: N3.Store,
			ontology: OntologyContext,
			options?: undefined | ValidateOptions
		) {
	...
	const validateOntologyGraph: (
		...
		ontologyContent: string,
		options?: undefined | ValidateOptions
	) => Effect.Effect<ValidationReport, ShaclValidationError | ValidationPolicyError> = Effect.fn("ShaclService.validateOntologyGraph")(function* (
		graph: N3.Store,
		ontologyKey: string,
		ontologyContent: string,
		options?: undefined | ValidateOptions
