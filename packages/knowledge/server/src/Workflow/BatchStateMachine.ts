...
export interface BatchStateMachineShape {
  readonly create: (batchId: KnowledgeEntityIds.BatchExecutionId.Type) => Effect.Effect<BatchState>;
...
const serviceEffect: Effect.Effect<BatchStateMachineShape> = Effect.gen(function* () {
  ...
  const create: BatchStateMachineShape["create"] = Effect.fn("BatchStateMachine.create")(function* (
    batchId: KnowledgeEntityIds.BatchExecutionId.Type
  ) {
  ...
  const getState: BatchStateMachineShape["getState"] = Effect.fn("BatchStateMachine.getState")(function* (
    batchId: KnowledgeEntityIds.BatchExecutionId.Type
  ) {
  ...
  const transition: BatchStateMachineShape["transition"] = Effect.fn("BatchStateMachine.transition")(function* (
    batchId: KnowledgeEntityIds.BatchExecutionId.Type,
    nextState: BatchState
  ) {
