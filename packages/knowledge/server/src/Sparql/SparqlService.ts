...
const serviceEffect: Effect.Effect<SparqlServiceShape, never, SparqlParser | RdfStore> = Effect.gen(function* () {
	...
	const select: (queryString: string) => Effect.Effect<SelectResult, SparqlServiceError.Type> = Effect.fn("SparqlService.select")(function* (queryString) {
		return yield* pipe(
	...
	const construct: (queryString: string) => Effect.Effect<ConstructResult.Type, SparqlServiceError.Type> =
		Effect.fn(function* (queryString: string) {
			return yield* pipe(
	...
	const ask: (queryString: string) => Effect.Effect<AskResult.Type, SparqlServiceError.Type> =
		Effect.fn("SparqlService.ask")(function* (queryString: string) {
			return yield* pipe(
	...
	const describe: (queryString: string) => Effect.Effect<DescribeResult.Type, SparqlServiceError.Type> =
		Effect.fn("SparqlService.describe")(function* (queryString: string) {
			return yield* pipe(
