import { TextStyle } from "@beep/knowledge-management-domain/value-objects";
...
export const document = OrgTable.make(KnowledgeManagementEntityIds.DocumentId)(
  {
    userId: pg
      .text("user_id")
      .notNull()
    ...
    parentDocumentId: pg.text("parent_document_id").$type<KnowledgeManagementEntityIds.DocumentId.Type>(),
    title: pg.text("title"),
