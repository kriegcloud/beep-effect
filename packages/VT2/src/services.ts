...
import { LiteralKit, StatusCauseFields, TaggedErrorClass } from "@beep/schema";
...
const $I = $RootId.create("VT2/services");
 ...
 * @category PortContract
 */
export class Vt2MemoryContextProvider extends Context.Service<Vt2MemoryContextProvider, Vt2MemoryContextProviderShape>()(
