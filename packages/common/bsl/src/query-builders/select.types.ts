import type { AnyColumn, Column, ColumnBaseConfig, GetColumnData, UpdateColConfig } from "../column";
import type { ChangeColumnTableName, ColumnType, Dialect } from "../column-builder";
import type { SelectedFields } from "../operations";
import type { ColumnsSelection, SQL, View } from "../sql/sql";
import type { Subquery } from "../subquery";
import type { Table } from "../table";
import type { Assume, DrizzleTypeError, Equal, FromSingleKeyObject, IsAny, IsUnion, Not, Simplify } from "../utils";

export type JoinType = "inner" | "left" | "right" | "full" | "cross";

export type JoinNullability = "nullable" | "not-null";

export type ApplyNullability<T, TNullability extends JoinNullability> = TNullability extends "nullable"
  ? T | null
...
> = TNullability extends "not-null"
  ...
  : Column<
      Assume<
        ...
        >,
        ColumnBaseConfig<ColumnType.Type>
      >
    >;
              ...
              : TField extends Subquery
                ...
                : TField extends Record<string, any>
                  ? TField[keyof TField] extends
                      | AnyColumn<{ tableName: infer TTableName extends string }>
                      | SQL
                      | SQL.Aliased
    ...
    : {
        [Key in keyof TSelection]: TSelection[Key] extends Column
          ...
          : TSelection[Key] extends Table
            ...
            : TSelection[Key] extends SQL | SQL.Aliased
              ? TSelection[Key]
      ...
      : "inner" extends TJoinType
        ...
        : "cross" extends TJoinType
          ...
          : "full" extends TJoinType
            ? SetJoinsNullability<TJoinsNotNull, "nullable"> & { [name in TJoinedName]: "nullable" }
            : never
  : TJoinsNotNull;
