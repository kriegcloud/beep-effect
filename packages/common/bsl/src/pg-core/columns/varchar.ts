...
export class PgVarcharBuilder<TEnum extends [string, ...string[]] | undefined = undefined> extends PgColumnBuilder<
...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgVarchar(table, this.config as any);
  }
}

export class PgVarchar<TEnum extends [string, ...string[]] | undefined = undefined> extends PgColumn<
...
export function varchar(config: { length?: undefined | number }): PgVarcharBuilder<undefined>;
export function varchar(name: string, config: { length?: undefined | number }): PgVarcharBuilder<undefined>;
...
export function varchar(a?: undefined | string | PgVarcharConfig, b: PgVarcharConfig = {}): any {
