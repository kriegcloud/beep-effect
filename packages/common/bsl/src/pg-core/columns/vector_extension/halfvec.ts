...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgHalfVector(table, this.config as any);
  }
}
...
export function halfvec(config: PgHalfVectorConfig): PgHalfVectorBuilder;
export function halfvec(name: string, config: PgHalfVectorConfig): PgHalfVectorBuilder;
