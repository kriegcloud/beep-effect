import type { CacheConfig, WithCacheConfig } from "../../cache/core/types";
import { entityKind, is } from "../../entity";
import type { PgColumn } from "../../pg-core/columns/index";
import type { PgDialect } from "../../pg-core/dialect";
import type { PgSession, PreparedQueryConfig } from "../../pg-core/session";
import type { SubqueryWithSelection } from "../../pg-core/subquery";
import type { PgTable } from "../../pg-core/table";
import { PgViewBase } from "../../pg-core/view-base";
...
import type { ColumnsSelection, Placeholder, Query, SQLWrapper } from "../../sql/sql";
import { SQL, View } from "../../sql/sql";
...
export class PgSelectBuilder<TSelection extends SelectedFields | undefined, TBuilderMode extends "db" | "qb" = "db"> {
...
> extends TypedQueryBuilder<TSelectedFields, TResult> {
  ...
  protected cacheConfig?: undefined | WithCacheConfig = undefined;
  ...
  >(
    ...
    ? PgSelectCrossJoinFn<this, TDynamic, TIsLateral>
  ...
  ) => PgSelectWithout<this, TDynamic, PgSetOperatorExcludedMethods, true> {
  ...
  $withCache(
    config?:
      | undefined
      | { config?: undefined | CacheConfig; tag?: undefined | string; autoInvalidate?: undefined | boolean }
      | false
  ) {
    this.cacheConfig =
      config === undefined
  ...
  implements RunnableQuery<TResult, "pg">, SQLWrapper
{
  ...
  /** @internal */
  _prepare(name?: undefined | string): PgSelectPrepare<this> {
