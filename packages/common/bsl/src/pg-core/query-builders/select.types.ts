...
import type { PgColumn } from "../../pg-core/columns/index";
import type { PgTable, PgTableWithColumns } from "../../pg-core/table";
import type { PgViewWithSelection } from "../../pg-core/view";
import type { PgViewBase } from "../../pg-core/view-base";
...
import type { ColumnsSelection, Placeholder, SQL, SQLWrapper, View } from "../../sql/sql";
import type { Subquery } from "../../subquery";
import type { Table, UpdateTableConfig } from "../../table";
import type { Assume, DrizzleTypeError, Equal, ValidateShape, ValueOrArray } from "../../utils";
import type { PgPreparedQuery, PreparedQueryConfig } from "../session";
import type { PgSelectBase, PgSelectQueryBuilderBase } from "./select";
...
export interface PgSelectConfig {
  ...
  fieldsFlat?: undefined | SelectedFieldsOrdered;
  where?: undefined | SQL;
  having?: undefined | SQL;
  table: PgTable | Subquery | PgViewBase | SQL;
  limit?: undefined | number | Placeholder;
  offset?: undefined | number | Placeholder;
  joins?: undefined | PgSelectJoinConfig[];
  orderBy?: undefined | (PgColumn | SQL | SQL.Aliased)[];
  groupBy?: undefined | (PgColumn | SQL | SQL.Aliased)[];
  lockingClause?:
    | undefined
    | {
...
export type TableLikeHasEmptySelection<T extends PgTable | Subquery | PgViewBase | SQL> = T extends Subquery
  ? Equal<T["_"]["selectedFields"], {}> extends true
    ? true
    : false
  : false;
...
export type LockConfig = {
  of?: undefined | ValueOrArray<PgTable>;
} & (
  | {
      noWait: true;
      skipLocked?: undefined | undefined;
    }
  | {
      noWait?: undefined | undefined;
      skipLocked: true;
    }
  | {
      noWait?: undefined;
...
export type PgSetOperator<
  ...
  TSelectMode extends SelectMode = SelectMode,
  TNullabilityMap extends Record<string, JoinNullability> = Record<string, JoinNullability>,
> = PgSelectBase<TTableName, TSelection, TSelectMode, TNullabilityMap, true, PgSetOperatorExcludedMethods>;
