...
import { AiCorpusRankedDocumentSchema } from "./_schemas.ts";

export const QueryCorpus = Tool.make("QueryCorpus", {
  description: "Query a learned corpus session and return BM25 vector-cosine ranked results without relearning",
  parameters: {
