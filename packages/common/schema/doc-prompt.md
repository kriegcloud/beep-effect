You are enforcing the documentation strategy for @beep/utils. Follow these steps exactly:
  ...
  1. Review Strategy Docs
      - Read packages/common/schema/DOCUMENTATION_STRATEGY.md.
  ...
  7. Repo-Level Docgen & Docs Site
      ...
      - If other packages aren’t ready (e.g., schema dependencies), either patch shared configs (like schema/docgen.json) or coordinate with owners.
