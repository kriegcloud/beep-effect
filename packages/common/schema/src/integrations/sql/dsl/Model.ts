...
import type { ColumnDef, DSL, ModelClassWithVariants, ModelVariant } from "./types";
import { ColumnMetaSymbol, isDSLVariantField, MODEL_VARIANTS } from "./types";
  ...
  F.pipe(
    ...
    R.map((field) => {
      ...
      if (isDSLVariantField(field)) {
        ...
        return VS.Field(field.schemas as VariantSchema.Field.ConfigWithKeys<ModelVariant>);
      }
      ...
      if (isAnyVariantField(field)) {
        ...
        return VS.Field(
          (field as VariantSchema.Field<VariantSchema.Field.Config>)
            .schemas as VariantSchema.Field.ConfigWithKeys<ModelVariant>
        );
      }
      ...
      return VS.FieldOnly(...MODEL_VARIANTS)(schema);
    })
  ) as VariantSchema.Struct.Fields;
