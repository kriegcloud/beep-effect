 ...
 *
 * Mirrors Drizzle/Bun serial types so schema consumers can brand auto-incrementing IDs.
 *
 * @example
 * import * as S from "effect/Schema";
 * import { PgSerialSchema } from "@beep/schema/integrations/sql/pg-serial";
 *
 ...
 *
 * @example
 * import type { PgSerialSchema } from "@beep/schema/integrations/sql/pg-serial";
 *
