 ...
 * @category generated
 */
export interface Generated<S extends S.Schema.All | S.PropertySignature.All>
 ...
 * @category generated
 */
export const Generated = <S extends S.Schema.All | S.PropertySignature.All>(schema: S): Generated<S> =>
  Field({
    select: schema,
    update: schema,
    json: schema,
 ...
 * @category generated
 */
export const GeneratedByApp = <S extends S.Schema.All | S.PropertySignature.All>(schema: S): GeneratedByApp<S> =>
  Field({
    select: schema,
    insert: schema,
    update: schema,
 ...
 * @category sensitive
 */
export interface Sensitive<S extends S.Schema.All | S.PropertySignature.All>
  extends VariantSchema.Field<{
    readonly select: S;
    readonly insert: S;
    readonly update: S;
 ...
 * @category sensitive
 */
export const Sensitive = <S extends S.Schema.All | S.PropertySignature.All>(schema: S): Sensitive<S> =>
  Field({
    select: schema,
    insert: schema,
    update: schema,
 ...
 * @category optional
 */
export interface FieldOption<S extends S.Schema.Any>
  extends VariantSchema.Field<{
 ...
 * @category date & time
 */
export interface DateTimeFromDate extends S.transform<typeof S.ValidDateFromSelf, typeof S.DateTimeUtcFromSelf> {}

/**
 * @since 1.0.0
 * @category date & time
 */
export const DateTimeFromDate: DateTimeFromDate = S.transform(S.ValidDateFromSelf, S.DateTimeUtcFromSelf, {
 ...
 * @category date & time
 */
export const Date: Date = S.transformOrFail(S.String, S.DateTimeUtcFromSelf, {
  decode: (s, _, ast) =>
 ...
 * @category json
 */
export const JsonFromString = <S extends S.Schema.All | S.PropertySignature.All>(schema: S): JsonFromString<S> => {
 ...
 * @category uuid
 */
export class BooleanFromNumber extends S.transform(S.Literal(0, 1), S.Boolean, {
  decode: (n) => n === 1,
  encode: (b) => (b ? 1 : 0),
}) {}
