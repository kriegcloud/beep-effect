 ...
 *
 * @example
 * import { makeFlat } from "@beep/schema/core/utils/arbitrary";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { makeArb } from "@beep/schema/core/utils/arbitrary";
 *
