...
export const UpdateDeleteAction = LiteralKit([
	"cascade",
	"restrict",
	"no action",
	"set null",
...
export const ArrayDimension = LiteralKit(DimensionStringFromNumber.From.Options)
.annotate($I.annote(
	"ArrayDimension",
	{
...
export const ArrayDimensionString = LiteralKit(DimensionStringFromNumber.To.Options)
.annotate($I.annote(
	"ArrayDimensionString",
	{
		description: "All array dimensions supported by SQL columns as string"
	}
));
...
export const PolicyConfigAs = LiteralKit([
	"permissive",
	"restrictive"
])
.annotate($I.annote(
...
export const PolicyConfigFor = LiteralKit([
	"all",
	"select",
	"insert",
	"update",
...
export const Casing = LiteralKit([
	"snake_case",
	"camelCase"
])
.annotate($I.annote(
...
export const RelationType = LiteralKit([
	"many",
	"one"
])
.annotate($I.annote(
...
export type Assume<T, U> = T extends U
                           ? T
                           : U;


export type ExtractColumnTypeData<T extends ColumnType> = T extends `${infer Type extends ColumnDataType} ${infer Constraint extends ColumnDataConstraint}`
...
.annotate($I.annote(
	"BigIntColumnTypeDataConstraint",
	{
...
.annotate($I.annote(
	"NumberColumnTypeDataConstraint",
	{
...
.annotate($I.annote(
	"ObjectColumnTypeDataConstraint",
	{
...
.annotate($I.annote(
	"StringColumnTypeDataConstraint",
	{
