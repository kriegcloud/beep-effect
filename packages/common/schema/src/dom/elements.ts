 ...
 */
export const DOMHtmlElement = S.declare(isHTMLElement)
	.pipe(
		$I.annoteSchema(
			"DOMHtmlElement",
			{
...
export const DOMCssProperties = S.declare(isCSSProperties)
	.pipe(
		$I.annoteSchema(
			"DOMCssProperties",
			{
 ...
 * @category DomainModel
 */
export const DOMReactNode = S.declare(isReactNode)
	.pipe(
		$I.annoteSchema(
			"DOMReactNode",
			{
 ...
 * @category DomainModel
 */
export const DOMDragEvent = S.declare(isDragEvent)
	.pipe(
		$I.annoteSchema(
			"DOMDragEvent",
			{
