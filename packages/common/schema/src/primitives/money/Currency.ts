 ...
 */
export const DecimalPlaces = S.Literal(0, 2, 3, 4).annotations({
...
/**
 * Type guard for DecimalPlaces using S.is
 */
...
export class Currency extends S.Class<Currency>("Currency")({
   ...
   */
  symbol: S.NonEmptyTrimmedString.annotations({
...
/**
 * Type guard for Currency using S.is
 */
