...
export const currencies = [
  ...
  {
    entity: "INTERNATIONAL MONETARY FUND (IMF)\u00c2",
...
const codes = A.map(currencies, (_) => _.alphabeticcode);

export class Currency extends StringLiteralKit(...codes) {
  static readonly format = (options: {
...
export namespace Currency {
  export type Type = typeof Currency.Type;
  export type Encoded = typeof Currency.Encoded;
}
