...
@category Class
*/
export type Class<T, Arguments extends unknown[] = UnsafeTypes.UnsafeAny[]> = {
...
@category Class
*/
export type Constructor<T, Arguments extends unknown[] = UnsafeTypes.UnsafeAny[]> = new (...arguments_: Arguments) => T;
...
@category Class
*/
export type AbstractConstructor<T, Arguments extends unknown[] = UnsafeTypes.UnsafeAny[]> = abstract new (
