import type { _DefaultDelimiterCaseOptions } from "./delimiter-case";
...
@category Object
*/
export type SnakeCasedPropertiesDeep<Value, Options extends WordsOptions = {}> = DelimiterCasedPropertiesDeep<
  Value,
  "_",
