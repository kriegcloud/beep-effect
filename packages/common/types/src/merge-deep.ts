...
import type { EnforceOptional, FirstArrayElement, IsBothExtends, UnknownArrayOrTuple } from "./internal/index";
...
*/
type MergeDeepRecordProperty<Destination, Source, Options extends MergeDeepInternalOptions> = undefined extends Source
...
*/
type MergeDeepArrayOrTupleElements<Destination, Source, Options extends MergeDeepInternalOptions> = Source extends []
  ? Destination
  : Destination extends []
    ? Source
    : MergeDeepOrReturn<Source, Destination, Source, Options>;
