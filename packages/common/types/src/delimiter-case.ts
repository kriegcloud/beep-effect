import type { ApplyDefaultOptions, AsciiPunctuation, StartsWith } from "./internal/index";
import type { IsStringLiteral } from "./is-literal";
import type { Merge } from "./merge";
import type { RemovePrefix } from "./remove-prefix";
import type { _DefaultWordsOptions, Words, WordsOptions } from "./words";
 ...
 */
export type DelimiterCase<Value, Delimiter extends string, Options extends WordsOptions = {}> = Value extends string
