 ...
 */
export const TypeId = "@beep/utils/WebError";
 ...
 * @example
 * ```ts
 * import { WebError } from "@beep/utils/effect"
 *
 ...
 */
export class EvalError extends Schema.TaggedError<EvalError>()("@beep/utils/Web/EvalError", {
 ...
 */
export class RangeError extends Schema.TaggedError<RangeError>()("@beep/utils/Web/RangeError", {
 ...
 */
export class ReferenceError extends Schema.TaggedError<ReferenceError>()("@beep/utils/Web/ReferenceError", {
 ...
 */
export class TypeError extends Schema.TaggedError<TypeError>()("@beep/utils/Web/TypeError", {
 ...
 */
export class URIError extends Schema.TaggedError<URIError>()("@beep/utils/Web/URIError", {
...
export class QuotaExceededError extends Schema.TaggedError<QuotaExceededError>()(
  "@beep/utils/Web/QuotaExceededError",
  {
    cause: Schema.Union(
...
export class NoModificationAllowedError extends Schema.TaggedError<NoModificationAllowedError>()(
  "@beep/utils/Web/NoModificationAllowedError",
  {
 ...
 */
export class NotFoundError extends Schema.TaggedError<NotFoundError>()("@beep/utils/Web/NotFoundError", {
 ...
 */
export class NotAllowedError extends Schema.TaggedError<NotAllowedError>()("@beep/utils/Web/NotAllowedError", {
...
export class TypeMismatchError extends Schema.TaggedError<TypeMismatchError>()(
  "@beep/utils/Web/TypeMismatchError",
  {
...
export class InvalidStateError extends Schema.TaggedError<InvalidStateError>()(
  "@beep/utils/Web/InvalidStateError",
  {
 ...
 */
export class AbortError extends Schema.TaggedError<AbortError>()("@beep/utils/Web/AbortError", {
...
export class InvalidModificationError extends Schema.TaggedError<InvalidModificationError>()(
  "@beep/utils/Web/InvalidModificationError",
  {
 ...
 */
export class SecurityError extends Schema.TaggedError<SecurityError>()("@beep/utils/Web/SecurityError", {
 ...
 */
export class DataCloneError extends Schema.TaggedError<DataCloneError>()("@beep/utils/Web/DataCloneError", {
 ...
 *   Effect.catchTag("@beep/utils/Web/UnknownError", (error) => {
 ...
 * ```
 */
export class UnknownError extends Schema.TaggedError<UnknownError>()("@beep/utils/Web/UnknownError", {
