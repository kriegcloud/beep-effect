...
describe("flatMapNonEmpty", () => {
  it("data-first returns NonEmptyArray", () => {
    expect(Array.flatMapNonEmpty(nonEmpty, (x): Array.NonEmptyReadonlyArray<string> => [String(x)])).type.toBe<
  ...
  it("data-last returns NonEmptyArray", () => {
    expect(
      pipe(
        nonEmpty,
        Array.flatMapNonEmpty((x): Array.NonEmptyReadonlyArray<string> => [String(x)])
      )
    ).type.toBe<Array.NonEmptyArray<string>>();
  });
});
...
describe("mapNonEmptyReadonly", () => {
  it("data-first returns NonEmptyReadonlyArray", () => {
    expect(Array.mapNonEmptyReadonly(nonEmpty, (x) => String(x))).type.toBe<Array.NonEmptyReadonlyArray<string>>();
  });
  ...
  it("data-last returns NonEmptyReadonlyArray", () => {
    expect(
      pipe(
        nonEmpty,
        Array.mapNonEmptyReadonly((x) => String(x))
      )
...
describe("flatMapNonEmptyReadonly", () => {
  it("data-first returns NonEmptyReadonlyArray", () => {
    expect(Array.flatMapNonEmptyReadonly(nonEmpty, (x): Array.NonEmptyReadonlyArray<string> => [String(x)])).type.toBe<
  ...
  it("data-last returns NonEmptyReadonlyArray", () => {
    expect(
      pipe(
        nonEmpty,
        Array.flatMapNonEmptyReadonly((x): Array.NonEmptyReadonlyArray<string> => [String(x)])
      )
    ).type.toBe<Array.NonEmptyReadonlyArray<string>>();
  });
});
