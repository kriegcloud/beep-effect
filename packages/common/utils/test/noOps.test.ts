...
effect(
  "sync no-op helpers return stable outputs",
  Effect.fn(function* () {
...
effect(
  "async no-ops resolve quickly without side effects",
  Effect.fn(function* () {
...
effect(
  "nullOpE composes in Effect pipelines",
  Effect.fn(function* () {
...
effect(
  "no-op helpers keep references stable and callable",
  Effect.fn(function* () {
