...
effect(
  "guards and assertions validate non-empty schema arrays",
  Effect.fn(function* () {
...
effect(
  "NonEmptyReadonly.make preserves tuples and arrays",
  Effect.fn(function* () {
...
effect(
  "NonEmptyReadonly.mapWith supports curried and uncurried usage",
  Effect.fn(function* () {
...
effect(
  "NonEmptyReadonly.filter enforces non-empty output",
  Effect.fn(function* () {
...
effect(
  "NonEmptyReadonly.from and fromIterable reject empty inputs",
  Effect.fn(function* () {
