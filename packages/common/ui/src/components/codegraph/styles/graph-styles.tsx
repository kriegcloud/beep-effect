...
export const graphStylesFast: any[] = [
  ...
  {
    selector: 'edge[label="LISTENS_TO"]',
    style: { "line-color": "#c084fc", "target-arrow-color": "#c084fc", opacity: 0.5, width: 1.5 },
  },
  {
    selector: 'edge[label="EXTENDS"]',
    style: {
  ...
  {
    selector: 'edge[label="HAS_SECURITY_ISSUE"]',
    style: { "line-color": "#ef4444", "target-arrow-color": "#ef4444", opacity: 0.8, width: 2 },
  },
  {
    selector: 'edge[label="CALLS_EXTERNAL"]',
    style: { "line-color": "#818cf8", "target-arrow-color": "#818cf8", opacity: 0.5, width: 1.5 },
  },
  {
    selector: "node:selected",
    style: {
