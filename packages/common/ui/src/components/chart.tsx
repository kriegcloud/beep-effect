...
export class ChatTooltipContentIndicator extends BS.StringLiteralKit("line", "dot", "dashed") {}

export declare namespace ChatTooltipContentIndicator {
  export type Type = typeof ChatTooltipContentIndicator.Type;
}
function ChartTooltipContent({
  active,
  payload,
  className,
  indicator = ChatTooltipContentIndicator.Enum.dot,
  hideLabel = false,
  hideIndicator = false,
  label,
  labelFormatter,
  ...
  React.ComponentProps<"div"> & {
    ...
    readonly indicator?: undefined | ChatTooltipContentIndicator.Type;
  ...
  const nestLabel = payload.length === 1 && !ChatTooltipContentIndicator.is.dot(indicator);
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  ChatTooltipContentIndicator.is.dot(indicator) && "items-center"
                )}
              >
                      ...
                      !hideIndicator && (
                        <div
                          className={cn("shrink-0 rounded-[2px] border-(--color-border) bg-(--color-bg)", {
                            "h-2.5 w-2.5": ChatTooltipContentIndicator.is.dot(indicator),
                            "w-1": ChatTooltipContentIndicator.is.line(indicator),
                            "w-0 border-[1.5px] border-dashed bg-transparent":
                              ChatTooltipContentIndicator.is.dot(indicator),
                            "my-0.5": nestLabel && ChatTooltipContentIndicator.is.dot(indicator),
                          })}
                          style={
                            {
