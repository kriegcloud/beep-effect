...
import { Calendar, Check, CreditCard, Shield } from "@phosphor-icons/react";
...
export function PaymentDetails({
  ...
  return (
    <>
      <div className={cn("relative w-full max-w-xl rounded-3xl p-6 shadow-sm", className)}>
        <div className="mb-6">
        ...
        <div className="border-border bg-card/50 mb-6 rounded-2xl border p-6">
          <h2 className="text-foreground mb-5 font-sans text-2xl font-semibold">Card Details</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                {errors.validTill && <p className="text-destructive mt-1 text-sm">{errors.validTill}</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                {errors.cvv && <p className="text-destructive mt-1 text-sm">{errors.cvv}</p>}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-border bg-card/50 mb-6 rounded-2xl border p-6">
          <h2 className="text-foreground mb-5 font-sans text-2xl font-semibold">Billing Details</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                />
                {errors.middleLastName && <p className="text-destructive mt-1 text-sm">{errors.middleLastName}</p>}
              </div>
            </div>
            ...
            <div>
              ...
              />
              {errors.billingAddress && <p className="text-destructive mt-1 text-sm">{errors.billingAddress}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                />
                {errors.contactNumber && <p className="text-destructive mt-1 text-sm">{errors.contactNumber}</p>}
              </div>
            </div>
          </div>
        </div>
