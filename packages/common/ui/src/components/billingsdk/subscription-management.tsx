...
} from "@beep/ui/components/billingsdk/cancel-subscription-dialog";
import { UpdatePlanDialog, type UpdatePlanDialogProps } from "@beep/ui/components/billingsdk/update-plan-dialog";
...
import type { CurrentPlan } from "@beep/ui/lib/billingsdk-config";
import { Calendar, CreditCard } from "@phosphor-icons/react";
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6 px-4 sm:space-y-8 sm:px-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <UpdatePlanDialog className="mx-0 shadow-lg transition-all duration-200 hover:shadow-xl" {...updatePlan} />
