...
import { FileText, Globe, Image, MusicNotes, Paperclip, Video, X } from "@phosphor-icons/react";
...
export type AttachmentData = (FileUIPart & { readonly id: string }) | (SourceDocumentUIPart & { readonly id: string });
...
export type AttachmentsProps = HTMLAttributes<HTMLDivElement> & {
  readonly variant?: undefined | AttachmentVariant;
};
...
export type AttachmentPreviewProps = HTMLAttributes<HTMLDivElement> & {
  readonly fallbackIcon?: undefined | ReactNode;
};
...
export const AttachmentPreview = ({ fallbackIcon, className, ...props }: AttachmentPreviewProps) => {
  ...
  const renderIcon = (Icon: typeof Image) => <Icon className={cn(iconSize, "text-muted-foreground")} />;
...
export type AttachmentInfoProps = HTMLAttributes<HTMLDivElement> & {
  readonly showMediaType?: undefined | boolean;
};
