 ...
 * triple term names.
 */
export class TripleTermName extends BS.StringLiteralKit("subject", "predicate", "object").annotations(
  $I.annotations("TripleTermName", {
...
export class QuadTermName extends BS.StringLiteralKit(...TripleTermName.Options, "graph").annotations(
  $I.annotations("QuadTermName", {
...
export class QueryOperationCostValue extends S.Struct(
  ...
  $I.annotations("QueryOperationCostValue", {
...
export class QueryOperationCost extends S.Class<QueryOperationCost>($I`QueryOperationCost`)(
  ...
  $I.annotations("QueryOperationCost", {
 ...
 */
export class QueryResultCardinalityType extends BS.StringLiteralKit("estimate", "exact").annotations(
  $I.annotations("QueryResultCardinalityType", {
...
export class QueryResultCardinalityEstimate extends S.Class<QueryResultCardinalityEstimate>(
  $I`QueryResultCardinalityEstimate`
)(
  makeQueryResultCardinalityKind.estimate({}),
  $I.annotations("QueryResultCardinalityEstimate", {
...
export class QueryResultCardinalityExact extends S.Class<QueryResultCardinalityExact>($I`QueryResultCardinalityExact`)(
  ...
  $I.annotations("QueryResultCardinalityExact", {
...
export class QueryResultCardinality extends S.Union(
  ...
  $I.annotations("QueryResultCardinality", {
    description:
      "QueryResultCardinality represents the number of results, which can either be an estimate or exact value.",
  })
) {}
...
export class CardinalityMetadataSupport extends S.Class<CardinalityMetadataSupport>($I`CardinalityMetadataSupport`)(
  ...
  $I.annotations("CardinalityMetadataSupport", {
...
export class OrderMetadataSupport extends S.Class<OrderMetadataSupport>($I`OrderMetadataSupport`)(
  ...
  $I.annotations("OrderMetadataSupport", {
    description: "indicates that the query result order is supported.",
  })
) {}

export class AvailableOrdersMetadataSupport extends S.Class<AvailableOrdersMetadataSupport>(
  $I`AvailableOrdersMetadataSupport`
)(
  {
    availableOrders: LiteralTrue,
  },
  $I.annotations("AvailableOrdersMetadataSupport", {
...
export class AllMetadataSupport extends S.Class<AllMetadataSupport>($I`AllMetadataSupport`)(
  ...
  $I.annotations("AllMetadataSupport", {
...
export class CardinalityMetadataOpts extends S.Class<CardinalityMetadataOpts>($I`CardinalityMetadataOpts`)(
  ...
  $I.annotations("CardinalityMetadataOpts", {
    description: 'indicates the type of counting that was done, and MUST either be "estimate" or "exact".',
  })
) {}
...
export class OrderMetadataOpts extends OrderMetadataSupport.extend<OrderMetadataOpts>($I`OrderMetadataOpts`)(
  {},
  $I.annotations("OrderMetadataOpts", {
    description: "options for the order of the query result.",
  })
) {}

export class AvailableOrdersMetadataOpts extends AvailableOrdersMetadataSupport.extend<AvailableOrdersMetadataOpts>(
  $I`AvailableOrdersMetadataOpts`
)(
  {},
  $I.annotations("AvailableOrdersMetadataOpts", {
    description: "options for the available orders of the query result.",
  })
) {}

export class LanguageDirection extends BS.StringLiteralKit("ltr", "rtl", "").annotations(
  $I.annotations("LanguageDirection", {
    description: "indicates the direction of the language.",
  })
) {}

export declare namespace LanguageDirection {
  export type Type = typeof LanguageDirection.Type;
}

export class LanguageOptions extends S.Class<LanguageOptions>($I`LanguageOptions`)(
  {
    language: S.String,
    direction: S.optionalWith(LanguageDirection, { as: "Option", nullable: true }),
  },
  $I.annotations("LanguageOptions", {
    description: "options for the language of the query result.",
  })
) {}
