/**
 * UUID utilities powering schema-v2 entity id builders.
 *
 ...
 *
 * @example
 * import { UUIDLiteral } from "@beep/schema-v2/identity/entity-id/uuid";
 ...
 *
 * @example
 * import { BrandedUUID } from "@beep/schema-v2/identity/entity-id/uuid";
 * import * as S from "effect/Schema";
 *
 ...
 * @since 0.1.0
 * @example
 * import { UUIDLiteralEncoded } from "@beep/schema-v2/identity/entity-id/uuid";
 *
 ...
 * @since 0.1.0
 * @example
 * import type { UUIDLiteralEncoded } from "@beep/schema-v2/identity/entity-id/uuid";
 *
 ...
 * @since 0.1.0
 * @example
 * import type { UUIDLiteral } from "@beep/schema-v2/identity/entity-id/uuid";
 *
