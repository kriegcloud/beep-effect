 ...
 * import * as EntityId from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 *
 * @example
 * import type { SchemaType } from "@beep/schema-v2/identity/entity-id/entity-id";
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 *
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import type { Type } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import type { Encoded } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import { Factory } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import type { PublicId } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 *
 * @example
 * import type { PrivateId } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import type { EntityIdSchemaInstance } from "@beep/schema-v2/identity/entity-id/entity-id";
 * import * as EntityId from "@beep/schema-v2/identity/entity-id/entity-id";
 ...
 * @example
 * import { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 * import { make } from "@beep/schema-v2/identity/entity-id/entity-id";
 *
...
export const make = <const TableName extends string, const Brand extends string>(
  ...
  invariant(S.is(SnakeTag)(tableName), "TableName must be a lowercase snake case string", {
    file: "@beep/schema-v2/identity/entity-id/entity-id.ts",
    line: 188,
    args: [tableName],
  });
