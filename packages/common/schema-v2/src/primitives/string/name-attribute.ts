 ...
 *
 * @example
 * import { NameAttribute } from "@beep/schema-v2/primitives/string/name-attribute";
 *
 ...
 *
 * @example
 * import type { NameAttribute } from "@beep/schema-v2/primitives/string/name-attribute";
 *
