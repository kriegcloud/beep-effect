 ...
 *
 * @example
 * import { CurrencyCode } from "@beep/schema-v2/primitives/string/currency-code";
 *
...
/**
 * ISO 4217 currency literal kit.
 *
 * Exposes Schema/Enum/Options for every supported code so vertical slices can reuse them consistently.
 *
 * @example
 * import { CurrencyCodeKit } from "@beep/schema-v2/primitives/string/currency-code";
 *
 * const codes = CurrencyCodeKit.Options;
 *
 * @category Primitives/String
 * @since 0.1.0
 */
...
export class CurrencyCode extends CurrencyCodeKit.Schema.annotations(
  ...
  /**
   * List of allowable currency code literals.
   *
   * @category Primitives/String
   * @since 0.1.0
   */
  ...
  /**
   * Enum keyed by normalized currency identifiers.
   *
   * @category Primitives/String
   * @since 0.1.0
   */
 ...
 *
 * @example
 * import type { CurrencyCode } from "@beep/schema-v2/primitives/string/currency-code";
 *
