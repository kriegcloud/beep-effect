 ...
 *
 * @example
 * import { SnakeTag, StringWithDefault } from "@beep/schema-v2/primitives/string/string";
 *
...
`,
  ...
  static override readonly make = <const Value extends string>(
    ...
    invariant(S.is(SnakeTag)(tag), "Must be a valid SnakeTag", {
      file: "@beep/schema-v2/primitives/string/string.ts",
      line: 41,
      args: [tag],
    });
    return tag;
 ...
 *
 * @example
 * import type { SnakeTag } from "@beep/schema-v2/primitives/string/string";
 *
 ...
 *
 * @example
 * import type { StringPropertyOmittable } from "@beep/schema-v2/primitives/string/string";
 *
 ...
 *
 * @example
 * import { StringWithDefault } from "@beep/schema-v2/primitives/string/string";
 *
 * const title = StringWithDefault("Untitled");
 *
 * @category Primitives/String
