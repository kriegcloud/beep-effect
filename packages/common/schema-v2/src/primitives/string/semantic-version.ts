 ...
 * import { SemanticVersion } from "@beep/schema-v2/primitives/string/semantic-version";
 *
 ...
 *
 * @example
 * import type { SemanticVersion } from "@beep/schema-v2/primitives/string/semantic-version";
 *
