 ...
 * import { USStateCode } from "@beep/schema-v2/primitives/geo/usstate";
 *
...
/**
 * Literal kit of US state and territory abbreviations.
 *
 * @example
 * import { USStateCodeKit } from "@beep/schema-v2/primitives/geo/usstate";
 *
 * USStateCodeKit.Options.includes("CA");
 *
 * @category Primitives/Network/Location
 * @since 0.1.0
 */
...
export class USStateCode extends USStateCodeKit.Schema.annotations(
  ...
  /** @category Primitives/Network/Location @since 0.1.0 */
 ...
 *
 * @example
 * import type { USStateCode } from "@beep/schema-v2/primitives/geo/usstate";
 *
...
/**
 * Literal kit of US state and territory names.
 *
 * @example
 * import { USStateNameKit } from "@beep/schema-v2/primitives/geo/usstate";
 *
 * const states = USStateNameKit.Options;
 *
 * @category Primitives/Network/Location
 * @since 0.1.0
 */
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { USStateName } from "@beep/schema-v2/primitives/geo/usstate";
 *
 ...
 *
 * @example
 * import type { USStateName } from "@beep/schema-v2/primitives/geo/usstate";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { USStateNameFromCode } from "@beep/schema-v2/primitives/geo/usstate";
 *
 ...
 *
 * @example
 * import type { USStateNameFromCode } from "@beep/schema-v2/primitives/geo/usstate";
 *
