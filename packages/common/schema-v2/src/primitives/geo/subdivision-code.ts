 ...
 * import { SubdivisionCode } from "@beep/schema-v2/primitives/geo/subdivision-code";
 *
 ...
 *
 * @example
 * import type { SubdivisionCode } from "@beep/schema-v2/primitives/geo/subdivision-code";
 *
