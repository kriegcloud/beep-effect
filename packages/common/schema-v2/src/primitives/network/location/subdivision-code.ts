 ...
 * import { SubdivisionCode } from "@beep/schema-v2/primitives/network/location/subdivision-code";
 *
 ...
 *
 * @example
 * import type { SubdivisionCode } from "@beep/schema-v2/primitives/network/location/subdivision-code";
 *
