 ...
 * import { StringOrNumberToNumber } from "@beep/schema-v2/primitives/number/number";
 *
 ...
 *
 * @example
 * import type { StringOrNumberToNumber } from "@beep/schema-v2/primitives/number/number";
 *
