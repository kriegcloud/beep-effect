 ...
 *
 * Useful for encoding blobs within schema-v2 use cases (file uploads, crypto payloads, etc.).
 *
 * @example
 * import * as S from "effect/Schema";
 * import { Uint8Arr } from "@beep/schema-v2/primitives/binary/uint8-array";
 *
 ...
 * @since 0.1.0
 */
import { Id } from "@beep/schema-v2/primitives/binary/_id";
import * as S from "effect/Schema";
 ...
 *
 * @example
 * import type { Uint8Arr } from "@beep/schema-v2/primitives/binary/uint8-array";
 *
