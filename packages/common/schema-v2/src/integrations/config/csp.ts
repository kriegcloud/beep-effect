 ...
 *
 * @example
 * import { Csp } from "@beep/schema-v2/integrations/config/csp";
 *
...
import { RegexFromString } from "@beep/schema-v2/internal/regex/regex";
 ...
 *
 * @example
 * import { POLICY_DELIMITER } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import { DEFAULT_VALUES } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import { CSPDirectiveKit } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import { CSPDirective } from "@beep/schema-v2/integrations/config/csp";
 * import * as S from "effect/Schema";
 *
 * const directive = S.decodeSync(CSPDirective)("script-src");
 *
 * @category Integrations/Config
 * @since 0.1.0
 */
 ...
 *
 * @example
 * import { CSPDirectivePart } from "@beep/schema-v2/integrations/config/csp";
 * import * as S from "effect/Schema";
 *
 ...
 *
 * @example
 * import type { CSPDirectivePart } from "@beep/schema-v2/integrations/config/csp";
 *
...
/**
 * Literal kit enumerating static directive values that do not require URL validation.
 *
 * @example
 * import { StaticDirectiveKit } from "@beep/schema-v2/integrations/config/csp";
 *
 * const values = StaticDirectiveKit.Options;
 *
 * @category Integrations/Config
 * @since 0.1.0
 */
...
const StaticDirectiveSchema = StaticDirectiveKit.Schema.annotations(
  Id.annotations("StaticDirectiveSchema", {
 ...
 *
 * @example
 * import { StaticDirective } from "@beep/schema-v2/integrations/config/csp";
 * import * as S from "effect/Schema";
 *
 * const value = S.decodeSync(StaticDirective)("'self'");
 *
 * @category Integrations/Config
 * @since 0.1.0
 */
 ...
 *
 * @example
 * import { CSPDirectiveValue } from "@beep/schema-v2/integrations/config/csp";
 * import * as S from "effect/Schema";
 *
 ...
 *
 * @example
 * import { CSPDirectiveValues } from "@beep/schema-v2/integrations/config/csp";
 * import * as S from "effect/Schema";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { CSPStruct } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import type { CSPStruct } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { CSPString } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { CSPFromString } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import type { CSPFromString } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import { toHeader } from "@beep/schema-v2/integrations/config/csp";
 *
 ...
 *
 * @example
 * import type { Csp } from "@beep/schema-v2/integrations/config/csp";
 *
