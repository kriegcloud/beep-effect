 ...
 * import { FormFieldSchema } from "@beep/schema-v2/builders/form/field";
 *
...
/**
 * Literal kit exposing JSON Schema type values used by the form builder.
 *
 * @example
 * import { FormFieldTypeKit } from "@beep/schema-v2/builders/form/field";
 *
 * const typeNames = FormFieldTypeKit.Options;
 *
 * @category Builders/Form
 * @since 0.1.0
 */
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { FormFieldType } from "@beep/schema-v2/builders/form/field";
 *
...
export class FormFieldType extends FormFieldTypeKit.Schema.annotations(
  ...
  /** @category Builders/Form @since 0.1.0 */
 ...
 *
 * @example
 * import type { FormFieldType } from "@beep/schema-v2/builders/form/field";
 *
 ...
 *
 * @example
 * import { FormFieldFormatKit } from "@beep/schema-v2/builders/form/field";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { FormFieldFormat } from "@beep/schema-v2/builders/form/field";
 *
 ...
 *
 * @example
 * import type { FormFieldFormat } from "@beep/schema-v2/builders/form/field";
 *
 ...
 *
 * @example
 * import type { FormFieldSchema } from "@beep/schema-v2/builders/form/field";
 *
