/**
 * JSON Schema builder that mirrors the legacy `@beep/schema/JsonSchema` module.
 *
 * Provides typed helpers for emitting JSON Schema definitions alongside the
 * Effect-first schema primitives that power schema-v2.
 *
 * @example
 * import { JsonSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(JsonSchema)({ type: "object" });
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 */

import { prop_regex } from "@beep/schema-v2/internal/regex/regexes";
import { LiteralDefaults } from "@beep/schema-v2/primitives/string/literal";
 ...
 * @since 0.1.0
 * @example
 * import { JsonProp } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 ...
 * @since 0.1.0
 * @example
 * import type { JsonProp } from "@beep/schema-v2/builders/json-schema";
 *
 ...
 * @since 0.1.0
 * @example
 * import { $JsonType } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
...
/**
 * Namespace describing literal union type for {@link $JsonType}.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import type { $JsonType } from "@beep/schema-v2/builders/json-schema";
 *
 * const accepts: $JsonType.Type = "string";
 */
 ...
 * @since 0.1.0
 * @example
 * import type { _JsonSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * const accepts: _JsonSchema.Type = { type: "string" };
 */
export declare namespace _JsonSchema {
  /**
   * Type alias describing boolean shortcuts or nested JSON Schema definitions.
   *
   * @example
   * import type { _JsonSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const branch: _JsonSchema.Type = false;
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * Union schema that toggles between boolean shortcuts and nested JSON Schema definitions.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { _JsonSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(_JsonSchema)({ type: "string" });
 */
...
/**
 * Namespace describing the JSON Schema document shape and encoded variants.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import type { JsonSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Schema = JsonSchema.Type;
 */
export declare namespace JsonSchema {
  /**
   * Runtime type describing JSON Schema documents.
   *
   * @example
   * import type { JsonSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: JsonSchema.Type = { type: "string" };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type describing JSON Schema documents.
   *
   * @example
   * import type { JsonSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const encoded: JsonSchema.Encoded = { type: "string" };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
const JsonSchemaStruct = ExtendedStruct(
  {
  ...
  Id.annotations("JsonSchema", {
    description: "Structured representation of JSON Schema documents with Effect-powered annotations.",
  })
);

/**
 * Core JSON Schema helper used throughout schema-v2 to emit JSON Schema definitions.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 ...
 * const schema = S.decodeSync(JsonSchema)({ type: "object" });
 */
export class JsonSchema extends JsonSchemaStruct {
  ...
  static readonly go = (schema: JsonSchema.Type) => {
    ...
    const allowedKeys = StructRecord.keys(JsonSchema.fields as UnsafeTypes.UnsafeAny);
    const schemaKeys = StructRecord.keys(schema as Record<string, unknown>);
    F.pipe(
      schemaKeys,
      A.forEach((key) => {
        const isAllowed = F.pipe(
          allowedKeys,
          A.some((allowed) => allowed === key)
        );
        if (!isAllowed) {
  ...
  static readonly maybeGoOnArray = (value: UnsafeTypes.UnsafeAny) => {
    if (A.isArray(value)) {
      const array = value as ReadonlyArray<JsonSchema.Type>;
      F.pipe(
        array,
        A.forEach((item) => {
          JsonSchema.go(item);
...
/**
 * JSON Schema helper specialized for object types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { ObjectSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(ObjectSchema)({ type: "object", properties: {} });
 */
export class ObjectSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("object")("object"),
}).annotations(
  Id.annotations("ObjectSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { ObjectSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = ObjectSchema.Type;
 */
export declare namespace ObjectSchema {
  /**
   * Runtime type alias constrained to object JSON Schema documents.
   *
   * @example
   * import type { ObjectSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: ObjectSchema.Type = { type: "object", properties: {} };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded representation for {@link ObjectSchema}.
   *
   * @example
   * import type { ObjectSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: ObjectSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for array types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { ArraySchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(ArraySchema)({ type: "array", items: { type: "string" } });
 */
export class ArraySchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("array")("array"),
}).annotations(
  Id.annotations("ArraySchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { ArraySchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = ArraySchema.Type;
 */
export declare namespace ArraySchema {
  /**
   * Runtime type alias constrained to array JSON Schemas.
   *
   * @example
   * import type { ArraySchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: ArraySchema.Type = { type: "array", items: { type: "string" } };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type alias for {@link ArraySchema}.
   *
   * @example
   * import type { ArraySchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: ArraySchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for string types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { StringSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(StringSchema)({ type: "string", minLength: 1 });
 */
export class StringSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("string")("string"),
}).annotations(
  Id.annotations("StringSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { StringSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = StringSchema.Type;
 */
export declare namespace StringSchema {
  /**
   * Runtime type alias constrained to string JSON Schemas.
   *
   * @example
   * import type { StringSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: StringSchema.Type = { type: "string", minLength: 1 };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded representation for {@link StringSchema}.
   *
   * @example
   * import type { StringSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: StringSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for number types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { NumberSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(NumberSchema)({ type: "number", maximum: 100 });
 */
export class NumberSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("number")("number"),
}).annotations(
  Id.annotations("NumberSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { NumberSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = NumberSchema.Type;
 */
export declare namespace NumberSchema {
  /**
   * Runtime type alias constrained to number JSON Schemas.
   *
   * @example
   * import type { NumberSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: NumberSchema.Type = { type: "number", maximum: 100 };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type alias for {@link NumberSchema}.
   *
   * @example
   * import type { NumberSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: NumberSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for integer types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { IntegerSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(IntegerSchema)({ type: "integer", minimum: 0 });
 */
export class IntegerSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("integer")("integer"),
}).annotations(
  Id.annotations("IntegerSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { IntegerSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = IntegerSchema.Type;
 */
export declare namespace IntegerSchema {
  /**
   * Runtime type alias constrained to integer JSON Schemas.
   *
   * @example
   * import type { IntegerSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: IntegerSchema.Type = { type: "integer", minimum: 0 };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type alias for {@link IntegerSchema}.
   *
   * @example
   * import type { IntegerSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: IntegerSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for boolean types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { BooleanSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(BooleanSchema)({ type: "boolean", description: "Feature flag" });
 */
export class BooleanSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("boolean")("boolean"),
}).annotations(
  Id.annotations("BooleanSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { BooleanSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = BooleanSchema.Type;
 */
export declare namespace BooleanSchema {
  /**
   * Runtime type alias constrained to boolean JSON Schemas.
   *
   * @example
   * import type { BooleanSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: BooleanSchema.Type = { type: "boolean" };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type alias for {@link BooleanSchema}.
   *
   * @example
   * import type { BooleanSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: BooleanSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
...
/**
 * JSON Schema helper specialized for null types.
 *
 * @category Builders/JsonSchema
 * @since 0.1.0
 * @example
 * import { NullSchema } from "@beep/schema-v2/builders/json-schema";
 * import * as S from "effect/Schema";
 *
 * const schema = S.decodeSync(NullSchema)({ type: "null" });
 */
export class NullSchema extends ExtendedStruct({
  ...JsonSchema.fields,
  type: LiteralDefaults("null")("null"),
}).annotations(
  Id.annotations("NullSchema", {
 ...
 * @since 0.1.0
 * @example
 * import type { NullSchema } from "@beep/schema-v2/builders/json-schema";
 *
 * type Value = NullSchema.Type;
 */
export declare namespace NullSchema {
  /**
   * Runtime type alias constrained to null JSON Schemas.
   *
   * @example
   * import type { NullSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: NullSchema.Type = { type: "null" };
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
  ...
  /**
   * Encoded type alias for {@link NullSchema}.
   *
   * @example
   * import type { NullSchema } from "@beep/schema-v2/builders/json-schema";
   *
   * const schema: NullSchema.Encoded = {};
   *
   * @category Builders/JsonSchema
   * @since 0.1.0
   */
