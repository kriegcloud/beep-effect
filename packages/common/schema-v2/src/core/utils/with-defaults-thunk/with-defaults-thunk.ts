 ...
 * @example
 * import * as S from "effect/Schema";
 * import type { Type } from "@beep/schema-v2/core/utils/with-defaults-thunk/with-defaults-thunk";
 *
 ...
 *
 * @example
 * import type { Maker } from "@beep/schema-v2/core/utils/with-defaults-thunk/with-defaults-thunk";
 *
 ...
 * @example
 * import * as S from "effect/Schema";
 * import { make } from "@beep/schema-v2/core/utils/with-defaults-thunk/with-defaults-thunk";
 *
