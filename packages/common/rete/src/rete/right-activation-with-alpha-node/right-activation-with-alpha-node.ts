import { type AlphaNode, type Fact, type Session, type Token, TokenKind } from "@beep/rete/rete";
...
const rightActivationWithAlphaNode = <T extends object>(session: Session<T>, node: AlphaNode<T>, token: Token<T>) => {
