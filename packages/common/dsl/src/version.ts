...
const _liveStoreVersion = "0.1.0" as const;
 ...
 *
 * Bump required when:
 * - Modifying eventlog system tables (eventlogMetaTable, syncStatusTable) in schema/state/pg/system-tables/eventlog-tables.ts
