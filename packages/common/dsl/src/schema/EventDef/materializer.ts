 ...
 * @example
 * ```ts
 * import { State } from '@beep/livestore'
 *
...
import type { SingleOrReadonlyArray } from "@beep/utils";
...
import type { QueryBuilder } from "../state/pg/query-builder/mod.ts";
...
export type Materializer<TEventDef extends EventDef.AnyWithoutFn = EventDef.AnyWithoutFn> = (
  ...
  context: {
    ...
    event: BeepEvent.Client.Decoded;
  }
