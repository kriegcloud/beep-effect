...
import { type Effect, type Exit, type Queue, Schema, type Scope, type SubscriptionRef } from "effect";
import type { WebChannel } from "@beep/utils/effect/WebChannel";
...
import type { PgDb } from "./pg-types.ts";
 ...
 * ```
 */
export const SessionIdSymbol = Symbol.for("@beep/session-id");
...
export type MigrationHook = (db: PgDb) => void | Promise<void> | Effect.Effect<void, unknown>;
...
export interface AdapterArgs {
  ...
  syncPayloadEncoded: BS.Json.Type | undefined;
}
