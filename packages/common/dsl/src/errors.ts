...
export class PgError extends Schema.TaggedError<PgError>()("LiveStore.PgError", {
...
export class UnknownEventError extends Schema.TaggedError<UnknownEventError>()("LiveStore.UnknownEventError", {
  event: BeepEvent.Client.Encoded.pipe(Schema.pick("name", "args", "seqNum", "clientId", "sessionId")),
...
export class MaterializeError extends Schema.TaggedError<MaterializeError>()("LiveStore.MaterializeError", {
  cause: Schema.Union(MaterializerHashMismatchError, PgError, UnknownEventError),
  note: Schema.optional(Schema.String),
}) {}
