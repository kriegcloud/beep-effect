...
import { SerializedEditorStateEnvelope, TextStyle } from "../../values";

const $I = $WorkspacesDomainId.create("entities/Document/Document.model");

export class Model extends M.Class<Model>($I`DocumentModel`)(
  makeFields(WorkspacesEntityIds.DocumentId, {
    organizationId: SharedEntityIds.OrganizationId,
    userId: SharedEntityIds.UserId,
    templateId: BS.FieldOptionOmittable(S.String),
    parentDocumentId: BS.FieldOptionOmittable(WorkspacesEntityIds.DocumentId),
