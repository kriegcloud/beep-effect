...
const $I = $WorkspacesDomainId.create("entities/Page/contracts/Get.contract");
 ...
 * @category errors
 */
export const Failure = S.Union(PageErrors.PageNotFound, PageErrors.PagePermissionDenied);
