 ...
 *
 * @module documents-domain/entities/Page/contracts/Lock.contract
 * @since 1.0.0
 * @category contracts
 */
...
const $I = $WorkspacesDomainId.create("entities/Page/contracts/Lock.contract");

/**
 * Input payload for `Page.Lock`.
 *
 * @since 1.0.0
 * @category models
 */
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for the Lock Page contract.",
  })
) {}

/**
 * Success response for `Page.Lock`.
 *
 * @since 1.0.0
 * @category DTO
 */
export class Success extends S.Class<Success>($I`Success`)(
  ...
  $I.annotations("Success", {
    description: "Success response for the Lock Page contract.",
  })
) {}

/**
 * Failure response for `Page.Lock`.
 *
 * @since 1.0.0
 * @category errors
 */
...
/**
 * Tagged request contract for `Page.Lock`.
 *
 * @since 1.0.0
 * @category contracts
 */
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", {
    description: "Lock Page Request Contract.",
  })
) {
  /**
   ...
   * @category http
   */
  static readonly Http = HttpApiEndpoint.post("Lock", "/:id/lock")
    .setPayload(Payload)
