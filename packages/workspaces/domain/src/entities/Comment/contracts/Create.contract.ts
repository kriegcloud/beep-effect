 ...
 *
 * @module @beep/workspaces-domain/entities/Comment/contracts/Create.contract
 * @since 1.0.0
 * @category contracts
 */
...
const $I = $WorkspacesDomainId.create("entities/Comment/contracts/Create.contract");
 ...
 * @category errors
 */
export const Failure = S.Union(CommentErrors.CommentTooLongError, CommentErrors.CommentPermissionDeniedError);
