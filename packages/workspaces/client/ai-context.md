---
path: packages/workspaces/client
...
import { DocumentsClient } from "@beep/workspaces-client";
...
**Internal**: (planned) `@beep/workspaces-domain`, `@beep/schema`
...
- **@beep/workspaces-domain** - Domain schemas for type-safe contracts
- **@beep/workspaces-server** - Server handlers this client will consume
