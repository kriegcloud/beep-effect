...
**Internal**: (planned) `@beep/workspaces-domain`, `@beep/workspaces-client`, `@beep/ui`, `@beep/ui-core`
...
- **@beep/workspaces-domain** - Domain schemas for validation
- **@beep/workspaces-client** - Data fetching client
