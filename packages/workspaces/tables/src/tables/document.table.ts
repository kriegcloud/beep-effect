...
export const document = OrgTable.make(WorkspacesEntityIds.DocumentId)(
  {
    userId: pg
      .text("user_id")
      .notNull()
    ...
    parentDocumentId: pg.text("parent_document_id").$type<WorkspacesEntityIds.DocumentId.Type>(),
    title: pg.text("title"),
