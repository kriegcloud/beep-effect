...
/**
 * Workspace-first aliases backed by existing relation definitions.
 */
export const workspaceCommentRelations = commentRelations;
export const workspaceDiscussionRelations = discussionRelations;
export const workspaceFileRelations = documentFileRelations;
export const workspacePageRelations = documentRelations;
export const workspaceSnapshotRelations = documentVersionRelations;
export const workspaceSourceLinkRelations = documentSourceRelations;
export const workspaceRelations = pageRelations;
