...
import { layer as reposLayer } from "@beep/knowledge-management-infra/adapters/repositories";
import { Api, KnowledgePageRouterLive } from "@beep/knowledge-management-infra/routes";
...
const ScalarLayer = HttpApiScalar.layer({
  path: "/api/v1/knowledge-management/docs",
});
...
export const KnowledgeManagementApiHandlers = F.constant(toNextHandlers(handler));
