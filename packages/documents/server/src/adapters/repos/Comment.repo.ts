...
import { dependencies } from "@beep/documents-server/adapters/repos/_common";
...
export class CommentRepo extends Effect.Service<CommentRepo>()("@beep/documents-server/adapters/repos/CommentRepo", {
  dependencies,
  accessors: true,
