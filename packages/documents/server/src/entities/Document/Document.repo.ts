...
const serviceEffect = Effect.gen(function* () {
  ...
  const baseRepo = yield* DbRepo.make(DocumentsEntityIds.DocumentId, Document.Model);
  ...
  return {
    ...
    unlock,
    hardDelete,
  } as unknown as Entities.Document.RepoShape;
});

export const RepoLive: Layer.Layer<Entities.Document.Repo, never, DbClient.SliceDbRequirements> = Layer.effect(
