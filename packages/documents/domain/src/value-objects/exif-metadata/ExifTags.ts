...
const NumberFileTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/NumberFileTag"),
...
const NumberArrayFileTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/NumberArrayFileTag"),
...
const NumberArray2DFileTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/NumberArray2DFileTag"),
...
const RationalTag = makeTypedTag(S.Tuple(S.Number, S.Number)).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/RationalTag"),
...
const NumberTag = makeTypedTag(S.Number).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/NumberTag"),
...
const NumberArrayTag = makeTypedTag(S.Array(S.Number)).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/NumberArrayTag"),
...
const StringArrayTag = makeTypedTag(S.Array(S.String)).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/StringArrayTag"),
...
const StringTag = makeTypedTag(S.String).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/StringTag"),
...
const ValueTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/ValueTag"),
  identifier: "ValueTag",
  title: "Value Tag",
...
const FileTypeTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/FileTypeTag"),
...
const FileTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/FileTags"),
  identifier: "FileTags",
  title: "File Tags",
...
const JfifResolutionUnitTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/JfifResolutionUnitTag"),
...
const JfifThumbnailTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/JfifThumbnailTag"),
...
const JfifTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/JfifTags"),
  identifier: "JfifTags",
  title: "JFIF Tags",
...
const PngFileTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngFileTags"),
...
const PngPhysTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngPhysTags"),
...
const PngTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngTag"),
  identifier: "PngTag",
  title: "PNG Tag",
...
const PngTags = S.Struct(
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngTags"),
  identifier: "PngTags",
  title: "PNG Tags",
...
const PngTextTag = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngTextTag"),
...
const PngTextTags = S.Record({ key: S.String, value: PngTextTag }).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PngTextTags"),
...
const RiffTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/RiffTags"),
  identifier: "RiffTags",
...
const GifTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/GifTags"),
  identifier: "GifTags",
  title: "GIF Tags",
...
const XmpTags = S.Record({ key: S.String, value: XmpTag }).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/XmpTags"),
  identifier: "XmpTags",
  title: "XMP Tags",
...
const GpsTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/GpsTags"),
  identifier: "GpsTags",
  title: "GPS Tags",
...
const MPFImageTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/MPFImageTags"),
...
const PhotoshopTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PhotoshopTags"),
...
const CanonTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/CanonTags"),
...
const PentaxTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/PentaxTags"),
...
const CompositeTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/CompositeTags"),
...
const ThumbnailTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/ThumbnailTags"),
...
const IccTags = S.Record({ key: S.String, value: ValueTag }).annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/IccTags"),
  identifier: "IccTags",
...
export const ExpandedTags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/ExpandedTags"),
...
export const Tags = S.Struct({
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/exif-metadata/ExifTags/Tags"),
  identifier: "Tags",
  title: "Combined Tags",
