...
export class FileInfo extends S.Class<FileInfo>("FileInfo")(
  ...
  {
    schemaId: Symbol.for("@beep/documents-domain/value-objects/file-types/FileInfo"),
    identifier: "FileInfo",
    title: "File Info",
...
export class DetectedFileInfo extends S.Class<DetectedFileInfo>("DetectedFileInfo")(
  ...
  {
    schemaId: Symbol.for("@beep/documents-domain/value-objects/file-types/DetectedFileInfo"),
