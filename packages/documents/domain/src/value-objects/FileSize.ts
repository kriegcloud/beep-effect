...
export class ByteUnit extends BS.StringLiteralKit("B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB").annotations({
  schemaId: Symbol.for("@beep/documents-domain/value-objects/ByteUnit"),
  identifier: "ByteUnit",
...
export class BiByteUnit extends BS.StringLiteralKit(
  "B",
  "KiB",
  "MiB",
  "GiB",
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/BiByteUnit"),
...
export class BitUnit extends BS.StringLiteralKit(
  "b",
  "kbit",
  "Mbit",
  "Gbit",
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/BitUnit"),
  identifier: "BitUnit",
...
export class BiBitUnit extends BS.StringLiteralKit(
  "b",
  "kibit",
  "Mibit",
  "Gibit",
  ...
  schemaId: Symbol.for("@beep/documents-domain/value-objects/BiBitUnit"),
