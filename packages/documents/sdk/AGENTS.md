...
- Once HTTP API implementation is complete in `@beep/documents-infra`, this package will expose client-side wrappers.
...
export class DocumentsClient extends Effect.Service<DocumentsClient>()("@beep/documents-sdk/DocumentsClient", {
