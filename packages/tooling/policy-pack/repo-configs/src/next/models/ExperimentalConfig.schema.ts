...
const PrefetchInlining = S.Union([
  S.Boolean,
  S.Struct({
 ...
 * @since 0.0.0
 */
export const ExperimentalConfig = S.Struct({
  ...
  $I.annoteSchema("ExperimentalConfig", {
 ...
 * @example
 * ```ts
 * import type { ExperimentalConfig } from "@beep/repo-configs/next/models/ExperimentalConfig.schema"
 *
 * const config: ExperimentalConfig = { cssChunking: "strict" }
 * void config
 * ```
 *
 * @category models
 * @since 0.0.0
 */
export type ExperimentalConfig = typeof ExperimentalConfig.Type;
