...
type FormOptionsWithSubmitEffect = <
  const A,
  const I extends Record<PropertyKey, UnsafeTypes.UnsafeAny>
>(
  params: Params<A, I>) => ReturnType<typeof makeFormOptions<A, I, "onSubmit">>

export const formOptionsWithSubmitEffect: FormOptionsWithSubmitEffect = <const A, const I extends Record<PropertyKey, UnsafeTypes.UnsafeAny>>(
  {
    schema,
    onSubmit,
    defaultValues,
