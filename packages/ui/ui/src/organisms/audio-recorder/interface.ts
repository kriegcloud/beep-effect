import type { MediaAudioTrackConstraints, recorderControls } from "./use-audio-recorder.ts";

export interface StyleProps {
  /**
   * Applies passed classes to audio recorder container
   **/
  readonly AudioRecorderClass?: undefined | string;
  /**
   * Applies passed classes to audio recorder start/save option
   **/
  readonly AudioRecorderStartSaveClass?: undefined | string;
  /**
   * Applies passed classes to audio recorder timer
   **/
  readonly AudioRecorderTimerClass?: undefined | string;
  /**
   * Applies passed classes to audio recorder status option
   **/
  readonly AudioRecorderStatusClass?: undefined | string;
  /**
   * Applies passed classes to audio recorder pause/resume option
   **/
  readonly AudioRecorderPauseResumeClass?: undefined | string;
  /**
   * Applies passed classes to audio recorder discard option
   **/
  readonly AudioRecorderDiscardClass?: undefined | string;
}
...
export interface Props {
   ...
   **/
  readonly onRecordingComplete?: undefined | ((blob: Blob) => void);
  /**
   * This gets called when the getUserMedia Promise is rejected.
   * It takes the resultant DOMException as its parameter.
   **/
  readonly onNotAllowedOrFound?: undefined | ((exception: DOMException) => any);
  /**
   ...
   **/
  readonly recorderControls?: recorderControls;
  /**
   ...
   * @Property `sampleSize`
   */
  readonly audioTrackConstraints?: undefined | MediaAudioTrackConstraints;
  /**
   * If set to `true` the file gets downloaded when save recording is pressed
   **/
  readonly downloadOnSavePress?: undefined | boolean;
  /**
   * File extension for the audio filed that gets downloaded
   **/
  readonly downloadFileExtension?: "mp3" | "wav" | "webm";
  /**
   * Displays a waveform visualization for the audio when set to `true`. Defaults to `false`
   **/
  readonly showVisualizer?: undefined | boolean;
  /**
   * The options passed to the HTML MediaRecorder API.
   **/
  readonly mediaRecorderOptions?: undefined | MediaRecorderOptions;
  /**
   * Custom classes to changes styles.
   **/
  readonly classes?: undefined | StyleProps;
}
