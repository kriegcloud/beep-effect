...
export type IBorderLocation = BorderLocation.Type;
...
export type ITabLocation = TabLocation.Type;

export type IJsonRect = JsonRect;

export type IJsonPopout = JsonPopout;

export type IJsonBorderNode = JsonBorderNode;

export type IJsonRowNode = JsonRowNode;

export type IJsonTabSetNode = JsonTabSetNode;

export type IJsonTabNode = JsonTabNode;
...
export type IRowAttributes = RowAttributes;
export type ITabSetAttributes = TabSetAttributes;
export type ITabAttributes = TabAttributes;
...
export interface IJsonModel {
  global?: undefined | IGlobalAttributes;
  borders?: undefined | IJsonBorderNode[];
  ...
  popouts?: undefined | Record<string, IJsonPopout>;
}
