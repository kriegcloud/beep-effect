...
// ============================================================================
// IActions Schema Class (Effect Schema version)
// ============================================================================

const $I = $UiId.create("flexlayout-react/model/Actions");

/**
 * The Action creator class for FlexLayout model actions (Effect Schema version)
 *
 * This class mirrors the Actions class but uses Effect Schema for type-safe serialization.
 * Since Actions has no instance state (only static members), this uses a minimal empty schema.
 */
export class IActions extends S.Class<IActions>($I`IActions`)({}) {
  // Static action type constants
  static ADD_NODE = "FlexLayout_AddNode";
  static MOVE_NODE = "FlexLayout_MoveNode";
  static DELETE_TAB = "FlexLayout_DeleteTab";
  static DELETE_TABSET = "FlexLayout_DeleteTabset";
  ...
  static addNode(
    ...
    return Action.new(IActions.ADD_NODE, {
      json,
      toNode: toNodeId,
      location: location.getName(),
      index,
  ...
  static moveNode(
    ...
    return Action.new(IActions.MOVE_NODE, {
      fromNode: fromNodeId,
      toNode: toNodeId,
      location: location.getName(),
      index,
   ...
   */
  static deleteTab(tabNodeId: string): Action {
    return Action.new(IActions.DELETE_TAB, { node: tabNodeId });
  }
   ...
   */
  static deleteTabset(tabsetNodeId: string): Action {
    return Action.new(IActions.DELETE_TABSET, { node: tabsetNodeId });
  }
   ...
   */
  static renameTab(tabNodeId: string, text: string): Action {
    return Action.new(IActions.RENAME_TAB, { node: tabNodeId, text });
  }
   ...
   */
  static selectTab(tabNodeId: string): Action {
    return Action.new(IActions.SELECT_TAB, { tabNode: tabNodeId });
  }
   ...
   */
  static setActiveTabset(tabsetNodeId: string | undefined, windowId?: string | undefined): Action {
    return Action.new(IActions.SET_ACTIVE_TABSET, { tabsetNode: tabsetNodeId, windowId: windowId });
  }
   ...
   */
  static adjustWeights(nodeId: string, weights: number[]): Action {
    return Action.new(IActions.ADJUST_WEIGHTS, { nodeId, weights });
  }

  static adjustBorderSplit(nodeId: string, pos: number): Action {
    return Action.new(IActions.ADJUST_BORDER_SPLIT, { node: nodeId, pos });
  }
   ...
   */
  static maximizeToggle(tabsetNodeId: string, windowId?: string | undefined): Action {
    return Action.new(IActions.MAXIMIZE_TOGGLE, { node: tabsetNodeId, windowId: windowId });
  }
   ...
   */
  static updateModelAttributes(attributes: Partial<IGlobalAttributes>): Action {
    return Action.new(IActions.UPDATE_MODEL_ATTRIBUTES, { json: attributes });
  }
  ...
  static updateNodeAttributes(
    ...
    return Action.new(IActions.UPDATE_NODE_ATTRIBUTES, { node: nodeId, json: attributes });
  }
   ...
   */
  static popoutTab(nodeId: string): Action {
    return Action.new(IActions.POPOUT_TAB, { node: nodeId });
  }
   ...
   */
  static popoutTabset(nodeId: string): Action {
    return Action.new(IActions.POPOUT_TABSET, { node: nodeId });
  }
   ...
   */
  static closeWindow(windowId: string): Action {
    return Action.new(IActions.CLOSE_WINDOW, { windowId });
  }
   ...
   */
  static createWindow(layout: JsonRowNode, rect: JsonRect): Action {
    return Action.new(IActions.CREATE_WINDOW, { layout, rect });
  }
}
