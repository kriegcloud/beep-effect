      ...
      if (popoutWindow.current) {
        ...
        popoutWindow.current.addEventListener("load", () => {
          if (popoutWindow.current) {
            ...
            const observer = new MutationObserver((mutationsList: UnsafeTypes.UnsafeAny) =>
              handleStyleMutations(mutationsList, popoutDocument, styleMap)
            );
...
function handleStyleMutations(
  mutationsList: UnsafeTypes.UnsafeAny,
