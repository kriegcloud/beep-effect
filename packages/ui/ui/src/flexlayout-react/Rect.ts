...
import type { IJsonRect } from "./model/IJsonModel";
...
export class Rect {
  ...
  positionElement(element: HTMLElement, position?: undefined | string) {
    this.styleWithPosition(element.style, position);
  }

  styleWithPosition(style: Record<string, UnsafeTypes.UnsafeAny>, position = "absolute") {
