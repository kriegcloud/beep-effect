...
import { $createImageNode, $isImageNode, type IImagePayload, ImageNode } from "../../nodes/Image/ImageNode";
...
export const ImagesPlugin = ({ captionsEnabled }: { captionsEnabled?: undefined | boolean }): JSX.Element | null => {
...
declare global {
  interface DragEvent {
    rangeOffset?: undefined | number;
    rangeParent?: undefined | Node;
  }
}
