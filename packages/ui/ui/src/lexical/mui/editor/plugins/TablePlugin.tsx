...
export type InsertTableCommandPayload = Readonly<{
  ...
  readonly includeHeaders?: undefined | boolean;
}>;

export interface ICellContextShape {
...
export type CellEditorConfig = Readonly<{
  ...
  readonly nodes?: undefined | ReadonlyArray<Klass<LexicalNode>>;
  readonly onError: (error: Error, editor: LexicalEditor) => void;
  readonly readOnly?: undefined | boolean;
  readonly theme?: undefined | EditorThemeClasses;
}>;

export const CellContext = createContext<ICellContextShape>({
...
export function TableContext({ children }: { readonly children: JSX.Element }) {
