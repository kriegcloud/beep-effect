...
export interface BillingScreenProps {
  readonly className?: undefined | string;
  // Plan details
  readonly planName?: undefined | string;
  readonly planPrice?: undefined | string;
  readonly renewalDate?: undefined | string;
  // Credit details
  readonly totalBalance?: undefined | string;
  readonly username?: undefined | string;
  readonly giftedCredits?: undefined | string;
  readonly monthlyCredits?: undefined | string;
  readonly monthlyCreditsLimit?: undefined | string;
  readonly purchasedCredits?: undefined | string;
  // Settings
          ...
          <div className="border-border overflow-hidden rounded-xl border">
            ...
            <div className="border-border border-b p-6">
              <p className="text-muted-foreground text-sm">
                Your monthly credits reset in <span className="text-foreground font-semibold">{resetDays} days</span>.
                Credits are used in the following order: gifted, monthly, purchased.
              </p>
            </div>
