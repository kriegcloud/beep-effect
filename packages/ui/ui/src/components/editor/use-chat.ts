...
export declare namespace ToolName {
  export type Type = typeof ToolName.Type;
  export type Encoded = typeof ToolName.Encoded;
}
...
export type MessageDataPart = {
  readonly toolName: ToolName.Type;
...
const fakeStreamText = ({
  ...
  readonly chunkCount?: undefined | number;
  readonly sample?: undefined | "comment" | "markdown" | "mdx" | null;
  ...
  return new ReadableStream({
    async start(controller) {
      const blocks = (() => {
        ...
        if (sample === "comment") {
          return createCommentChunks(editor);
        }
