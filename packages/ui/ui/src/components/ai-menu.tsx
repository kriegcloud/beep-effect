...
import { Popover, PopoverAnchor, PopoverContent } from "@beep/ui/components/popover";
...
Start writing a new paragraph AFTER <Document> ONLY ONE SENTENCE`
  ...
  string,
  {
    ...
    readonly component?: undefined | React.ComponentType<{ menuState: EditorChatState }>;
    readonly filterItems?: undefined | boolean;
    readonly items?: undefined | { label: string; value: string }[];
    readonly shortcut?: undefined | string;
    readonly onSelect?:
      | undefined
      | (({ aiEditor, editor, input }: { aiEditor: SlateEditor; editor: PlateEditor; input: string }) => void);
  }
>;
...
export const AIMenuItems = ({
  ...
  React.useEffect(() => {
    ...
    if (menuGroups.length > 0 && firstGroup && firstItem) {
