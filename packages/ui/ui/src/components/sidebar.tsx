...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@beep/ui/components/sheet";
...
import { useIsMobile } from "@beep/ui/hooks/use-mobile";
...
function SidebarGroupLabel({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<"div"> & { readonly asChild?: undefined | boolean }) {
...
function SidebarGroupAction({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<"button"> & { readonly asChild?: undefined | boolean }) {
...
function SidebarMenuButton({
  ...
  readonly tooltip?: undefined | string | React.ComponentProps<typeof TooltipContent>;
