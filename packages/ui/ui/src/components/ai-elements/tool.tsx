...
import { CaretDownIcon, CheckCircleIcon, CircleIcon, ClockIcon, WrenchIcon, XCircleIcon } from "@phosphor-icons/react";
...
export type ToolHeaderProps = {
  ...
  | { readonly type: ToolUIPart["type"]; readonly state: ToolUIPart["state"]; readonly toolName?: undefined | never }
  | {
      readonly type: DynamicToolUIPart["type"];
...
export type ToolOutputProps = ComponentProps<"div"> & {
  readonly output: ToolPart["output"];
  readonly errorText: ToolPart["errorText"];
};
