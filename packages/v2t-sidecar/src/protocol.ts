...
const $I = $RootId.create("V2T/protocol");
 ...
 */
export const Vt2ControlPlaneResourceError = S.Union([
  SidecarBadRequest,
  SidecarNotFound,
  SidecarInternalError,
]).annotate(
...
class SessionsGroup extends HttpApiGroup.make("sessions", { topLevel: true })
  ...
  .add(
    HttpApiEndpoint.post("retryTranscript", "/sessions/:sessionId/transcript/retry", {
      params: Vt2SessionIdParams,
      success: Vt2SessionResource,
      error: Vt2ControlPlaneResourceError,
    })
