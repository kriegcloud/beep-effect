...
const $I = $RootId.create("V2T/domain");
...
/**
 * Transcript runtime health surfaced to the workspace shell.
 *
 * @since 0.0.0
 * @category DomainModel
 */
export const Vt2TranscriptRuntimeStatus = LiteralKit(["ready", "degraded"]).annotate(
  $I.annote("Vt2TranscriptRuntimeStatus", {
    description: "Runtime health for the local transcript provider seam.",
  })
);
/**
 * @since 0.0.0
 * @category DomainModel
 */
export type Vt2TranscriptRuntimeStatus = typeof Vt2TranscriptRuntimeStatus.Type;

/**
 * Command source used for the local transcript runtime.
 *
 * @since 0.0.0
 * @category DomainModel
 */
export const Vt2TranscriptRuntimeCommandSource = LiteralKit(["configured", "bundled", "system"]).annotate(
  $I.annote("Vt2TranscriptRuntimeCommandSource", {
    description: "Source used to resolve the Python command for the local transcript runtime.",
  })
);
/**
 * @since 0.0.0
 * @category DomainModel
 */
export type Vt2TranscriptRuntimeCommandSource = typeof Vt2TranscriptRuntimeCommandSource.Type;

/**
 * Transcript runtime detail surfaced to the workspace shell.
 *
 * @since 0.0.0
 * @category DomainModel
 */
export class Vt2TranscriptRuntime extends S.Class<Vt2TranscriptRuntime>($I`Vt2TranscriptRuntime`)(
  {
    status: Vt2TranscriptRuntimeStatus,
    providerMode: Vt2ProviderExecutionMode,
    commandSource: Vt2TranscriptRuntimeCommandSource,
    resolvedCommand: NonEmptyTrimmedStr,
    whisperModel: NonEmptyTrimmedStr,
    detail: NonEmptyTrimmedStr,
  },
  $I.annote("Vt2TranscriptRuntime", {
    description: "Resolved runtime detail for the local transcript provider seam.",
  })
) {}
...
export class Vt2Transcript extends S.Class<Vt2Transcript>($I`Vt2Transcript`)(
  {
    ...
    text: S.OptionFromOptionalKey(NonEmptyTrimmedStr),
    ...
    failureReason: S.OptionFromOptionalKey(NonEmptyTrimmedStr),
  },
...
export class Vt2WorkspaceSnapshot extends S.Class<Vt2WorkspaceSnapshot>($I`Vt2WorkspaceSnapshot`)(
  {
    ...
    transcriptRuntime: Vt2TranscriptRuntime,
