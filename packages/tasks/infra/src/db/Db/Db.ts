...
import * as TasksDbSchema from "@beep/tasks-tables/schema";
...
export class TasksDb extends Context.Tag("@beep/tasks-infra/TasksDb")<TasksDb, Db.Db<typeof TasksDbSchema>>() {
