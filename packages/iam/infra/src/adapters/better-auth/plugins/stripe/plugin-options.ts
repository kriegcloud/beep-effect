import type { AuthPluginSchema, GenericEndpointContext, InferOptionSchema, Session, User } from "better-auth";
...
export interface StripeOptions {
  ...
  subscription?: {
     ...
     * @returns
     */
    onSubscriptionUpdate?: (data: { event: Stripe.Event; subscription: Subscription }) => Promise<void>;
    /**
     * A callback to run after a user is about to cancel their subscription
     * @returns
     */
