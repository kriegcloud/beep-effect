import { parseJSON } from "@beep/iam-infra/adapters/better-auth/internal";
import type { AuthPluginSchema, GenericEndpointContext, InferOptionSchema } from "better-auth";
