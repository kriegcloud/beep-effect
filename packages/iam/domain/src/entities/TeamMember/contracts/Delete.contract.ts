...
const $I = $IamDomainId.create("entities/TeamMember/contracts/Delete.contract");

export class Payload extends S.Class<Payload>($I`Payload`)(
  { id: IamEntityIds.TeamMemberId },
  $I.annotations("Payload", { description: "Payload for the Delete TeamMember contract." })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", { description: "Delete TeamMember Request Contract." })
) {
  ...
  static readonly Http = HttpApiEndpoint.del("Delete", "/:id")
    ...
    .addError(TeamMemberErrors.TeamMemberPermissionDeniedError)
