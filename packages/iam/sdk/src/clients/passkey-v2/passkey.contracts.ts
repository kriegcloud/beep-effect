...
export class PasskeyRemovePayload extends BS.Class<PasskeyRemovePayload>("PasskeyRemovePayload")(
  {
    passkey: PasskeyView,
  },
  {
...
export const PasskeyRemoveContract = Contract.make("PasskeyRemove", {
