  ...
  "@beep/iam-sdk/clients/passkey-v2/PasskeyService",
  {
    ...
    effect: Effect.gen(function* () {
      ...
      return {
        ...
        add: (payload: typeof PasskeyAddContract.payloadSchema.Type) => Effect.gen(function* () {
        ...
        remove: (payload: typeof PasskeyRemoveContract.payloadSchema.Type) => Effect.gen(function* () {
        ...
        update: (payload: typeof PasskeyUpdateContract.payloadSchema.Type) => Effect.gen(function* () {
