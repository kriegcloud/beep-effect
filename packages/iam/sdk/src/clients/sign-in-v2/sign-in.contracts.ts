...
export namespace SignInEmailPayload {
  export type Type = typeof SignInEmailPayload.Type;
  export type Encoded = typeof SignInEmailPayload.Encoded;
}
...
export namespace SignInSocialPayload {
  export type Type = typeof SignInSocialPayload.Type;
  export type Encoded = typeof SignInSocialPayload.Encoded;
}
...
export namespace SignInUsernamePayload {
  export type Type = typeof SignInUsernamePayload.Type;
  export type Encoded = typeof SignInUsernamePayload.Encoded;
}
...
export namespace SignInPhoneNumberPayload {
  export type Type = typeof SignInPhoneNumberPayload.Type;
  export type Encoded = typeof SignInPhoneNumberPayload.Encoded;
}
...
export namespace SignInPasskeyPayload {
  export type Type = typeof SignInPasskeyPayload.Type;
  export type Encoded = typeof SignInPasskeyPayload.Encoded;
}
...
export declare namespace SignInOneTapPayload {
  export type Type = typeof SignInOneTapPayload.Type;
  export type Encoded = typeof SignInOneTapPayload.Encoded;
}
