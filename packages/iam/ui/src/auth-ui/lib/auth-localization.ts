import { ADMIN_ERROR_CODES } from "@beep/iam-domain/errors/admin.errors";
import { ANONYMOUS_ERROR_CODES } from "@beep/iam-domain/errors/anonymous.errors";
import { API_KEY_ERROR_CODES } from "@beep/iam-domain/errors/api-key.errors";
import { CAPTCHA_ERROR_CODES } from "@beep/iam-domain/errors/captcha.errors";
import { BASE_ERROR_CODES } from "@beep/iam-domain/errors/core.errors";
import { EMAIL_OTP_ERROR_CODES } from "@beep/iam-domain/errors/email-otp.errors";
import { GENERIC_OAUTH_ERROR_CODES } from "@beep/iam-domain/errors/generic-oauth.errors";
import { HAVEIBEENPWNED_ERROR_CODES } from "@beep/iam-domain/errors/haveibeenpwned.errors";
import { MULTI_SESSION_ERROR_CODES } from "@beep/iam-domain/errors/multi-session.errors";
import { ORGANIZATION_ERROR_CODES } from "@beep/iam-domain/errors/organization.errors";
import { PASSKEY_ERROR_CODES } from "@beep/iam-domain/errors/passkey.errors";
import { PHONE_NUMBER_ERROR_CODES } from "@beep/iam-domain/errors/phone-number.errors";
import { SUBSCRIPTION_ERROR_CODES } from "@beep/iam-domain/errors/subscription.errors";
import { TWO_FACTOR_ERROR_CODES } from "@beep/iam-domain/errors/two-factor.errors";
import { USERNAME_ERROR_CODES } from "@beep/iam-domain/errors/username.errors";
