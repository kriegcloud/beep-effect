      ...
      <Tailwind>
        <Body className={cn("mx-auto my-auto px-2 font-sans", classNames?.body)}>
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-color border-solid p-[20px]">
            ...
            <Heading className={cn("mx-0 my-[30px] p-0 text-center font-bold text-[24px]", classNames?.heading)}>
              {heading}
            </Heading>
            ...
            <Hr className={cn("mx-0 my-[26px] w-full border border-color border-solid", classNames?.hr)} />
