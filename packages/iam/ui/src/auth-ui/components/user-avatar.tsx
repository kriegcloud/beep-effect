...
export function UserAvatar({
  ...
  const gravatarUrl =
    gravatar && user?.email ? getGravatarUrl(user.email, gravatar === true ? undefined : gravatar) : null;
  ...
  return (
    ...
    >
      {avatar?.Image ? (
        <avatar.Image alt={name || localization?.USER} className={classNames?.image} src={src || ""} />
      ) : (
