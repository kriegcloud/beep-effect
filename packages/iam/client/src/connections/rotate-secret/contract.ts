 ...
 *
 * @module @beep/iam-client/connections/rotate-secret/contract
 * @category Connections/RotateSecret
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/rotate-secret");
 ...
 * ```
 *
 * @category Connections/RotateSecret/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/RotateSecret/Contracts
 * @since 0.1.0
 */
