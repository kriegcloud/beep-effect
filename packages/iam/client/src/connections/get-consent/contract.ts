 ...
 *
 * @module @beep/iam-client/connections/get-consent/contract
 * @category Connections/GetConsent
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/get-consent");
 ...
 * ```
 *
 * @category Connections/GetConsent/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/GetConsent/Contracts
 * @since 0.1.0
 */
