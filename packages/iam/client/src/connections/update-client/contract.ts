 ...
 *
 * @module @beep/iam-client/connections/update-client/contract
 * @category Connections/UpdateClient
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/update-client");

/**
 * Update fields for OAuth2 client.
 *
 * @category Connections/UpdateClient/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/UpdateClient/Contracts
 * @since 0.1.0
 */
