 ...
 *
 * @module @beep/iam-client/connections/consent/contract
 * @category Connections/Consent
 * @since 0.1.0
 */
 ...
 * ```
 *
 * @category Connections/Consent/Schemas
 * @since 0.1.0
 */
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for granting consent to an OAuth2 client.",
  })
) {}
 ...
 *
 * @category Connections/Consent/Contracts
 * @since 0.1.0
 */
