...
export class SettingsConfig extends BS.Class<SettingsConfig>("@beep/ui-core/settings/SettingsConfig")(
  {
  ...
  [
    {
      schemaId: Symbol.for("@beep/ui-core/settings/SettingsConfig"),
...
export class SettingsActionType extends SettingsActionTagged.annotations({
  schemaId: Symbol.for("@beep/ui-core/settings/SettingsActionType"),
