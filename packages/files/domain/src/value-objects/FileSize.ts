...
export class BiByteUnit extends BS.StringLiteralKit("B", "KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB").annotations({
...
export class BitUnit extends BS.StringLiteralKit("b", "kbit", "Mbit", "Gbit", "Tbit", "Pbit", "Ebit", "Zbit", "Ybit").annotations({
