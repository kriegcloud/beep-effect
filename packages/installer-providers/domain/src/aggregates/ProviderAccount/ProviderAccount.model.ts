...
import { $InstallerProvidersDomainId } from "@beep/identity/packages";
import { LiteralKit } from "@beep/schema";
import { OnePasswordReference } from "@beep/shared-domain/values/OnePasswordReference";
import * as S from "effect/Schema";

const $I = $InstallerProvidersDomainId.create("aggregates/ProviderAccount/ProviderAccount.model");
