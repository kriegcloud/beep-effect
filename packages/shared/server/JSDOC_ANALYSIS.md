# JSDoc Analysis Report: @beep/shared-server

> **Generated**: 2025-12-12T23:33:06.825Z
> **Package**: packages/shared/server
...
2. **Example Format**:
    ...
    * @example
    * ```typescript
    * import { MyThing } from "@beep/shared-server"
    *
...
```bash
beep docgen analyze -p packages/shared/server
```
