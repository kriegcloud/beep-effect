...
import type { Action } from "@beep/shared-domain/entity-ids";
 ...
 */
export type ActionPattern = Action.Type | `${string}:*`;
 ...
 * ```
 */
export const matchesActionPattern = (pattern: Action.Type, action: Action.Type): boolean => {
 ...
 * ```
 */
export const matchesActionPatternString = (pattern: ActionPattern, action: Action.Type): boolean => {
  return matchesPatternString(pattern, action);
};
 ...
 * ```
 */
export const matchesActionCondition = (condition: ActionCondition, action: Action.Type): boolean => {
 ...
 */
export const matchesActionPatterns = (patterns: readonly ActionPattern[], action: Action.Type): boolean => {
 ...
 */
export const anyActionMatchesCondition = (condition: ActionCondition, actions: readonly Action.Type[]): boolean => {
 ...
 */
export const filterMatchingActions = (condition: ActionCondition, actions: readonly Action.Type[]): Action.Type[] => {
