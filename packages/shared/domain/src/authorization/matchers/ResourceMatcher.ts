 ...
 * ```
 */
export const matchesResourceType = (conditionType: ResourceCondition["type"], resourceType: ResourceType): boolean => {
 ...
 * ```
 */
export const matchesAccountType = (allowedTypes: ReadonlyArray<AccountType>, accountType: AccountType): boolean => {
 ...
 * ```
 */
export const matchesBooleanAttribute = (required: boolean, actual: boolean): boolean => {
 ...
 */
export const matchesResourceAttributes = (attributes: ResourceAttributes, resource: ResourceContext): boolean => {
 ...
 * ```
 */
export const matchesResourceCondition = (condition: ResourceCondition, resource: ResourceContext): boolean => {
 ...
 */
export const getResourceMismatchReason = (condition: ResourceCondition, resource: ResourceContext): string | null => {
  // Check resource type
  if (!matchesResourceType(condition.type, resource.type)) {
 ...
 */
export const createCompanyResourceContext = (params: { id?: string }): ResourceContext => ({
  type: "company",
  ...params,
});
 ...
 */
export const createOrganizationResourceContext = (params: { id?: string }): ResourceContext => ({
  type: "organization",
  ...params,
});
 ...
 */
export const createConsolidationGroupResourceContext = (params: { id?: string }): ResourceContext => ({
 ...
 */
export const createReportResourceContext = (params: { id?: string }): ResourceContext => ({
  type: "report",
  ...params,
});
