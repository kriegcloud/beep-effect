 ...
 */
export const AuditLogEntryId = S.UUID.pipe(
  S.brand("AuditLogEntryId"),
  S.annotations({
 ...
 */
export const AuditAction = BS.StringLiteralKit("Create", "Update", "Delete", "StatusChange").annotations({
 ...
 */
export const AuditEntityType = BS.StringLiteralKit(
  "Organization",
  "OrganizationMember",
  "Company",
  "Account",
 ...
 */
export const AuditFieldChange = S.Struct({
  from: S.Unknown,
  to: S.Unknown,
});
 ...
 */
export const AuditChanges = S.Record({ key: S.String, value: AuditFieldChange });
