...
import * as DocumentsTableNames from "./DocumentsTableNames.ts";
...
export { SharedTableNames, DocumentsTableNames, IamTableNames, TaskTableNames, CommsTableNames, PartyTableNames };
