...
export const DocumentId = EntityId.make("document", {
  brand: "DocumentId",
  annotations: {
    schemaId: Symbol.for("@beep/shared/domain/EntityIds/knowledge-management/DocumentId"),
...
export const DocumentVersionId = EntityId.make("document_version", {
  ...
  annotations: {
    schemaId: Symbol.for("@beep/shared/domain/EntityIds/knowledge-management/DocumentVersionId"),
...
export const DiscussionId = EntityId.make("discussion", {
  brand: "DiscussionId",
  annotations: {
    schemaId: Symbol.for("@beep/shared/domain/EntityIds/knowledge-management/DiscussionId"),
...
export const CommentId = EntityId.make("comment", {
  brand: "CommentId",
  annotations: {
    schemaId: Symbol.for("@beep/shared/domain/EntityIds/knowledge-management/CommentId"),
...
export const DocumentFileId = EntityId.make("document_file", {
  ...
  annotations: {
    schemaId: Symbol.for("@beep/shared/domain/EntityIds/knowledge-management/DocumentFileId"),
