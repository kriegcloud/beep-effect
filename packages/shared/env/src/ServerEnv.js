 ...
 * @since 0.1.0
 */
export const ConfigArrayURL = (name) =>
...
const withPlaceholderRedacted = (config) => config.pipe(Config.withDefault(Redacted.make(PLACEHOLDER_VALUE)));
/**
 ...
 * @since 0.1.0
 */
export const isPlaceholder = (configValue) =>
