...
const makeUploadStream = (uploadId: string, input: UploadInput) =>
  Effect.gen(function* () {
    ...
    const handleIdle = (state: UploadState & { readonly _tag: "Idle" }) =>
      Effect.gen(function* () {
    ...
    const handleCompressing = (state: UploadState & { readonly _tag: "Compressing" }) =>
      Effect.gen(function* () {
        const maxAttempts = 3;
    ...
    const handleUploading = (state: UploadState & { readonly _tag: "Uploading" }) =>
      Effect.gen(function* () {
    ...
    const handleSyncing = (state: UploadState & { readonly _tag: "Syncing" }) =>
      Effect.gen(function* () {
