 ...
 */
export class UploadedFileData extends FileUploadDataWithCustomId.extend<UploadedFileData>("UploadedFileData")({
  key: S.String,
  /**
   * @deprecated
...
export class MetadataFetchStreamPart extends S.Class<MetadataFetchStreamPart>("MetadataFetchStreamPart")({
  payload: S.String,
  signature: S.String,
  hook: UploadThingHook,
}) {}

export class MetadataFetchResponse extends S.Class<MetadataFetchResponse>("MetadataFetchResponse")({
  ok: S.Boolean,
}) {}

export class CallbackResultResponse extends S.Class<CallbackResultResponse>("CallbackResultResponse")({
  ok: S.Boolean,
}) {}
...
export class UploadActionPayload extends S.Class<UploadActionPayload>("UploadActionPayload")({
