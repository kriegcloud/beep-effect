 ...
 *
 * @since 0.0.0
 * @module @beep/beepgraph-messaging/NatsConfig
 */
 ...
 * @category models
 */
export class NatsConfigData extends S.Class<NatsConfigData>("@beep/beepgraph-messaging/NatsConfigData")({
 ...
 * @category models
 */
export class NatsConfig extends Context.Service<NatsConfig, NatsConfigData>()("@beep/beepgraph-messaging/NatsConfig") {
  // -------------------------------------------------------------------------
  // Config loading
  // -------------------------------------------------------------------------
