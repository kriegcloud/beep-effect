 ...
 * import { ResponseRouter } from "@beep/beepgraph-messaging/ResponseRouter"
 *
 ...
 *
 * @since 0.0.0
 * @module @beep/beepgraph-messaging/ResponseRouter
 */
...
>()("@beep/beepgraph-messaging/ResponseRouter") {}
 ...
 * @internal
 */
const dispatchMessage = Effect.fn("ResponseRouter.dispatchMessage")(function* (
  msg: NatsMessage,
...
export const makeResponseRouter = (
  ...
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      yield* messages.pipe(
        Stream.runForEach((msg) => dispatchMessage(msg, deferredRef, streamRef)),
