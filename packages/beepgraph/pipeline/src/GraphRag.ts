...
export interface GraphRagOptions {
  ...
  readonly maxSubgraphSize?: number;
  readonly tripleLimit?: number;
}
...
export interface GraphRagResult {
  ...
  readonly subgraph: ReadonlyArray<Primitives.Triple>;
}
 ...
 * @category pipelines
 */
export const graphRagQuery = Effect.fn("GraphRag.query")(function* (query: string, options: GraphRagOptions = {}) {
