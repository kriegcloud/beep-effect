...
export type PluginOptions<T extends string, Opts extends Record<string, any>> = {
  _tag: T;
  options: Opts;
};
...
export type MakePluginsParams = {
  ...
  customSession?: PluginOptions<"customSession", PluginAdapters.CustomSessionOptions>;
  ...
  oidcProvider?: PluginOptions<"oidcProvider", PluginAdapters.OidcProviderOptions>;
  oneTap?: PluginOptions<"oneTap", PluginAdapters.OneTapOptions>;
  oneTimeToken?: PluginOptions<"oneTimeToken", PluginAdapters.OneTimeTokenOptions>;
  openAPI?: PluginOptions<"openAPI", PluginAdapters.OpenApiOptions>;
  organization?: PluginOptions<"organization", PluginAdapters.OrganizationOptions>;
...
export const makePlugins = F.flow(
  (opts: MakePluginsParams) =>
    [
      opts.admin ? PluginAdapters.makeAdminPlugin(opts.admin.options) : undefined,
      opts.anonymous ? PluginAdapters.makeAnonymousPlugin(opts.anonymous.options) : undefined,
      opts.apiKey ? PluginAdapters.makeApiKeyPlugin(opts.apiKey.options) : undefined,
      opts.bearer ? PluginAdapters.makeBearerPlugin(opts.bearer.options) : undefined,
      opts.captcha ? PluginAdapters.makeCaptchaPlugin(opts.captcha.options) : undefined,
      opts.customSession ? PluginAdapters.makeCustomSessionPlugin(opts.customSession.options) : undefined,
      ...
      opts.oAuthProxy ? PluginAdapters.makeOAuthProxyPlugin(opts.oAuthProxy.options) : undefined,
      opts.oidcProvider ? PluginAdapters.makeOidcProviderPlugin(opts.oidcProvider.options) : undefined,
      opts.oneTap ? PluginAdapters.makeOneTapPlugin(opts.oneTap.options) : undefined,
      opts.oneTimeToken ? PluginAdapters.makeOneTimeTokenPlugin(opts.oneTimeToken.options) : undefined,
      opts.openAPI ? PluginAdapters.makeOpenApiPlugin(opts.openAPI.options) : undefined,
      opts.organization ? PluginAdapters.makeOrganizationPlugin(opts.organization.options) : undefined,
      opts.passkey ? PluginAdapters.makePasskeyPlugin(opts.passkey.options) : undefined,
      opts.phoneNumber ? PluginAdapters.makePhoneNumberPlugin(opts.phoneNumber.options) : undefined,
      ...
      opts.stripe ? PluginAdapters.makeStripePlugin(opts.stripe.options) : undefined,
      opts.twoFactor ? PluginAdapters.makeTwoFactorPlugin(opts.twoFactor.options) : undefined,
      opts.username ? PluginAdapters.makeUsernamePlugin(opts.username.options) : undefined,
