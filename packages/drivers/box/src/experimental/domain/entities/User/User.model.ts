 ...
 * @example
 * ```ts
 * import { User } from "@beep/box/experimental/domain/values/User/User.model";
 *
...
export declare namespace User {
	 ...
	 * import {User} from "@beep/box/experimental/domain/values/User/User.model";
	 *
	 * const thing: User.Encoded = S.encodeUnknownSync(User)({});
	 * ```
	 *
	 * @category models
	 * @since 0.0.0
 ...
 * import {User} from "@beep/box/experimental/domain/values/User/User.model";
 *
 * const thing: User = S.encodeUnknownSync(User)({});
 * ```
 *
 * @category models
 * @since 0.0.0
