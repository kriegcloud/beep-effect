...
const allowedFuturePhaseStubs = new Set([
  "goals/stack-installer/history/outputs/p2-ai-mode-parity.md",
  "goals/stack-installer/history/outputs/p3-recovery.md",
  "goals/stack-installer/history/outputs/p4-portability.md",
  "goals/stack-installer/history/outputs/p5-distribution-readiness.md",
  "goals/stack-installer/ops/handoffs/HANDOFF_P2_AI_MODE.md",
  "goals/stack-installer/ops/handoffs/HANDOFF_P3_RECOVERY.md",
  "goals/stack-installer/ops/handoffs/HANDOFF_P4_PORTABILITY.md",
  "goals/stack-installer/ops/handoffs/HANDOFF_V1_RELEASE.md",
]);
