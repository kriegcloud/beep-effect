...
The initiative packet exists at `goals/stack-installer/`.
...
- `goals/README.md` lifecycle and vocabulary
- `goals/ai-metrics-stack` packet shape
- `goals/canonical-slice-factory` slice creation posture
...
- `goals/README.md` must list `stack-installer` as an active initiative.
