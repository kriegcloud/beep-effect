...
- `goals/agent-effectiveness-loop/SPEC.md` defines the Phase 0 privacy,
  ownership, and research-lane contract.
- `goals/ai-metrics-stack/SPEC.md` defines the config-impact scorecard,
  privacy model, OTLP-first Phoenix posture, and tooling ownership.
- `goals/ai-metrics-stack/history/outputs/p4-scorecards-labels-and-benchmarks.md`
  proves label queue, benchmark, and weekly report surfaces.
- `goals/ai-metrics-stack/history/outputs/p6-seven-day-proof-and-hardening.md`
...
- `goals/jsdoc-worker-eval/SPEC.md` and
  `goals/jsdoc-worker-eval/research/2026-05-16-runpod-ollama-qwen3-coder-30b-worker-eval-10-packet.md`
