...
- `goals/agent-effectiveness-loop/{README.md,SPEC.md,PLAN.md,ops/manifest.json}`
- `goals/ai-metrics-stack/{README.md,SPEC.md,PLAN.md,ops/manifest.json}`
- `goals/ai-metrics-stack/history/outputs/*.md`
- `goals/jsdoc-worker-eval/{README.md,SPEC.md,PLAN.md,ops/manifest.json}`
- `goals/jsdoc-worker-eval/research/*.md`
- `goals/jsdoc-worker-eval/history/outputs/*.json`
...
rg -n "label|benchmark|weekly|forwarder|OTLP|mirror|retention|follow-up|must not" goals/ai-metrics-stack packages/tooling
```
