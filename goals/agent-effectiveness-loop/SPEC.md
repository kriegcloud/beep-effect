...
- `goals/ai-metrics-stack/history/outputs/*`
- `goals/jsdoc-worker-eval/{README.md,SPEC.md,PLAN.md,ops/manifest.json}`
- `goals/jsdoc-worker-eval/research/*`
...
Phase 2 and Phase 3 work are no longer tracked as active phases in this goal.
They have been split into separate goal packets:

- `goals/agent-effectiveness-phoenix-enrichment` owns Phoenix-native
  annotations, datasets, experiments, evals, and prompt/config comparison.
- `goals/agent-effectiveness-workflow-integration` owns operator workflow,
  CI/report, runbook, and agent-handoff integration.
