...
3. Read these local references before drafting:
   - `goals/expert-memory-big-picture/expert-memory-kernel.md`
   - `goals/expert-memory-big-picture/expert-memory-control-plane.md`
   - `goals/expert-memory-big-picture/research-lanes-and-open-questions.md`
   - `goals/repo-codegraph-jsdoc/SPEC.md`
   - `goals/repo-codegraph-jsdoc/research/semantic-kg-integration-explained.md`
...
- Target directory: `goals/trustgraph-port`
