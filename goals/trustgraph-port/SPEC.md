...
- The expert-memory control-plane docs explicitly treat identity, workflow state, progress, budgets, partial results, and auditability as architectural concerns in [expert-memory-control-plane.md](/home/elpresidank/YeeBois/projects/beep-effect/goals/expert-memory-big-picture/expert-memory-control-plane.md).
