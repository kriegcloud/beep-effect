...
| `goals/canonical-slice-factory` | Current architecture automation and fixture replacement contract; earlier lean-slate posture remains recoverable from git history and the archive branch. |
...
| `goals/knowledge-workspace` | Prior event-sourced workspace and graph design context; marked as needing refresh. |
| `goals/ip-law-knowledge-graph` | IP law ontology and graph grounding reference. |
