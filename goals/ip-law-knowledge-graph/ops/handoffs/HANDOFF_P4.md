...
- [SPEC.md](../../SPEC.md) — Success Criteria checklist
- [p3-implementation-notes.md](../../history/outputs/p3-implementation-notes.md) — Implementation record, known issues, test results
...
7. Write a final readiness statement addressing each item in the `SPEC.md` success criteria checklist.
...
P4 is complete when all 4 commands exit 0 for the package scope, all new failures are resolved, and `history/outputs/p4-verification.md` contains the signed-off readiness statement.
