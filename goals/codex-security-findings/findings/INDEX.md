...
| CSF-004 | Medium | fixed | Closed | [Alternate proof URL leaks upload bearer token](./CSF-004-alternate-proof-url-leaks-upload-bearer-token.md) | goals/stack-installer | 1722c83 |
...
| CSF-006 | Medium | fixed | Closed | [Malformed Host header crashes proof upload server](./CSF-006-malformed-host-header-crashes-proof-upload-server.md) | goals/stack-installer | ea4b6d4 |
...
| CSF-025 | Low | fixed | Closed | [ps failure path can leak process command lines](./CSF-025-ps-failure-path-can-leak-process-command-lines.md) | goals/stack-installer | 9097bfc |
| CSF-026 | Low | fixed | Closed | [Proof watch helper trusts PID and file paths](./CSF-026-proof-watch-helper-trusts-pid-and-file-paths.md) | goals/stack-installer | 76e62e1 |
| CSF-027 | Low | fixed | Closed | [Live tailnet upload endpoint committed to docs](./CSF-027-live-tailnet-upload-endpoint-committed-to-docs.md) | goals/stack-installer | 57d5180 |
| CSF-028 | Low | fixed | Closed | [Remote status endpoint leaks coordinator output path](./CSF-028-remote-status-endpoint-leaks-coordinator-output-path.md) | goals/stack-installer | e24fc20 |
| CSF-029 | Low | fixed | Closed | [Status helper replays unescaped upload logs](./CSF-029-status-helper-replays-unescaped-upload-logs.md) | goals/stack-installer | 2945c63 |
| CSF-030 | Low | fixed | Closed | [Tailnet upload endpoint disclosed in committed audit notes](./CSF-030-tailnet-upload-endpoint-disclosed-in-committed-audit-notes.md) | goals/stack-installer | 8f36343 |
| CSF-031 | Low | fixed | Closed | [Internal SMB peer details disclosed in audit notes](./CSF-031-internal-smb-peer-details-disclosed-in-audit-notes.md) | goals/stack-installer | 6ec9c16 |
...
| CSF-033 | Low | fixed | Closed | [Predictable /tmp paths for AI metrics proof data](./CSF-033-predictable-tmp-paths-for-ai-metrics-proof-data.md) | goals/ai-metrics-stack | 7033ed3 |
...
| CSF-046 | Informational | fixed | Closed | [Host header poisoning in proof upload landing page](./CSF-046-host-header-poisoning-in-proof-upload-landing-page.md) | goals/stack-installer | d8f1ede |
| CSF-047 | Informational | fixed | Closed | [Unvalidated PID is negated for process-group kill](./CSF-047-unvalidated-pid-is-negated-for-process-group-kill.md) | goals/stack-installer | 6eb1d33 |
