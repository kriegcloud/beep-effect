...
| Owner area | goals/ai-metrics-stack |
...
- Verification command: `rg -n 'umask 077; .*mktemp -d -t ai-metrics-p7-(proof-data|restore)' goals/ai-metrics-stack/ops/manifest.json && ! rg -n '/tmp/ai-metrics-p7|/tmp/beep-ai-metrics' goals/ai-metrics-stack/ops/manifest.json`
- Changed files:
  - none
- Verification notes:
...
- goals/ai-metrics-stack/history/outputs/p6-pre-may16-readiness-ledger.md
