...
- Verification command: `! rg -n '(100\.(6[4-9]|[7-9][0-9]|1[01][0-9]|12[0-7])\.[0-9]{1,3}\.[0-9]{1,3}|[A-Za-z0-9-]+\.[A-Za-z0-9-]+\.ts\.net)' goals/stack-installer apps/stack-installer`
- Changed files:
