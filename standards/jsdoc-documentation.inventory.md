...
Generated: 2026-04-27T19:33:54.385Z
...
| openModules | 125 |
| openExports | 2478 |
| missingExportExamples | 1870 |
| missingExportCategories | 733 |
| missingExportSince | 439 |
| forbiddenTagFindings | 9 |
| malformedConditionalTagFindings | 0 |
| exampleImportFindings | 22 |
| unsafeExampleFindings | 74 |
| schemaAnnotationFindings | 107 |
| rootPolicyOpen | 0 |
...
| 11 | `@beep/test-utils` | `tooling/test-utils` | needs-remediation | 2 | 21 | 0 | 7 |
| 12 | `@beep/repo-configs` | `tooling/configs` | clean | 6 | 18 | 0 | 0 |
...
| 22 | `@beep/pglite` | `packages/drivers/pglite` | needs-remediation | 1 | 1 | 0 | 1 |
| 23 | `@beep/shared-server` | `packages/shared/server` | clean | 1 | 1 | 0 | 0 |
| 24 | `@beep/shared-config` | `packages/shared/config` | clean | 1 | 1 | 0 | 0 |
...
Export findings:
- `src/Array.ts:260` `export * from "effect/Array";` (re-export) - missing @example
...
- `src/Array.ts:305` `fromIterableNonEmpty` (const) - 1 unsafe example violation(s)
...
- `src/Id.ts:118` `IdentitySegmentCountError` (class) - 1 schema annotation/type-alias gap(s)
- `src/Id.ts:349` `IdentityString` (type) - 1 unsafe example violation(s)
- `src/Id.ts:366` `IdentitySymbol` (type) - 1 unsafe example violation(s)
- `src/packages.ts:732` `$FirecrawlId` (const) - missing @example
- `src/packages.ts:756` `RepoPkgs` (const) - missing @example
- `src/packages.ts:762` `$MdId` (const) - missing summary; missing @example
- `src/packages.ts:768` `$CodedankWebId` (const) - missing summary; missing @example
- `src/packages.ts:774` `$DrizzleId` (const) - missing summary; missing @example
- `src/packages.ts:780` `$PgliteId` (const) - missing summary; missing @example
...
- `src/Fn.ts:443` `ThunkOf` (function) - resolved
- `src/Fn.ts:444` `ThunkOf` (function) - missing summary; missing @example, @category, @since
- `src/Fn.ts:448` `ThunkOf` (function) - missing summary; missing @example, @category, @since
- `src/Fn.ts:472` `Fn` (function) - resolved
- `src/Fn.ts:496` `Fn` (function) - resolved
- `src/Fn.ts:521` `Fn` (function) - resolved
- `src/Fn.ts:551` `Fn` (function) - resolved
- `src/Fn.ts:557` `Fn` (function) - missing summary; missing @example, @category, @since
- `src/Fn.ts:123` `FnType` (type) - 1 unsafe example violation(s)
- `src/Fn.ts:167` `FnSchemaNoArg` (interface) - missing @example
- `src/Fn.ts:186` `FnSchemaUnary` (interface) - missing @example
- `src/Fn.ts:206` `FnSchema` (type) - missing @example
- `src/Fn.ts:222` `FnSchemaStatics` (type) - missing @example
- `src/Fn.ts:407` `AnyFn` (const) - resolved
- `src/Fn.ts:419` `AnyFn` (type) - missing @example
...
- `src/PosixPath.ts:103` `normalizePath` (const) - resolved
...
- `src/color/Color.ts:371` `HexColorInput` (const) - missing @example
- `src/color/Color.ts:385` `HexColorInput` (type) - missing @example
- `src/color/Color.ts:393` `HexColor` (const) - missing @example
- `src/color/Color.ts:408` `HexColor` (type) - missing @example
- `src/color/Color.ts:416` `NormalizeHexColor` (const) - missing @example
- `src/color/Color.ts:437` `NormalizeHexColor` (type) - missing @example
- `src/color/Color.ts:445` `RgbInputChannel` (const) - missing @example
- `src/color/Color.ts:460` `RgbInputChannel` (type) - missing @example
- `src/color/Color.ts:468` `RgbChannel` (const) - missing @example
- `src/color/Color.ts:484` `RgbChannel` (type) - missing @example
- `src/color/Color.ts:492` `RgbInput` (class) - missing @example
- `src/color/Color.ts:509` `Rgb` (class) - missing @example
- `src/color/Color.ts:526` `OklchCoordinate` (const) - missing @example
- `src/color/Color.ts:541` `OklchCoordinate` (type) - missing @example
- `src/color/Color.ts:549` `OklchLightness` (const) - missing @example
- `src/color/Color.ts:565` `OklchLightness` (type) - missing @example
- `src/color/Color.ts:573` `OklchChroma` (const) - missing @example
- `src/color/Color.ts:589` `OklchChroma` (type) - missing @example
- `src/color/Color.ts:597` `OklchHue` (const) - missing @example
- `src/color/Color.ts:613` `OklchHue` (type) - missing @example
- `src/color/Color.ts:621` `OklchInput` (class) - missing @example
- `src/color/Color.ts:638` `OklchColor` (class) - missing @example
- `src/color/Color.ts:655` `HexColorScale12` (const) - missing @example
- `src/color/Color.ts:672` `HexColorScale12` (type) - missing @example
- `src/color/Color.ts:680` `RgbaColorString` (const) - missing @example
- `src/color/Color.ts:695` `RgbaColorString` (type) - missing @example
- `src/color/Color.ts:703` `HexToRgb` (const) - missing @example
- `src/color/Color.ts:724` `HexToRgb` (type) - missing @example
- `src/color/Color.ts:732` `RgbToHex` (const) - missing @example
- `src/color/Color.ts:750` `RgbToHex` (type) - missing @example
- `src/color/Color.ts:758` `RgbToOklch` (const) - missing @example
- `src/color/Color.ts:776` `RgbToOklch` (type) - missing @example
- `src/color/Color.ts:784` `OklchToRgb` (const) - missing @example
- `src/color/Color.ts:802` `OklchToRgb` (type) - missing @example
- `src/color/Color.ts:810` `HexToOklch` (const) - missing @example
- `src/color/Color.ts:831` `HexToOklch` (type) - missing @example
- `src/color/Color.ts:839` `OklchToHex` (const) - missing @example
- `src/color/Color.ts:857` `OklchToHex` (type) - missing @example
- `src/color/Color.ts:865` `ColorAmount` (const) - missing @example
- `src/color/Color.ts:880` `ColorAmount` (type) - missing @example
- `src/color/Color.ts:898` `GenerateScaleInput` (class) - missing @example
- `src/color/Color.ts:914` `GenerateScale` (const) - missing @example
- `src/color/Color.ts:934` `GenerateScale` (type) - missing @example
- `src/color/Color.ts:942` `GenerateNeutralScaleInput` (class) - missing @example
- `src/color/Color.ts:958` `GenerateNeutralScale` (const) - missing @example
- `src/color/Color.ts:978` `GenerateNeutralScale` (type) - missing @example
- `src/color/Color.ts:986` `GenerateAlphaScaleInput` (class) - missing @example
- `src/color/Color.ts:1002` `GenerateAlphaScale` (const) - missing @example
- `src/color/Color.ts:1022` `GenerateAlphaScale` (type) - missing @example
- `src/color/Color.ts:1030` `MixColorsInput` (class) - missing @example
- `src/color/Color.ts:1047` `MixColors` (const) - missing @example
- `src/color/Color.ts:1065` `MixColors` (type) - missing @example
- `src/color/Color.ts:1073` `LightenInput` (class) - missing @example
- `src/color/Color.ts:1089` `Lighten` (const) - missing @example
- `src/color/Color.ts:1107` `Lighten` (type) - missing @example
- `src/color/Color.ts:1115` `DarkenInput` (class) - missing @example
- `src/color/Color.ts:1131` `Darken` (const) - missing @example
- `src/color/Color.ts:1149` `Darken` (type) - missing @example
- `src/color/Color.ts:1157` `WithAlphaInput` (class) - missing @example
- `src/color/Color.ts:1173` `WithAlpha` (const) - missing @example
- `src/color/Color.ts:1191` `WithAlpha` (type) - missing @example
...
- `src/csv/parse/CsvParser.ts:375` `parseCsvRows` (const) - missing @example
...
- `src/csv/parse/ParserOptions.ts:228` `ParserOptionsArgs` (type) - missing @example
...
- `src/http/headers/_internal/helpers.ts:79` `encodeStrictURI` (const) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:84` `encodeStrictURIOption` (const) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:89` `wrapArray` (const) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:95` `ResponseHeader` (class) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:108` `makeHeaderEncodeForbidden` (const) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:120` `makeResponseHeader` (const) - missing summary; missing @example, @category
- `src/http/headers/_internal/helpers.ts:135` `makeResponseHeaderOption` (const) - missing summary; missing @example, @category
...
- `src/index.ts:228` `export * from "./Fn.ts";` (re-export) - missing @example
- `src/index.ts:233` `export * from "./http/index.ts";` (re-export) - missing @example
- `src/index.ts:238` `export * from "./Json.ts";` (re-export) - missing @example
- `src/index.ts:243` `export * from "./KebabStr.ts";` (re-export) - missing @example
- `src/index.ts:248` `export * from "./LocalDate.ts";` (re-export) - missing @example
- `src/index.ts:253` `export * from "./location/index.ts";` (re-export) - missing @example
- `src/index.ts:258` `export * as Model from "./Model.ts";` (re-export) - missing @example
- `src/index.ts:263` `export * from "./Options.ts";` (re-export) - missing @example
- `src/index.ts:268` `export * from "./PascalStr.ts";` (re-export) - missing @example
- `src/index.ts:273` `export * from "./Primitive.ts";` (re-export) - missing @example
- `src/index.ts:278` `export * from "./person/index.ts";` (re-export) - missing @example
- `src/index.ts:283` `export * from "./RegExp.ts";` (re-export) - missing @example
- `src/index.ts:288` `export * as SchemaUtils from "./SchemaUtils/index.ts";` (re-export) - missing @example
- `src/index.ts:293` `export * from "./SemanticVersion.ts";` (re-export) - missing @example
- `src/index.ts:298` `export * from "./SeverityLevel.ts";` (re-export) - missing @example
- `src/index.ts:303` `export * from "./Sha256.ts";` (re-export) - missing @example
- `src/index.ts:308` `export * from "./Slug.ts";` (re-export) - missing @example
- `src/index.ts:313` `export * from "./SnakeStr.ts";` (re-export) - missing @example
- `src/index.ts:318` `export * from "./StatusCauseError.ts";` (re-export) - missing @example
- `src/index.ts:323` `export * from "./StatusCauseTaggedErrorClass.ts";` (re-export) - missing @example
- `src/index.ts:328` `export * from "./String.ts";` (re-export) - missing @example
- `src/index.ts:333` `export * from "./TaggedErrorClass.ts";` (re-export) - missing @example
- `src/index.ts:338` `export * from "./Timezone.ts";` (re-export) - missing @example
- `src/index.ts:343` `export * from "./Toml.ts";` (re-export) - missing @example
- `src/index.ts:348` `export * from "./Transformations.ts";` (re-export) - missing @example
- `src/index.ts:353` `export * from "./URL.ts";` (re-export) - missing @example
- `src/index.ts:358` `export * as VariantSchema from "./VariantSchema.ts";` (re-export) - missing @example
- `src/index.ts:363` `export * from "./Xml.ts";` (re-export) - missing @example
- `src/index.ts:368` `export * from "./Yaml.ts";` (re-export) - missing @example
...
- `src/TSMorph/TSMorph.model.ts:110` `RepoRootPath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:128` `RepoRootPath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:141` `WorkspaceDirectoryPath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:160` `WorkspaceDirectoryPath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:173` `TsConfigFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:189` `TsConfigFilePath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:202` `TypeScriptImplementationFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:222` `TypeScriptImplementationFilePath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:235` `TypeScriptDeclarationFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:255` `TypeScriptDeclarationFilePath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:268` `TypeScriptFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:286` `TypeScriptFilePath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:299` `SymbolFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:316` `SymbolFilePath` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:329` `SymbolNameSegment` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:349` `SymbolNameSegment` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:362` `SymbolQualifiedName` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:382` `SymbolQualifiedName` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:395` `SymbolKind` (const) - 1 schema annotation/type-alias gap(s)
- `src/TSMorph/TSMorph.model.ts:408` `SymbolKind` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:421` `SymbolCategory` (const) - 1 schema annotation/type-alias gap(s)
- `src/TSMorph/TSMorph.model.ts:439` `SymbolCategory` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:452` `symbolCategoryFromKind` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:475` `SymbolKindToCategory` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:493` `SymbolKindToCategory` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:506` `SourceText` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:524` `SourceText` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:537` `LineNumber` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:553` `LineNumber` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:566` `ColumnNumber` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:582` `ColumnNumber` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:595` `ByteOffset` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:613` `ByteOffset` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:626` `ByteLength` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:644` `ByteLength` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:657` `ContentHash` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:675` `ContentHash` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:688` `TsMorphScopeMode` (const) - 1 schema annotation/type-alias gap(s)
- `src/TSMorph/TSMorph.model.ts:704` `TsMorphScopeMode` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:717` `TsMorphReferencePolicy` (const) - 1 schema annotation/type-alias gap(s)
- `src/TSMorph/TSMorph.model.ts:733` `TsMorphReferencePolicy` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:754` `ProjectScopeId` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:770` `ProjectScopeId` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:783` `ProjectScopeIdParts` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:804` `ProjectCacheKey` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:820` `ProjectCacheKey` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:833` `SymbolId` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:854` `SymbolId` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:867` `SymbolIdParts` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:888` `FilePathToTsConfigFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:908` `FilePathToTypeScriptImplementationFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:928` `FilePathToTypeScriptDeclarationFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:948` `FilePathToTypeScriptFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:968` `TypeScriptImplementationFilePathToSymbolFilePath` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:993` `ContentHashFromBytes` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1020` `ContentHashFromSourceText` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1043` `InternalTsMorphProject` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1059` `InternalTsMorphSourceFile` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1075` `InternalTsMorphNode` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1091` `Symbol` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1159` `Symbol` (namespace) - resolved
- `src/TSMorph/TSMorph.model.ts:1197` `SymbolInit` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:1217` `makeSymbolId` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1236` `makeProjectScopeId` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1257` `makeProjectCacheKey` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1276` `makeSymbol` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1319` `TsMorphScopeEntrypoint` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1353` `TsMorphScopeEntrypoint` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:1366` `TsMorphProjectScopeRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1391` `TsMorphProjectInspectionRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1418` `TsMorphProjectScope` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1444` `TsMorphFileOutlineRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1467` `TsMorphFileOutline` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1489` `TsMorphSourceTextRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1511` `TsMorphSourceTextResult` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1533` `TsMorphSymbolLookupRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1556` `TsMorphSymbolLookupResult` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1579` `TsMorphSearchLimit` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1598` `TsMorphSearchLimit` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:1611` `TsMorphSymbolSearchRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1637` `TsMorphSymbolSearchResult` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1663` `TsMorphSymbolSourceRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1686` `TsMorphSymbolSourceResult` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1711` `TsMorphDiagnosticCategory` (const) - 1 schema annotation/type-alias gap(s)
- `src/TSMorph/TSMorph.model.ts:1729` `TsMorphDiagnosticCategory` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:1802` `TsMorphDiagnostic` (const) - resolved
- `src/TSMorph/TSMorph.model.ts:1825` `TsMorphDiagnostic` (type) - resolved
- `src/TSMorph/TSMorph.model.ts:1838` `TsMorphDiagnosticsRequest` (class) - resolved
- `src/TSMorph/TSMorph.model.ts:1861` `TsMorphDiagnosticsResult` (class) - resolved
...
- `src/TSMorph/TSMorph.service.ts:637` `createTSMorphService` (const) - resolved
- `src/TSMorph/TSMorph.service.ts:1297` `TSMorphServiceLive` (const) - resolved
...
Export findings:
- `src/entities/Specimen/Specimen.model.ts:39` `SpecimenStatus` (type) - missing @example
...
Export findings:
- `src/SqlTest.ts:185` `PgliteTestcontainersTestDriverConfigInput` (type) - missing @example
- `src/SqlTest.ts:238` `PgExternalTestDriverConfigInput` (type) - missing @example
- `src/SqlTest.ts:246` `PgliteSqlTestLayerMode` (type) - missing @example
- `src/SqlTest.ts:254` `PgliteSqlTestLayerOptions` (interface) - missing @example
- `src/SqlTest.ts:435` `PgliteTestcontainerResource` (interface) - 1 unsafe example violation(s)
...
Export findings:
- `src/Config.ts:21` `SpecimenConfigShape` (interface) - missing @example
- `src/Layer.ts:19` `export type { SpecimenConfigShape } from "./Config.js";` (re-export) - missing @example
- `src/Layer.ts:35` `loadSpecimenConfig` (const) - missing @example
- `src/PublicConfig.ts:19` `SpecimenPublicConfig` (class) - missing @example
- `src/Secrets.ts:27` `SpecimenSecretConfig` (class) - missing @example
- `src/ServerConfig.ts:19` `SpecimenServerConfig` (class) - missing @example
- `src/TestLayer.ts:19` `specimenTestPublicConfig` (const) - missing @example
- `src/TestLayer.ts:29` `specimenTestServerConfig` (const) - missing @example
- `src/TestLayer.ts:39` `specimenTestSecretConfig` (const) - missing @example
...
Export findings:
- `src/entities/Specimen/Specimen.service.ts:20` `SpecimenUseCases` (interface) - missing @example
...
Export findings:
- `src/entities/Organization/Organization.values.ts:52` `LicenseTier` (type) - 1 unsafe example violation(s)
- `src/entities/Organization/index.ts:7` `export * from "./Organization.behavior.js";` (re-export) - missing @example
- `src/entities/Organization/index.ts:15` `export * from "./Organization.model.js";` (re-export) - missing @example
- `src/entities/Organization/index.ts:23` `export * from "./Organization.values.js";` (re-export) - missing @example
...
- `src/entity/BaseEntity.ts:102` `fields` (const) - missing @example
- `src/entity/BaseEntity.ts:119` `fieldMap` (const) - missing @example
- `src/entity/BaseEntity.ts:194` `FieldMapFor` (type) - missing @example
- `src/entity/BaseEntity.ts:205` `Definition` (type) - missing @example
- `src/entity/BaseEntity.ts:220` `ExtendBuilder` (interface) - missing @example
- `src/entity/BaseEntity.ts:547` `BaseEntity` (type) - missing @example
- `src/entity/EntityId.ts:57` `EntityIdValue` (type) - missing @example
- `src/entity/EntityId.ts:65` `EntityIdValueFor` (type) - missing @example
- `src/entity/EntityId.ts:167` `OptionsInput` (type) - missing @example
- `src/entity/EntityId.ts:204` `Definition` (class) - missing @example
- `src/entity/EntityId.ts:258` `EntityId` (type) - missing @example
- `src/entity/EntityId.ts:296` `Any` (type) - missing @example
- `src/entity/EntityMixin.ts:585` `FieldDescriptorByValueStrategy` (type) - missing @example
- `src/entity/EntityMixin.ts:610` `FieldDescriptorFromInput` (type) - missing @example
- `src/entity/EntityMixin.ts:630` `FieldDescriptorMap` (type) - missing @example
- `src/entity/EntityMixin.ts:640` `FieldDescriptorInputMap` (type) - missing @example
- `src/entity/EntityMixin.ts:650` `FieldDescriptorMapFromDefinition` (type) - missing @example
- `src/entity/EntityMixin.ts:660` `AnyFieldDescriptorMap` (type) - missing @example
- `src/entity/EntityMixin.ts:668` `Definition` (type) - missing @example
- `src/entity/EntityMixin.ts:682` `FieldOverride` (type) - missing @example
- `src/entity/EntityMixin.ts:704` `EntityMixin` (type) - missing @example
- `src/entity/EntityMixin.ts:745` `Pack` (type) - missing @example
- `src/entity/EntityMixin.ts:763` `PackFromMixins` (type) - missing @example
- `src/entity/EntityMixin.ts:775` `EmptyPack` (type) - missing @example
- `src/entity/EntityMixin.ts:783` `EntityMixinFieldCollisionError` (class) - missing @example
- `src/entity/EntityMixin.ts:801` `EntityMixinDescriptorMissingError` (class) - missing @example
- `src/entity/EntityMixin.ts:845` `isOverride` (const) - missing @example
- `src/entity/EntityMixin.ts:853` `isMixin` (const) - missing @example
- `src/entity/EntityMixin.ts:861` `isPack` (const) - missing @example
- `src/entity/EntityMixin.ts:967` `pack` (const) - missing @example
- `src/entity/EntityRef.ts:21` `EntityType` (const) - missing @example
- `src/entity/EntityRef.ts:34` `EntityType` (type) - missing @example
- `src/entity/Principal.ts:21` `SystemComponent` (const) - missing @example
- `src/entity/Principal.ts:33` `SystemComponent` (type) - missing @example
- `src/entity/Principal.ts:41` `UserPrincipal` (class) - missing @example
- `src/entity/Principal.ts:57` `ServiceAccountPrincipal` (class) - missing @example
- `src/entity/Principal.ts:74` `AgentPrincipal` (class) - missing @example
- `src/entity/Principal.ts:93` `ConnectorAccountPrincipal` (class) - missing @example
- `src/entity/Principal.ts:110` `SystemPrincipal` (class) - missing @example
...
- `src/entity/index.ts:14` `export * as BaseEntity from "./BaseEntity.ts";` (re-export) - missing @example
- `src/entity/index.ts:22` `export * as EntityId from "./EntityId.ts";` (re-export) - missing @example
- `src/entity/index.ts:30` `export * as EntityMixin from "./EntityMixin.ts";` (re-export) - missing @example
- `src/entity/index.ts:38` `export * as EntityRef from "./EntityRef.ts";` (re-export) - missing @example
- `src/entity/index.ts:46` `export * as Principal from "./Principal.ts";` (re-export) - missing @example
- `src/entity/index.ts:54` `export * as primitives from "./primitives.ts";` (re-export) - missing @example
- `src/entity/index.ts:62` `export * as SourceKind from "./SourceKind.ts";` (re-export) - missing @example
- `src/entity/primitives.ts:39` `Sha256` (type) - missing @example
- `src/entity/primitives.ts:47` `Ed25519Signature` (const) - missing @example
- `src/entity/primitives.ts:60` `Ed25519Signature` (type) - missing @example
- `src/entity/primitives.ts:68` `EncryptionKeyId` (const) - missing @example
- `src/entity/primitives.ts:81` `EncryptionKeyId` (type) - missing @example
- `src/entity/primitives.ts:89` `HybridLogicalClock` (const) - missing @example
- `src/entity/primitives.ts:102` `HybridLogicalClock` (type) - missing @example
- `src/entity/primitives.ts:110` `VectorClock` (const) - missing @example
- `src/entity/primitives.ts:123` `VectorClock` (type) - missing @example
- `src/identity/Shared.ts:20` `OrganizationId` (const) - missing @example
- `src/identity/Shared.ts:38` `OrganizationId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:46` `UserId` (const) - missing @example
- `src/identity/Shared.ts:64` `UserId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:72` `TeamId` (const) - missing @example
- `src/identity/Shared.ts:90` `TeamId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:98` `ServiceAccountId` (const) - missing @example
- `src/identity/Shared.ts:116` `ServiceAccountId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:124` `AgentId` (const) - missing @example
- `src/identity/Shared.ts:142` `AgentId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:150` `AgentVersionId` (const) - missing @example
- `src/identity/Shared.ts:168` `AgentVersionId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:176` `ConnectorAccountId` (const) - missing @example
- `src/identity/Shared.ts:194` `ConnectorAccountId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:202` `ActivityId` (const) - missing @example
- `src/identity/Shared.ts:220` `ActivityId` (type) - 1 unsafe example violation(s)
- `src/identity/Shared.ts:228` `LocalMachineId` (const) - missing @example
- `src/identity/Shared.ts:246` `LocalMachineId` (type) - 1 unsafe example violation(s)
- `src/identity/index.ts:12` `export * as Shared from "./Shared.ts";` (re-export) - missing @example
- `src/index.ts:29` `export * as Aggregates from "./aggregates/index.ts";` (re-export) - missing @example
- `src/index.ts:37` `export * as Entities from "./entities/index.ts";` (re-export) - missing @example
- `src/index.ts:44` `export * as BaseEntity from "./entity/BaseEntity.ts";` (re-export) - missing @example
- `src/index.ts:51` `export * as EntityId from "./entity/EntityId.ts";` (re-export) - missing @example
- `src/index.ts:58` `export * as EntityMixin from "./entity/EntityMixin.ts";` (re-export) - missing @example
- `src/index.ts:65` `export * as EntityRef from "./entity/EntityRef.ts";` (re-export) - missing @example
- `src/index.ts:72` `export * as Principal from "./entity/Principal.ts";` (re-export) - missing @example
- `src/index.ts:79` `export * as SourceKind from "./entity/SourceKind.ts";` (re-export) - missing @example
- `src/index.ts:86` `export * as Identity from "./identity/index.ts";` (re-export) - missing @example
- `src/index.ts:93` `export * as Values from "./values/index.ts";` (re-export) - missing @example
- `src/values/LocalDate/index.ts:16` `export * from "./LocalDate.behavior.ts";` (re-export) - missing @example
- `src/values/LocalDate/index.ts:22` `export * from "./LocalDate.model.ts";` (re-export) - missing @example
- `src/values/index.ts:14` `export * as LocalDate from "./LocalDate/index.ts";` (re-export) - missing @example
...
- `src/hooks/useSpinner.ts:132` `useSpinner` (function) - missing @example
...
- `src/commands/Codex/internal/CodexSessionStartRuntime.ts:129` `buildCodexSessionStartContext` (const) - 2 schema annotation/type-alias gap(s)
...
- `src/commands/CreatePackage/ConfigUpdater.ts:319` `updateTsconfigPackages` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:360` `updateTsconfigPaths` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:414` `updateTstycheConfig` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:524` `updateRootConfigsForTargets` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:566` `checkConfigNeedsUpdateForTargets` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:610` `updateRootConfigs` (const) - missing @example
- `src/commands/CreatePackage/ConfigUpdater.ts:638` `checkConfigNeedsUpdate` (const) - missing @example
...
- `src/commands/CreatePackage/Handler.ts:76` `resolveCreatePackageTemplateDir` (const) - missing @example
- `src/commands/CreatePackage/Handler.ts:200` `TemplateContext` (class) - missing @example
- `src/commands/CreatePackage/Handler.ts:458` `createPackageCommand` (const) - missing @example
...
- `src/commands/Docgen/index.ts:598` `docgenCommand` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:75` `DocgenPackageStatus` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:90` `DocgenPackageStatus` (type) - missing @example
- `src/commands/Docgen/internal/Operations.ts:104` `DocgenConfigDocument` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:133` `DocgenWorkspacePackage` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:154` `DocgenIssuePriority` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:165` `DocgenIssuePriority` (type) - missing @example
- `src/commands/Docgen/internal/Operations.ts:173` `DocgenExportKind` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:194` `DocgenExportKind` (type) - missing @example
- `src/commands/Docgen/internal/Operations.ts:202` `DocgenExportAnalysis` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:226` `DocgenAnalysisSummary` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:246` `DocgenPackageAnalysis` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:265` `DocgenGenerationResult` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:285` `DocgenAggregateResult` (class) - missing @example
- `src/commands/Docgen/internal/Operations.ts:912` `normalizeDocsOutputPath` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:923` `loadDocgenConfigDocument` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:951` `createDocgenConfigDocument` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:994` `discoverDocgenWorkspacePackages` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1037` `resolveDocgenWorkspacePackage` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1089` `analyzePackageDocumentation` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1133` `generateAnalysisReport` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1247` `generateAnalysisJson` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1257` `aggregateGeneratedDocs` (const) - missing @example
- `src/commands/Docgen/internal/Operations.ts:1405` `runDocgenForPackage` (const) - missing @example
...
- `src/commands/Quality/Tasks.ts:636` `sqlIntegrationStepForTesting` (const) - missing @example
- `src/commands/Quality/Tasks.ts:649` `runSqlIntegrationTestLaneForTesting` (const) - missing @example
- `src/commands/Quality/Tasks.ts:770` `rootQualityStepsForTesting` (const) - missing @example
- `src/commands/Quality/Tasks.ts:898` `parseQualityTaskInvocation` (const) - resolved
- `src/commands/Quality/Tasks.ts:942` `runQualityTask` (const) - resolved
- `src/commands/Quality/Tasks.ts:976` `runQualityTaskIfRequested` (const) - resolved
- `src/commands/Quality/Tasks.ts:1008` `collectStepOutput` (const) - resolved
...
- `src/commands/TsconfigSync.ts:52` `export {
  /**
...
- `src/commands/TsconfigSync.ts:152` `TsconfigSyncDriftError` (class) - missing @example
- `src/commands/TsconfigSync.ts:170` `TsconfigSyncCycleError` (class) - missing @example
- `src/commands/TsconfigSync.ts:188` `TsconfigSyncFilterError` (class) - missing @example
- `src/commands/TsconfigSync.ts:213` `TsconfigSyncMode` (const) - missing @example
- `src/commands/TsconfigSync.ts:267` `TsconfigSyncRunOptions` (const) - missing @example
- `src/commands/TsconfigSync.ts:286` `TsconfigSyncRunOptions` (type) - missing @example
- `src/commands/TsconfigSync.ts:294` `TsconfigSyncSection` (const) - missing @example
- `src/commands/TsconfigSync.ts:314` `TsconfigSyncSection` (type) - missing @example
- `src/commands/TsconfigSync.ts:400` `TsconfigSyncChange` (const) - missing @example
- `src/commands/TsconfigSync.ts:424` `TsconfigSyncChange` (type) - missing @example
- `src/commands/TsconfigSync.ts:525` `PlannedFileChange` (const) - missing @example
- `src/commands/TsconfigSync.ts:549` `PlannedFileChange` (type) - missing @example
- `src/commands/TsconfigSync.ts:591` `TsconfigSyncResult` (const) - missing @example
- `src/commands/TsconfigSync.ts:607` `TsconfigSyncResult` (type) - missing @example
...
- `src/commands/VersionSync/internal/resolvers/BiomeResolver.ts:148` `BiomeSchemaState` (class) - missing @example
- `src/commands/VersionSync/internal/resolvers/BiomeResolver.ts:168` `resolveBiomeSchema` (const) - missing @example
- `src/commands/VersionSync/internal/resolvers/BiomeResolver.ts:243` `buildBiomeReport` (const) - missing @example
- `src/commands/VersionSync/internal/resolvers/BiomeResolver.ts:288` `updateBiomeSchema` (const) - missing @example
...
- `src/commands/VersionSync/internal/resolvers/NodeResolver.ts:131` `resolveNodeVersions` (const) - missing @example
- `src/commands/VersionSync/internal/resolvers/NodeResolver.ts:246` `buildNodeReport` (const) - missing @example
...
- `src/commands/VersionSync/internal/updaters/YamlFileUpdater.ts:113` `replaceNodeVersionWithFile` (const) - missing @example
...
- `src/index.ts:21` `export * as Table from "./table/Table.ts";` (re-export) - missing @example
- `src/table/Table.ts:88` `ColumnBuilderFor` (type) - missing @example
- `src/table/Table.ts:98` `ColumnBuilderMapFor` (type) - missing @example
- `src/table/Table.ts:110` `TableFor` (type) - missing @example
- `src/table/Table.ts:158` `WithDefinition` (type) - 1 unsafe example violation(s)
...
### @beep/fixture-lab-specimen-ui

Path: `packages/fixture-lab/specimen/ui`

Export findings:
- `src/entities/Specimen/Specimen.detail.tsx:15` `SpecimenDetailProps` (interface) - missing @example
...
- `src/Core/Pattern.ts:76` `WinkPOSTag` (const) - resolved
- `src/Core/Pattern.ts:96` `WinkPOSTag` (type) - resolved
- `src/Core/Pattern.ts:111` `WinkEntityType` (const) - resolved
- `src/Core/Pattern.ts:131` `WinkEntityType` (type) - resolved
- `src/Core/Pattern.ts:157` `POSPatternOption` (const) - resolved
- `src/Core/Pattern.ts:180` `POSPatternOption` (type) - resolved
- `src/Core/Pattern.ts:195` `EntityPatternOption` (const) - resolved
- `src/Core/Pattern.ts:218` `EntityPatternOption` (type) - resolved
- `src/Core/Pattern.ts:233` `LiteralPatternOption` (const) - resolved
- `src/Core/Pattern.ts:257` `LiteralPatternOption` (type) - resolved
- `src/Core/Pattern.ts:272` `POSPatternElement` (class) - resolved
- `src/Core/Pattern.ts:295` `EntityPatternElement` (class) - resolved
- `src/Core/Pattern.ts:318` `LiteralPatternElement` (class) - resolved
- `src/Core/Pattern.ts:341` `PatternElement` (const) - resolved
- `src/Core/Pattern.ts:362` `PatternElement` (type) - resolved
- `src/Core/Pattern.ts:377` `PatternId` (const) - resolved
- `src/Core/Pattern.ts:399` `PatternId` (type) - resolved
- `src/Core/Pattern.ts:414` `MarkRange` (const) - resolved
- `src/Core/Pattern.ts:435` `MarkRange` (type) - resolved
- `src/Core/Pattern.ts:450` `Pattern` (class) - resolved
...
- `src/Core/PatternParsers.ts:203` `BracketStringToPatternElement` (const) - resolved
- `src/Core/PatternParsers.ts:228` `BracketStringToPatternElement` (type) - resolved
- `src/Core/PatternParsers.ts:243` `PatternFromString` (const) - resolved
...
Export findings:
- `src/entities/Specimen/Specimen.command-client.ts:17` `SpecimenCommandOperation` (type) - missing @example
- `src/entities/Specimen/Specimen.command-client.ts:25` `SpecimenCommandRequest` (type) - missing @example
- `src/entities/Specimen/Specimen.command-client.ts:33` `SpecimenCommandTransport` (interface) - missing @example
- `src/entities/Specimen/Specimen.command-client.ts:46` `SpecimenCommandClient` (interface) - missing @example
- `src/entities/Specimen/Specimen.query-client.ts:17` `SpecimenQueryOperation` (type) - missing @example
- `src/entities/Specimen/Specimen.query-client.ts:25` `SpecimenQueryRequest` (type) - missing @example
- `src/entities/Specimen/Specimen.query-client.ts:33` `SpecimenQueryTransport` (interface) - missing @example
- `src/entities/Specimen/Specimen.query-client.ts:46` `SpecimenQueryClient` (interface) - missing @example
- `src/entities/Specimen/Specimen.service.ts:29` `SpecimenClientOperation` (type) - missing @example
- `src/entities/Specimen/Specimen.service.ts:37` `SpecimenClientRequest` (type) - missing @example
- `src/entities/Specimen/Specimen.service.ts:70` `SpecimenClient` (interface) - missing @example
...
Export findings:
- `src/Metric.ts:191` `trackDuration` (const) - missing @example
- `src/Metric.ts:314` `observeWorkflow` (const) - missing @example
- `src/Metric.ts:445` `observeHttpRequest` (const) - missing @example
- `src/PhaseProfiler.ts:259` `profilePhase` (const) - missing @example
...
- `src/server/HttpApiTelemetry.ts:256` `makeHttpApiTelemetryDescriptor` (const) - 1 unsafe example violation(s)
- `src/server/HttpApiTelemetry.ts:295` `httpApiFailureStatus` (const) - 1 unsafe example violation(s)
- `src/server/HttpApiTelemetry.ts:415` `observeHttpApiEffect` (const) - missing @example
- `src/server/HttpApiTelemetry.ts:574` `observeHttpApiHandler` (const) - missing @example
...
Export findings:
- `src/entities/Organization/index.ts:7` `export * from "./Organization.display.js";` (re-export) - missing @example
- `src/entities/index.ts:7` `export * as Organization from "./Organization/index.js";` (re-export) - missing @example
- `src/index.ts:29` `export * as Entities from "./entities/index.ts";` (re-export) - missing @example
