...
| `initiatives/canonical-slice-factory/` | Current architecture automation path; the pre-automation memory packets live only in git history and the archive branch |
