import type { _DefaultCamelCaseOptions, CamelCase, CamelCaseOptions } from "./camel-case";
...
type _CamelCasedPropertiesDeep<Value, Options extends Required<CamelCaseOptions>> = Value extends NonRecursiveType
  ? Value
