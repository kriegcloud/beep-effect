...
import { ExtraConfigColumn, IndexedColumn } from "./columns/index";
...
interface IndexConfig {
   ...
   */
  with?: undefined | Record<string, any>;

  /**
   * The optional WITH clause method for the index
   */
  method?: undefined | "btree" | string;
}
...
export type GetColumnsTableName<TColumns> = TColumns extends PgColumn
  ? TColumns["_"]["name"]
  : TColumns extends PgColumn[]
    ? TColumns[number]["_"]["name"]
    : never;

export function index(name?: undefined | string): IndexBuilderOn {
  return new IndexBuilderOn(false, name);
}

export function uniqueIndex(name?: undefined | string): IndexBuilderOn {
