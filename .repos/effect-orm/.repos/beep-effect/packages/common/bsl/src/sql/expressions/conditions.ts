...
export function inArray(column: SQLWrapper, values: ReadonlyArray<unknown | Placeholder> | SQLWrapper): SQL {
 ...
 */
export function between<T>(column: SQL.Aliased, min: T | SQLWrapper, max: T | SQLWrapper): SQL;
 ...
 */
export function notBetween<T>(column: SQL.Aliased, min: T | SQLWrapper, max: T | SQLWrapper): SQL;
...
export function notBetween(column: SQLWrapper, min: unknown, max: unknown): SQL {
 ...
 */
export function arrayContains<T>(column: SQL.Aliased<T>, values: (T | Placeholder) | SQLWrapper): SQL;
...
export function arrayContains(column: SQLWrapper, values: (unknown | Placeholder)[] | SQLWrapper): SQL {
  if (Array.isArray(values)) {
    if (values.length === 0) {
 ...
 * @see arrayOverlaps to find if a column or expression contains any elements of an array
 */
export function arrayContained<T>(column: SQL.Aliased<T>, values: (T | Placeholder) | SQLWrapper): SQL;
...
export function arrayContained(column: SQLWrapper, values: (unknown | Placeholder)[] | SQLWrapper): SQL {
  if (Array.isArray(values)) {
    if (values.length === 0) {
 ...
 * @see arrayContained to find if an array contains all elements of a column or expression
 */
export function arrayOverlaps<T>(column: SQL.Aliased<T>, values: (T | Placeholder) | SQLWrapper): SQL;
...
export function arrayOverlaps(column: SQLWrapper, values: (unknown | Placeholder)[] | SQLWrapper): SQL {
  if (Array.isArray(values)) {
    if (values.length === 0) {
