...
title: Introduction
slug: /
description: "agnix validates AI agent configuration files across Claude Code, Cursor, Copilot, MCP, and AGENTS.md. 155 rules, auto-fix, and editor integration."
---
...
- [Rules Reference](./rules/index.md) -- browse all 155 validation rules
