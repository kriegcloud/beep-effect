...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgBinaryVector(table, this.config as any);
  }
}
...
export function bit(config: PgBinaryVectorConfig): PgBinaryVectorBuilder;
export function bit(name: string, config: PgBinaryVectorConfig): PgBinaryVectorBuilder;
