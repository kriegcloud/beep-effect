...
export class PgLineBuilder extends PgColumnBuilder<{
  ...
  override build(table: PgTable<any>) {
    return new PgLineTuple(table, this.config as any);
  }
}
...
export class PgLineABCBuilder extends PgColumnBuilder<{
  ...
  /** @internal */
  override build(table: PgTable<any>) {
    return new PgLineABC(table, this.config as any);
  }
}
...
export function line<TMode extends PgLineTypeConfig["mode"] & {}>(
  config?: undefined | PgLineTypeConfig<TMode>
): Equal<TMode, "abc"> extends true ? PgLineABCBuilder : PgLineBuilder;
export function line<TMode extends PgLineTypeConfig["mode"] & {}>(
  name: string,
  config?: undefined | PgLineTypeConfig<TMode>
): Equal<TMode, "abc"> extends true ? PgLineABCBuilder : PgLineBuilder;
export function line(a?: undefined | string | PgLineTypeConfig, b?: undefined | PgLineTypeConfig) {
