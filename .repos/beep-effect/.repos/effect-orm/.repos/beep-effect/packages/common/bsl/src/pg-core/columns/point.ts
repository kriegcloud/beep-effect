...
export class PgPointTupleBuilder extends PgColumnBuilder<{
  ...
  override build(table: PgTable<any>) {
    return new PgPointTuple(table, this.config as any);
  }
}
...
export class PgPointObjectBuilder extends PgColumnBuilder<{
  ...
  /** @internal */
  override build(table: PgTable<any>) {
    return new PgPointObject(table, this.config as any);
  }
}
...
export function point<TMode extends PgPointConfig["mode"] & {}>(
  config?: undefined | PgPointConfig<TMode>
): Equal<TMode, "xy"> extends true ? PgPointObjectBuilder : PgPointTupleBuilder;
export function point<TMode extends PgPointConfig["mode"] & {}>(
  name: string,
  config?: undefined | PgPointConfig<TMode>
): Equal<TMode, "xy"> extends true ? PgPointObjectBuilder : PgPointTupleBuilder;
export function point(a?: undefined | string | PgPointConfig, b?: undefined | PgPointConfig) {
