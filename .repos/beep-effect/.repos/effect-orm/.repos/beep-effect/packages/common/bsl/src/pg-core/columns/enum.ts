...
export interface PgEnumObject<TValues extends object> {
  (name?: undefined | string): PgEnumObjectColumnBuilder<TValues>;
...
export class PgEnumObjectColumnBuilder<TValues extends object> extends PgColumnBuilder<
  {
...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgEnumObjectColumn(table, this.config as any);
  }
}
...
export interface PgEnum<TValues extends [string, ...string[]]> {
  (name?: undefined | string): PgEnumColumnBuilder<TValues>;
...
export class PgEnumColumnBuilder<TValues extends [string, ...string[]]> extends PgColumnBuilder<
  {
    dataType: "string enum";
    data: TValues[number];
    enumValues: TValues;
...
> {
  ...
  /** @internal */
  override build(table: PgTable<any>) {
    return new PgEnumColumn(table, this.config as any);
  }
}
...
export function pgEnum(enumName: any, input: any): any {
...
export function pgEnumWithSchema<U extends string, T extends Readonly<[U, ...U[]]>>(
  ...
  const enumInstance: PgEnum<Writable<T>> = Object.assign(
    (name?: undefined | string): PgEnumColumnBuilder<Writable<T>> => new PgEnumColumnBuilder(name ?? "", enumInstance),
    {
      enumName,
      enumValues: values,
      schema,
...
export function pgEnumObjectWithSchema<T extends object>(
  ...
  const enumInstance: PgEnumObject<T> = Object.assign(
    (name?: undefined | string): PgEnumObjectColumnBuilder<T> =>
      new PgEnumObjectColumnBuilder(name ?? "", enumInstance),
    {
      enumName,
