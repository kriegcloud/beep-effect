...
import type { PgTable, TableConfig } from "../../pg-core/table";
...
import { Param, SQL, sql } from "../../sql/sql";
import type { Subquery } from "../../subquery";
import type { InferInsertModel } from "../../table";
import { getTableName, Table, TableColumns } from "../../table";
import { tracer } from "../../tracing";
import { haveSameKeys, mapUpdateSet, type NeonAuthToken, orderSelectedFields } from "../../utils";
import type { AnyPgColumn, PgColumn } from "../columns/common";
...
export interface PgInsertConfig<TTable extends PgTable = PgTable> {
  ...
  onConflict?:  undefined | SQL;
  returningFields?: undefined | SelectedFieldsFlat;
  returning?: undefined | SelectedFieldsOrdered;
  select?: undefined | boolean;
  overridingSystemValue_?: undefined | boolean;
}
...
> = TypedQueryBuilder<{ [K in keyof TModel]: AnyPgColumn | SQL | SQL.Aliased | TModel[K] }>;
