...
export class PgCharBuilder<TEnum extends [string, ...string[]] | undefined = undefined> extends PgColumnBuilder<
...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgChar(table, this.config as any);
  }
}

export class PgChar<TEnum extends [string, ...string[]] | undefined = undefined> extends PgColumn<
