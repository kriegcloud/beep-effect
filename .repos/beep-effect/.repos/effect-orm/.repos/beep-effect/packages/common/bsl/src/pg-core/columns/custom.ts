import type { ColumnBuilderBaseConfig } from "../../column-builder";
import { entityKind } from "../../entity";
import type { PgTable } from "../../pg-core/table";
import type { SQL, SQLGenerator } from "../../sql/sql";
import { type Equal, getColumnNameAndConfig } from "../../utils";
import { parsePgArray } from "../utils/array";
...
> {
  ...
  override build(table: PgTable<any>) {
    return new PgCustomColumn(table, this.config as any);
  }
}
...
export class PgCustomColumn<T extends ColumnBuilderBaseConfig<"custom">> extends PgColumn<"custom"> {
  ...
  private readonly mapTo?: undefined | ((value: T["data"]) => T["driverParam"]);
  private readonly mapFrom?: undefined | ((value: T["driverParam"]) => T["data"]);
  private readonly mapJson?: undefined | ((value: unknown) => T["data"]);
  private readonly forJsonSelect?: undefined | ((identifier: SQL, sql: SQLGenerator, arrayDimensions?: number) => SQL);
...
export function customType<T extends CustomTypeValues = CustomTypeValues>(
  ...
  return (a?: string | T["config"], b?: T["config"]): PgCustomColumnBuilder<ConvertCustomConfig<T>> => {
