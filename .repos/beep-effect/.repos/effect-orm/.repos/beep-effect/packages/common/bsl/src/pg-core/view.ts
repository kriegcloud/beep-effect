...
import type { ColumnsSelection, SQL } from "../sql/sql";
import type { RequireAtLeastOne } from "../utils";
import { getTableColumns } from "../utils";
import type { AnyPgColumnBuilder, PgBuildColumns, PgColumn } from "./columns/common";
...
export class DefaultViewBuilderCore<TConfig extends { name: string; columns?: undefined | unknown }> {
...
export class MaterializedViewBuilderCore<TConfig extends { name: string; columns?: undefined | unknown }> {
  ...
  protected config: {
    with?: undefined | PgMaterializedViewWithConfig;
    using?: undefined | string;
...
export class MaterializedViewBuilder<TName extends string = string> extends MaterializedViewBuilderCore<{
  name: TName;
}> {
...
> extends PgViewBase<TName, TExisting, TSelectedFields> {
  ...
  readonly [PgMaterializedViewConfig]:
    | {
        readonly with?: undefined | PgMaterializedViewWithConfig;
        readonly using?: undefined | string;
        readonly tablespace?: undefined | string;
        readonly withNoData?: undefined | boolean;
      }
    | undefined;
...
export function pgView(
  name: string,
  columns?: undefined | Record<string, AnyPgColumnBuilder>
): ViewBuilder | ManualViewBuilder {
