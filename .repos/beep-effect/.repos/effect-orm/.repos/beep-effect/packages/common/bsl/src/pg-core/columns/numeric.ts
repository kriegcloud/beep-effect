...
> {
  ...
  constructor(name: string, precision?: undefined | number, scale?: undefined | number) {
...
> {
  ...
  /** @internal */
  override build(table: PgTable<any>) {
    return new PgNumericNumber(table, this.config as any);
  }
}
...
> {
  ...
  /** @internal */
  override build(table: PgTable<any>) {
    return new PgNumericBigInt(table, this.config as any);
  }
}
...
export type PgNumericConfig<T extends "string" | "number" | "bigint" = "string" | "number" | "bigint"> =
  | { precision: number; scale?: undefined | number; mode?: undefined | T }
  | { precision?: undefined | number; scale: number; mode?: undefined | T }
  | { precision?: undefined | number; scale?: undefined | number; mode: T };

export function numeric<TMode extends "string" | "number" | "bigint">(
  config?: undefined | PgNumericConfig<TMode>
...
export function numeric<TMode extends "string" | "number" | "bigint">(
  ...
  : Equal<TMode, "bigint"> extends true
    ? PgNumericBigIntBuilder
    : PgNumericBuilder;
export function numeric(a?: undefined | string | PgNumericConfig, b?: undefined | PgNumericConfig) {
