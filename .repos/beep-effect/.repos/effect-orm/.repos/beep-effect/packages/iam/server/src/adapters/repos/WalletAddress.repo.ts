...
const $I = $IamServerId.create("adapters/repos/WalletAddressRepo");
export class WalletAddressRepo extends Effect.Service<WalletAddressRepo>()($I`WalletAddressRepo`, {
  dependencies,
  accessors: true,
  effect: Repo.make(
