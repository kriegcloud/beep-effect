...
import { BlockDiscussion } from "@beep/ui/components/block-discussion";
import type { TComment } from "@beep/ui/components/comment";
...
export type TDiscussion = {
  ...
  readonly documentContent?: string | undefined;
};
