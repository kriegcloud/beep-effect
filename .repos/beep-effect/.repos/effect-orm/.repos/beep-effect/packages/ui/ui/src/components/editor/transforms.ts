...
type InsertBlockOptions = {
  readonly upsert?: undefined | boolean;
};
...
export const insertBlock = (editor: PlateEditor, type: string, options: InsertBlockOptions = {}) => {
  ...
  editor.tf.withoutNormalizing(() => {
    ...
    if (type in insertBlockMap && insertBlockMap[type]) {
...
export const setBlockType = (editor: PlateEditor, type: string, { at }: { readonly at?: undefined | Path } = {}) => {
  editor.tf.withoutNormalizing(() => {
