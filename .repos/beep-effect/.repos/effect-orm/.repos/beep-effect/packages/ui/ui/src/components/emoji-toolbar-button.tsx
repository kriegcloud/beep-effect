...
export function EmojiToolbarButton({
  ...
  readonly options?: undefined | EmojiDropdownMenuOptions;
  ...
  return (
    <EmojiPopover
      ...
      setIsOpen={setIsOpen}
    >
      {/* @ts-expect-error - platejs type incompatibility with exactOptionalPropertyTypes */}
      <EmojiPicker
        {...emojiPickerState}
...
export function EmojiPicker({
  ...
  icons?: undefined | EmojiIconList<React.ReactElement>;
}) {
  return (
    <div
    ...
    >
      <EmojiPickerNavigation
        ...
        {...(focusedCategory !== undefined ? { focusedCategory } : {})}
        i18n={i18n}
        icons={icons}
      />
