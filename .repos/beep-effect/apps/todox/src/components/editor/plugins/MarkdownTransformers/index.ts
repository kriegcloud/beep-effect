...
/**
 * Filter out transformers whose dependencies include CodeNode or CodeHighlightNode,
...
/**
 * Transformer set for the email compose editor.
 * Excludes TABLE, EQUATION, TWEET, and CODE whose node dependencies
 * are not registered in EMAIL_COMPOSE_NODES.
 */
export const EMAIL_COMPOSE_TRANSFORMERS: Array<Transformer> = [
  HR,
  IMAGE,
  EMOJI,
  CHECK_LIST,
  ...withoutCodeDeps(ELEMENT_TRANSFORMERS),
  ...withoutCodeDeps(MULTILINE_ELEMENT_TRANSFORMERS),
  ...TEXT_FORMAT_TRANSFORMERS,
  ...TEXT_MATCH_TRANSFORMERS,
];
