---
name: canonical-domain-entity
description: Canonical domain entity pattern for the beep-effect monorepo. Defines the complete file structure, contract pattern, error pattern, repository contract, RPC/HTTP/AI tool aggregation, cluster entity, and barrel export conventions for every domain entity.
---
