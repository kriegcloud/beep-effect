...
const $I = $WorkspacesDomainId.create("entities/Document/contracts/Get.contract");
...
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for the Get Document Contract.",
  })
) {}
...
export class Success extends S.Class<Success>($I`Success`)(
  ...
  $I.annotations("Success", {
    description: "Success response for the Get Document Contract.",
  })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", {
    description: "Get Document Request Contract.",
  })
) {
