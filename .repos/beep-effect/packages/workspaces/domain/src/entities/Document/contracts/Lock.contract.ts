...
const $I = $WorkspacesDomainId.create("entities/Document/contracts/Lock.contract");
...
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", {
    description: "Payload for the Lock Document Contract.",
  })
) {}
...
export class Success extends S.Class<Success>($I`Success`)(
  ...
  $I.annotations("Success", {
    description: "Success response for the Lock Document Contract.",
  })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", {
    description: "Lock Document Request Contract.",
  })
) {
  static readonly Rpc = Rpc.fromTaggedRequest(Contract);
  static readonly Tool = Tool.fromTaggedRequest(Contract);
  static readonly Http = HttpApiEndpoint.patch("Lock", "/:id/lock")
    .setPayload(Payload)
