...
effect(
  "getNameInitials handles whitespace, nullish, and empty names",
  Effect.fn(function* () {
...
effect(
  "normalizeString and kebabCase produce predictable search-friendly strings",
  Effect.fn(function* () {
...
effect(
  "stripMessageFormatting removes markdown tokens",
  Effect.fn(function* () {
...
effect(
  "interpolateTemplate resolves nested values and leaves missing placeholders intact",
  Effect.fn(function* () {
...
effect(
  "getNestedValue supports array notation and returns undefined for missing paths",
  Effect.fn(function* () {
...
effect(
  "applyPrefix/suffix and mapping helpers preserve literal combinations",
  Effect.fn(function* () {
...
effect(
  "strLiteralFromNum formats numeric literals as strings",
  Effect.fn(function* () {
...
effect(
  "formatLabel handles spaced, underscored, and camel case identifiers",
  Effect.fn(function* () {
...
effect(
  "mapApplySuffix rejects empty literal arrays",
  Effect.fn(function* () {
...
effect(
  "singularize handles consonant-o plurals gracefully",
  Effect.fn(function* () {
