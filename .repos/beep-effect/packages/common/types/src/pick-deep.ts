...
*/
type InternalPickDeep<T, Path extends string | number> = T extends NonRecursiveType
  ? never
  : T extends UnknownArray
...
*/
type PickDeepArray<ArrayType extends UnknownArray, P extends string | number> = P extends `${
