...
export const BlankNodeEncoded = S.TemplateLiteral("<", S.String, ">").annotations(
  $I.annotations("BlankNodeEncoded", {
...
export class BlankNodeFromString extends S.transform(BlankNodeEncoded, BlankNode, {
  strict: true,
  decode: (string) => pipe(string, Str.replace(">", ""), Str.replace("<", ""), BlankNode.new),
