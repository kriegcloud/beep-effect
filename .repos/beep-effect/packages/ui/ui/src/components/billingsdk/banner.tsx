    ...
    switch (variant) {
      ...
      case "popup":
        return {
          ...
          actions: "flex items-center justify-center md:justify-start gap-2 sm:self-auto flex-shrink-0 pr-12",
        };
      case "destructive":
        return {
          container: hasGradient
          ...
          content: "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-destructive leading-tight"
            : "text-sm font-medium text-destructive-foreground leading-tight",
          description: hasGradient ? "text-xs text-destructive/80" : "text-xs text-destructive-foreground/80",
          actions: "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
      case "warning":
        return {
          container: hasGradient
      ...
      default:
        return {
          ...
          wrapper:
            "relative container mx-auto flex flex-col sm:flex-row md:items-start items-center justify-between px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-4",
          content: "flex flex-col text-center sm:text-left sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-foreground leading-tight"
            : "text-sm font-medium text-primary-foreground leading-tight",
          description: hasGradient ? "text-xs text-foreground/80" : "text-xs text-primary-foreground/80",
          actions: "flex items-center justify-center md:justify-start gap-2 sm:self-auto pr-12",
        };
    }
  };
        ...
        >
          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.content}>
              <div className={variant === "minimal" ? "flex flex-col gap-0.5 md:flex-row md:gap-2" : ""}>
            ...
            <div className={styles.actions}>
              {buttonText && variant !== "minimal" && (
                <Button
                  ...
                  className={"h-8"}
                >
                  {buttonIcon && <div className="mr-1 flex-shrink-0">{buttonIcon}</div>}
                  {buttonText}
                </Button>
              )}
            </div>
