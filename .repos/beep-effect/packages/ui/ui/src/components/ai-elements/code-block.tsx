...
type CodeBlockProps = HTMLAttributes<HTMLDivElement> & {
  ...
  readonly showLineNumbers?: undefined | boolean;
};
...
export const highlightCode = (
  ...
  callback?: undefined | ((result: TokenizedCode) => void)
): TokenizedCode | null => {
...
export const CodeBlockContainer = ({
  ...
  style,
  ...props
}: HTMLAttributes<HTMLDivElement> & { readonly language: string }) => (
  <div
...
export type CodeBlockCopyButtonProps = ComponentProps<typeof Button> & {
  readonly onCopy?: undefined | (() => void);
