...
interface MessageBranchContextType {
  ...
  readonly branches: ReactElement[];
  readonly setBranches: (branches: ReactElement[]) => void;
}
...
export type MessageBranchProps = HTMLAttributes<HTMLDivElement> & {
  readonly defaultBranch?: undefined | number;
  readonly onBranchChange?: undefined | ((branchIndex: number) => void);
};
