...
class FindByRelationIdRequest extends S.Class<FindByRelationIdRequest>("FindByRelationIdRequest")({
...
class SearchByTextRequest extends S.Class<SearchByTextRequest>("SearchByTextRequest")({
  query: S.String,
  organizationId: SharedEntityIds.OrganizationId,
  limit: S.Number,
}) {}
...
export const RepoLive: Layer.Layer<Entities.RelationEvidence.Repo, never, DbClient.SliceDbRequirements> = Layer.effect(
