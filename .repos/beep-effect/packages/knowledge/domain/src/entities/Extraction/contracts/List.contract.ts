...
import { ExtractionStatus, Model } from "../Extraction.model";

const $I = $KnowledgeDomainId.create("entities/Extraction/contracts/List.contract");
...
export class Element extends S.Class<Element>($I`Element`)(
  ...
  $I.annotations("Element", {
    description: "extraction_list element",
  })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotations("Contract", {
    description: "List extractions Request Contract.",
  })
) {
