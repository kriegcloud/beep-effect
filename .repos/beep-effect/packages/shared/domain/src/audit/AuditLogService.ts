...
import type { AuditChanges, AuditEntityType } from "./AuditLog.ts";
 ...
 * ```
 */
export class AuditLogService extends Context.Tag("AuditLogService")<AuditLogService, AuditLogServiceShape>() {}
