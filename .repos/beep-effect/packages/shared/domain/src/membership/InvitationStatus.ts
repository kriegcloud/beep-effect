 ...
 */
export const InvitationStatus = BS.StringLiteralKit("pending", "accepted", "revoked").annotations({
...
/**
 * Type guard for InvitationStatus using S.is
 */
export const isInvitationStatus = S.is(InvitationStatus);

/**
 * All valid InvitationStatus values
 */
export const InvitationStatusValues: readonly InvitationStatus[] = ["pending", "accepted", "revoked"] as const;
