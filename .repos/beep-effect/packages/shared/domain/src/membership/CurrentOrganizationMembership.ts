 ...
 * ```
 */
export const withOrganizationMembership =
 ...
 * ```
 */
export const getCurrentOrganizationId = () => Effect.map(getCurrentOrganizationMembership(), (m) => m.organizationId);
 ...
 * ```
 */
export const getCurrentUserRole = () => Effect.map(getCurrentOrganizationMembership(), (m) => m.role);
