...
import type { InvitationRole, OrganizationInvitation } from "./OrganizationInvitation.ts";
...
export interface InvitationServiceShape {
  ...
  ) => Effect.Effect<CreateInvitationResult, InvitationAlreadyExistsError | PersistenceError>;
  ...
  readonly revokeInvitation: (
    ...
    revokedBy: SharedEntityIds.UserId.Type
  ) => Effect.Effect<OrganizationInvitation, InvalidInvitationError | PersistenceError | EntityNotFoundError>;
 ...
 * ```
 */
export class InvitationService extends Context.Tag("InvitationService")<InvitationService, InvitationServiceShape>() {}
 ...
 */
export type RevokeInvitationError = InvalidInvitationError | PersistenceError | EntityNotFoundError;
