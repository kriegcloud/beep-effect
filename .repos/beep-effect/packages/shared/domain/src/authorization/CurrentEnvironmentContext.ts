 ...
 */
export const getCurrentEnvironmentContext: Effect.Effect<EnvironmentContextWithMeta, never, CurrentEnvironmentContext> =
  CurrentEnvironmentContext;
...
export const withEnvironmentContext =
  ...
  <A, E, R>(effect: Effect.Effect<A, E, R>): Effect.Effect<A, E, Exclude<R, CurrentEnvironmentContext>> =>
 ...
 */
export const CurrentEnvironmentContextDefault: Layer.Layer<CurrentEnvironmentContext> = Layer.sync(
  CurrentEnvironmentContext,
