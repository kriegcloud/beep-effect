 ...
 *
 * @module @beep/iam-client/connections/get-consents/contract
 * @category Connections/GetConsents
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/get-consents");

/**
 * OAuth2 consent record schema for list response.
 *
 * @category Connections/GetConsents/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/GetConsents/Contracts
 * @since 0.1.0
 */
