 ...
 *
 * @module @beep/iam-client/connections/link/contract
 * @category Connections/Link
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/link");
 ...
 * ```
 *
 * @category Connections/Link/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/Link/Contracts
 * @since 0.1.0
 */
