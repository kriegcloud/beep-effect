 ...
 *
 * @module @beep/iam-client/connections/register/contract
 * @category Connections/Register
 * @since 0.1.0
 */
...
const $I = $IamClientId.create("connections/register");
 ...
 * ```
 *
 * @category Connections/Register/Schemas
 * @since 0.1.0
 */
 ...
 *
 * @category Connections/Register/Contracts
 * @since 0.1.0
 */
