...
export class Payload extends S.Class<Payload>($I`Payload`)(
  ...
  $I.annotations("Payload", { description: "Payload for the Get Member Contract." })
) {}

export class Success extends S.Class<Success>($I`Success`)(
  { data: Member.Model.json },
  $I.annotations("Success", { description: "Success response for the Get Member Contract." })
) {}
...
export class Contract extends S.TaggedRequest<Contract>($I`Contract`)(
  ...
  $I.annotationsHttp("Contract", { description: "Get Member Request Contract." })
) {
