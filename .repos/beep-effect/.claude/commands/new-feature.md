# New Feature Development - beep-effect codebase

## 🚨 MANDATORY SPEC-DRIVEN DEVELOPMENT 🚨

This command enforces a rigorous **5-phase development process** for substantial new features in the beep-effect codebase. This process ensures systematic development, comprehensive documentation, and alignment with beep-effect codebase standards.
...
- Create `design.md` including:
  - **beep-effect codebase Patterns**: Generator functions, error handling, resource management
...
- **MANDATORY**: `bun run biome --write <file.ts>` after editing ANY TypeScript file
- **MANDATORY**: `bun run docgen` must pass with zero errors
...
bun run biome --write packages/effect/src/<modified-file>.ts
...
- Zero compilation errors (`bun docgen`, `bun check`, `bun run build`)
...
This workflow ensures systematic, high-quality feature development that maintains the beep-effect codebase's standards for type safety, functional programming patterns, and comprehensive documentation.