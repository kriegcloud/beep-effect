...
export const info = (message: string, props?: Record<string, unknown>) => logWithLevel("info", message, props)

export const warn = (message: string, props?: Record<string, unknown>) => logWithLevel("warn", message, props)
