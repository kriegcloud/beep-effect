...
Write managed targets to disk with backup and state tracking.

```bash
# Dry run (report changes without writing)
bun run /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/src/bin.ts \
  apply --fixture /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/fixtures/poc-04/managed.yaml \
  --dry-run
...
```bash
bun run /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/src/bin.ts \
  check --fixture /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/fixtures/poc-04/managed.yaml
```

Returns `{ ok: true }` if state is consistent, `{ ok: false }` with messages on drift.

---

## doctor

End-to-end health check (placeholder in scaffold mode).
...
Restore managed files from backup and clean up state.

```bash
bun run /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/src/bin.ts \
  revert --fixture /home/elpresidank/YeeBois/projects/beep-effect3/tooling/beep-sync/fixtures/poc-04/managed.yaml
```
