            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                ...
                >
                  ...
                  <Typography>
                    Pigment CSS looks through Material UI components used in the project and extracts the styles into
                    plain CSS.
                  </Typography>
                </li>
                <li
                ...
                >
                  ...
                  <Typography>
                    Material UI provides a set of layout components that integrates with Pigment CSS to support React
                    Server Components.
                  </Typography>
                </li>
                <li
                ...
                >
                  ...
                  <Typography>Replacing Emotion with Pigment CSS eliminates ~15kB from the final bundle.</Typography>
                </li>
              </Stack>
            </Grid>
          </Grid>
