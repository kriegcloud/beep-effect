...
export const Route = createFileRoute("/_app/$orgSlug/notifications/general")({
	component: GeneralRoute,
})

function GeneralRoute() {
	const { groups, isEmpty, isLoading, markAsRead } = useGroupedNotifications("general")
			...
			<SectionHeader.Root className="border-none pb-0">
				<SectionHeader.Group>
					<div className="space-y-0.5">
						<SectionHeader.Heading size="xl">Channels</SectionHeader.Heading>
						<SectionHeader.Subheading>
							Notifications from public and private channels.
						</SectionHeader.Subheading>
					</div>
				</SectionHeader.Group>
			</SectionHeader.Root>
