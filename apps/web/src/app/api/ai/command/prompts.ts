import type { ChatMessage } from "@beep/ui/components/editor/use-chat";
...
export function getGeneratePrompt(editor: SlateEditor, { messages }: { readonly messages: ChatMessage[] }) {
...
export function getEditPrompt(
  editor: SlateEditor,
  { isSelecting, messages }: { readonly isSelecting: boolean; readonly messages: ChatMessage[] }
) {
