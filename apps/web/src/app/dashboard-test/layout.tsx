...
import MainLayout from "@beep/ui/layouts/main-layout/MainLayout";
import { SettingsPanelProvider } from "@beep/ui/settings-v2/SettingsPanelProvider";
import { SettingsProvider, useSettingsContext } from "@beep/ui/settings-v2/SettingsProvider";
import { REFRESH } from "@beep/ui/settings-v2/SettingsReducer";
import SettingsPanel from "@beep/ui/settings-v2/settings-panel/SettingsPanel";
import { useConfigFromQuery } from "@beep/ui/settings-v2/use-config-from-query";
...
const SettingPanelToggler = dynamic(() => import("@beep/ui/settings-v2/settings-panel/SettingPanelToggler"), {
  ssr: false,
});
