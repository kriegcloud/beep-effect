...
const rawOpipSiteContent = {
  metadata: {
    siteUrl: "https://opip.law",
    siteName: "opip.law - Thomas J. Oppold",
  ...
  hero: {
    ...
    video: {
      src: "/opip/hero-vid.mp4",
      alt: "",
      credit: "OPIP launch media",
    },
    videoPoster: {
      src: "/opip/hero-vid-poster.jpg",
      alt: "",
      credit: "OPIP launch media",
    },
  },
  about: [
    ...
    },
    {
      ...
      image: {
        src: "/opip/about/engineering.jpg",
  ...
  matters: [
    {
      ...
      figure: {
        src: "/opip/matter-figs/midwest-karavan.png",
    ...
    },
    {
      ...
      figure: {
        src: "/opip/matter-figs/gramm-deere.png",
    ...
    },
    {
      ...
      figure: {
        src: "/opip/matter-figs/precision-planting.png",
  ...
  clients: [
    {
      id: "precision-planting",
      aspectRatio: "660/128",
      logo: { src: "/opip/clients/precision-planting.svg", alt: "Precision Planting", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "headsight",
      aspectRatio: "258/86",
      logo: { src: "/opip/clients/headsight.png", alt: "Headsight", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "genesis-attachments",
      aspectRatio: "242/52",
      logo: { src: "/opip/clients/genesis-attachments.svg", alt: "Genesis Attachments", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "superior-industries",
      aspectRatio: "200/71",
      logo: { src: "/opip/clients/superior-industries.svg", alt: "Superior Industries", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "skyline-displays",
      aspectRatio: "5000/2140",
      logo: { src: "/opip/clients/skyline-displays.png", alt: "Skyline Displays", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "par-aide",
      aspectRatio: "200/209",
      logo: { src: "/opip/clients/par-aide.png", alt: "Par Aide", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "cray",
      aspectRatio: "513/60",
      logo: { src: "/opip/clients/cray.svg", alt: "Cray", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "kingdom-ag-concepts",
      aspectRatio: "176/62",
      logo: { src: "/opip/clients/kingdom-ag-concepts.png", alt: "Kingdom Ag Concepts", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "eastpoint-sports",
      aspectRatio: "508/144",
      logo: { src: "/opip/clients/eastpoint-sports.png", alt: "EastPoint Sports", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
    {
      id: "bioenergy-life",
      aspectRatio: "300/124",
      logo: { src: "/opip/clients/bioenergy-life.png", alt: "Bioenergy Life Science", credit: "Client mark" },
      review: needsReview("Confirm permission or publication comfort before launch."),
    },
  ],
  press: [
...
} satisfies typeof OpipSiteContent.Encoded;
...
export const launchReviewGates = {
  ...
  contact: opipSiteContent.contact.review,
