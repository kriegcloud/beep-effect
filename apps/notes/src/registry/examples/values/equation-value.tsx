...
export const equationValue: any = (
  <fragment>
    ...
    <hp indent={1} listStyleType="decimal">
      <htext>Equations allow you to express complex mathematical concepts in both inline and block formats.</htext>
    </hp>
    ...
    <hp indent={2} listStyleType="disc">
      <htext>Click on any equation to edit it. Press Escape to close the menu without editing it.</htext>
    </hp>
    <hp indent={2} listStyleType="disc">
    ...
    <hp>
      <htext>
        Advanced usage: Combine equations with other elements like tables or code blocks for comprehensive scientific
