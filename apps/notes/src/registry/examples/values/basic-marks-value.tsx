...
export const basicMarksValue: any = (
  <fragment>
    <hh2>🌱 Marks</hh2>
    <hp>Add style and emphasis to your text using the mark plugins, which offers a variety of formatting options.</hp>
    <hp>
      Make text <htext bold>bold</htext>, <htext italic>italic</htext>, <htext underline>underlined</htext>, or apply a{" "}
