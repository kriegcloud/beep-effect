...
export const blockMenuValue: any = (
  <fragment>
    ...
    <hp indent={1} listStyleType="disc">
      <htext>
        Right-click any unselected block to open the context menu. If you right-click within a selected block, you'll
        see the browser's native context menu instead.
      </htext>
    </hp>
    ...
    <hcallout variant="info" icon="💡">
      <htext>You can select multiple blocks and apply block menu actions to all of them at once!</htext>
    </hcallout>
  </fragment>
);
