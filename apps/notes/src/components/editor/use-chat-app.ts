    ...
    async onData(data) {
      ...
      if (data.type === "data-comment" && data.data) {
        ...
        try {
          ...
          // Apply comment marks to the editor after the discussion is created
...
const mdxChunks = [
  [
    ...
    },
    {
      delay,
      texts:
        'src="https://s26.q4cdn.com/900411403/documents/doc_downloads/test.pdf" width="80%" isUpload="true" />\n\n',
    },
    {
      delay,
      texts: "Audio ",
