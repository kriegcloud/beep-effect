...
import { AIToolbarButton } from "@beep/notes/registry/ui/ai-toolbar-button";
import { InlineEquationToolbarButton } from "@beep/notes/registry/ui/equation-toolbar-button";
import { FontColorToolbarButton } from "@beep/notes/registry/ui/font-color-toolbar-button";
import { LinkToolbarButton } from "@beep/notes/registry/ui/link-toolbar-button";
import { MarkToolbarButton } from "@beep/notes/registry/ui/mark-toolbar-button";
import { MoreToolbarButton } from "@beep/notes/registry/ui/more-toolbar-button";
import { ToolbarGroup } from "@beep/notes/registry/ui/toolbar";
import { TurnIntoToolbarButton } from "@beep/notes/registry/ui/turn-into-toolbar-button";
      ...
      {!readOnly && (
        <>
          ...
          <ToolbarGroup>
            ...
            <MarkToolbarButton nodeType={KEYS.strikethrough} shortcut="⌘+Shift+X" tooltip="Strikethrough">
              <Strikethrough />
            </MarkToolbarButton>
...
const AIIcon = (props: LucideProps) => (
  <svg aria-hidden="true" fill="url(#myGradient)" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
