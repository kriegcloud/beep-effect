...
import { BlockSuggestionCard, isResolvedSuggestion, useResolveSuggestion } from "./block-suggestion-app";
...
export const BlockDiscussion: RenderNodeWrapper = (props) => {
  ...
  if (commentNodes.length === 0 && suggestionNodes.length === 0 && !draftCommentNode && isOverlapWithEditor) return;
              ...
              <React.Fragment>
                {noneActive ? (
                  ...
                  <React.Fragment>
                    ...
                    {activeDiscussion && <BlockCommentsCard discussion={activeDiscussion} isLast={true} />}
                  </React.Fragment>
                )}
              </React.Fragment>
            )}
...
const useResolvedDiscussion = (commentNodes: NodeEntry<TCommentText>[], blockPath: Path): RouterDiscussionItem[] => {
