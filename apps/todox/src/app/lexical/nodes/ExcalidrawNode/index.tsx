...
function $convertExcalidrawElement(domNode: HTMLElement): DOMConversionOutput | null {
  ...
  const height = !heightStr || heightStr === "inherit" ? "inherit" : Number.parseInt(heightStr, 10);
  const width = !widthStr || widthStr === "inherit" ? "inherit" : Number.parseInt(widthStr, 10);
