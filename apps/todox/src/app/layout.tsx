    ...
    <>
      ...
      <html lang={appConfig.lang ?? "en"} dir={appConfig.dir} className={inter.variable} suppressHydrationWarning>
        <head>
          {isDev && (
            <>
              <Script src="https://unpkg.com/react-grab@0.1.15/dist/index.global.js" strategy="beforeInteractive" />
              {/*<Script*/}
              {/*  src="https://unpkg.com/@react-grab/claude-code@0.1.15/dist/client.global.js"*/}
              {/*  strategy="afterInteractive"*/}
              {/*/>*/}
              <Script
                src="https://unpkg.com/@react-grab/codex@0.1.15/dist/client.global.js"
                strategy="afterInteractive"
              />
            </>
          )}
