...
const E = {
  john: KnowledgeEntityIds.KnowledgeEntityId.create(),
  sarah: KnowledgeEntityIds.KnowledgeEntityId.create(),
  mike: KnowledgeEntityIds.KnowledgeEntityId.create(),
  alex: KnowledgeEntityIds.KnowledgeEntityId.create(),
  lisa: KnowledgeEntityIds.KnowledgeEntityId.create(),
  acme: KnowledgeEntityIds.KnowledgeEntityId.create(),
  engTeam: KnowledgeEntityIds.KnowledgeEntityId.create(),
  platformTeam: KnowledgeEntityIds.KnowledgeEntityId.create(),
  q4Release: KnowledgeEntityIds.KnowledgeEntityId.create(),
  budgetReview: KnowledgeEntityIds.KnowledgeEntityId.create(),
} as const;

const Rel = {
  johnWorksAcme: KnowledgeEntityIds.RelationId.create(),
  sarahWorksAcme: KnowledgeEntityIds.RelationId.create(),
  mikeWorksAcme: KnowledgeEntityIds.RelationId.create(),
  sarahMemberEng: KnowledgeEntityIds.RelationId.create(),
  mikeMemberEng: KnowledgeEntityIds.RelationId.create(),
  lisaMemberEng: KnowledgeEntityIds.RelationId.create(),
  alexMemberPlatform: KnowledgeEntityIds.RelationId.create(),
  sarahReportsJohn: KnowledgeEntityIds.RelationId.create(),
  mikeReportsJohn: KnowledgeEntityIds.RelationId.create(),
  johnLeadsQ4: KnowledgeEntityIds.RelationId.create(),
  sarahContributesQ4: KnowledgeEntityIds.RelationId.create(),
  mikeContributesQ4: KnowledgeEntityIds.RelationId.create(),
  johnPresentsBudget: KnowledgeEntityIds.RelationId.create(),
  q4Deadline: KnowledgeEntityIds.RelationId.create(),
  budgetQuarter: KnowledgeEntityIds.RelationId.create(),
  engTeamPartAcme: KnowledgeEntityIds.RelationId.create(),
  platformTeamPartAcme: KnowledgeEntityIds.RelationId.create(),
  johnRole: KnowledgeEntityIds.RelationId.create(),
  sarahRole: KnowledgeEntityIds.RelationId.create(),
  mikeRole: KnowledgeEntityIds.RelationId.create(),
} as const;
