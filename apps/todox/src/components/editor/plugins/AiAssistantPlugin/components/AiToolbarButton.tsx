...
import { useAiContextSafe } from "../../../context/AiContext";
...
export function AiToolbarButton({ disabled }: AiToolbarButtonProps) {
  ...
  // Don't render when outside AiContextProvider (e.g. mail compose)
  if (aiContext === null) {
    return null;
  }

  const isLoading = aiContext.operationState === "streaming";
