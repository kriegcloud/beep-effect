import { themeAtom } from "@beep/interfere/atoms/theme";
...
import type { File, FullPath } from "../domain/workspace";
...
const runtime = Atom.runtime(
  Layer.mergeAll(Loader.Default, Monaco.Default, ToasterService.Default, WebContainer.Default)
