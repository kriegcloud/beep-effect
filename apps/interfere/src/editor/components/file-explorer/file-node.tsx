...
import { State, useExplorerDispatch, useExplorerState, useRemove, useRename } from "./state";
...
export declare namespace FileNode {
  ...
  export type OnClick = (event: React.MouseEvent<HTMLButtonElement>, node: File | Directory) => void;
}
