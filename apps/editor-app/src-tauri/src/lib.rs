...
const DEV_SIDECAR_ENTRYPOINT: &str = "packages/editor/runtime/src/main.ts";
const DEV_SIDECAR_HOSTNAME: &str = "editor-sidecar";
const PACKAGED_SIDECAR_NAME: &str = "editor-sidecar";
...
pub fn run() {
  tauri::Builder::default()
    ...
    .expect("error while running Editor App");
}
