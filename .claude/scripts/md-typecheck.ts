...
const createTsConfig = (tsconfigBasePath: string, projectRoot: string) => ({
  ...
  compilerOptions: {
    ...
    baseUrl: projectRoot,
    paths: {
      effect: [`${projectRoot}/.claude/node_modules/effect`, `${projectRoot}/node_modules/effect`],
      "effect/*": [`${projectRoot}/.claude/node_modules/effect/*`, `${projectRoot}/node_modules/effect/*`],
      "@effect/*": [`${projectRoot}/.claude/node_modules/@effect/*`, `${projectRoot}/node_modules/@effect/*`],
      "@effect-atom/*": [
    ...
    typeRoots: [`${projectRoot}/node_modules/@types`, `${projectRoot}/.claude/node_modules/@types`],
  },
  include: ["./**/*.ts", "./**/*.tsx"],
});
...
const extractCodeBlocks = (file: string, content: string): ReadonlyArray<CodeBlock> => {
  // Match code fences: ```typescript, ```typescript, ```tsx with optional nocheck modifier
