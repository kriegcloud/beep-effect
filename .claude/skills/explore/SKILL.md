...
(b) in-repo capability inventory via `graphify query "<question>"` and
`standards/repo-exports.catalog.md`, citing package + path, marking gaps NOT
FOUND. Surface constraints discovered. Fan out subagents for breadth when the
topic is wide.
