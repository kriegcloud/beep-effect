...
The interface type and the service tag for any View Model SHALL bear identical names.
...
export const ChatVM = ServiceMap.Service<ChatVM>("ChatVM");
```
...
export const ComponentNameVM = ServiceMap.Service<ComponentNameVM>("ComponentNameVM");
