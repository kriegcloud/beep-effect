...
const FeatureService = ServiceMap.Service<FeatureService>("FeatureService")
...
// Declare types
declare const DatabaseService: ServiceMap.Service.Tag<DatabaseService, {}>
declare const ConfigService: ServiceMap.Service.Tag<ConfigService, {}>
